...
typedef struct _DWM_COMPOSITION_BUFFER
{
    ...
    /* TRUE if pPixels points at the locked D3DKMT allocation VA (Phase 2).
     * When set, the compositor draws directly into the WDDM allocation and
     * DwmPresentFrame issues a real kernel D3DKMTPresent of that allocation. */
    BOOL            AllocationIsLockedVa;
