...
{
    /* Desktop composition uses the native Direct3D runtime, UMD and WDDM
     * presentation chain. OpenGL ICD availability is an application contract
     * and must not mask a missing or failed Direct3D display path. */
