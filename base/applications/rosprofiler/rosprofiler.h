...
#define WM_RPERF_TIMELINE_GET_GRAPH_ORIGIN (WM_APP + 13)
#define WM_RPERF_TIMELINE_GET_STAT (WM_APP + 14)
#define WM_RPERF_TIMELINE_SET_VIEW (WM_APP + 15)
#define WM_RPERF_TIMELINE_SET_TRACK_MODE (WM_APP + 16)
#define WM_RPERF_TIMELINE_GET_TRACK_MODE (WM_APP + 17)
#define WM_RPERF_TIMELINE_HOVER (WM_APP + 18)
#define WM_RPERF_TIMELINE_GET_BUCKET_COUNT (WM_APP + 19)

#define RPERF_TIMELINE_STAT_TOTAL 0
#define RPERF_TIMELINE_STAT_SELECTED 1
#define RPERF_TIMELINE_STAT_RUNNING 2
#define RPERF_TIMELINE_STAT_WAITING 3
#define RPERF_TIMELINE_STAT_UNKNOWN 4
#define RPERF_TIMELINE_STAT_DIAGNOSTIC 5
#define RPERF_TIMELINE_STAT_WAITING_EXCLUDED 6
#define RPERF_TIMELINE_STAT_CPU_ONLY 7
#define RPERF_TIMELINE_STAT_CONTEXT_SWITCHES 8
#define RPERF_TIMELINE_STAT_WAKEUPS 9
#define RPERF_TIMELINE_STAT_LOSS 10
#define RPERF_TIMELINE_STAT_CPU_COUNT 11
#define RPERF_TIMELINE_STAT_HAS_SCHEDULER 12

#define RPERF_TIMELINE_TRACK_THREADS 0
#define RPERF_TIMELINE_TRACK_CPUS 1

#define RPERF_TIMELINE_HOVER_MIXED_REASON 0x00000001
#define RPERF_TIMELINE_HOVER_MIXED_CPU 0x00000002
#define RPERF_TIMELINE_HOVER_PRECISE 0x00000004
...
typedef struct _RPERF_TIMELINE_HOVER
{
    BOOL Active;
    ULONG TrackMode;
    ULONG ProcessId;
