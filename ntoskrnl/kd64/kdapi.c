...
static volatile LONG KdpDebuggerNestedDepth;
                ...
                IN PCONTEXT Context)
{
    ...
    if (PatternLength == 0 || PatternLength != Data->Length || PatternLength > RTL_NUMBER_OF(PrefixTable) || Remaining > MAXULONGLONG - Address)
    {
        Status = STATUS_INVALID_PARAMETER;
        goto SendReply;
    }
                ...
                IN PKEXCEPTION_FRAME ExceptionFrame)
{
    ...
    {
        InterlockedIncrement(&KdpDebuggerNestedDepth);
        return FALSE;
    }
...
KdDisableDebuggerWithLock(IN BOOLEAN NeedLock)
{
    ...
    if (!KdDisableCount)
    {
        ...
        if (KdDebuggerEnabled)
        {
            ...
            MmWriteableSharedUserData->KdDebuggerEnabled = FALSE;
        }
     }
