...
@ stub -arch=arm64 ExAllocateFromLookasideListEx
@ stub -arch=arm64 ExAllocateFromNPagedLookasideList
@ stub -arch=arm64 ExAllocatePool2
@ stub -arch=arm64 ExAllocatePool3
@ stub -arch=arm64 ExAllocateTimer
@ stub -arch=arm64 ExBlockOnAddressPushLock
@ stub -arch=arm64 ExCancelDpcEventWait
@ stub -arch=arm64 ExCancelTimer
...
@ stub -arch=arm64 ExQueryTimerResolution
@ stub -arch=arm64 ExQueryWnfStateData
@ stub -arch=arm64 ExQueueDpcEventWait
@ stub -arch=arm64 ExRcuFreePool
@ stub -arch=arm64 ExRealTimeIsUniversal
...
@ stub -arch=arm64 ExSubscribeWnfStateChange
...
@ stub -arch=arm64 ExUnsubscribeWnfStateChange
...
@ stub -arch=arm64 IoUnregisterPlugPlayNotificationEx
...
@ stub -arch=arm64 KeCountSetBitsAffinityEx
...
@ stub -arch=arm64 KeFindFirstSetLeftAffinityEx
@ stub -arch=arm64 KeFindFirstSetLeftGroupAffinity
@ stub -arch=arm64 KeFindFirstSetRightAffinityEx
@ stub -arch=arm64 KeFindFirstSetRightGroupAffinity
...
@ stub -arch=arm64 KeQueryActiveGroupCount
@ stub -arch=arm64 KeQueryActiveProcessorAffinity
@ stub -arch=arm64 KeQueryActiveProcessorAffinity2
@ stub -arch=arm64 KeQueryAuxiliaryCounterFrequency
@ stub -arch=arm64 KeQueryDpcWatchdogInformation
@ stub -arch=arm64 KeQueryEffectivePriorityThread
@ stub -arch=arm64 KeQueryGroupAffinity
@ stub -arch=arm64 KeQueryGroupAffinityEx
@ stub -arch=arm64 KeQueryHardwareCounterConfiguration
@ stub -arch=arm64 KeQueryHeteroCpuPolicyThread
@ stub -arch=arm64 KeQueryInterruptPartitionCount
@ stub -arch=arm64 KeQueryInterruptPartitionInformation
@ stub -arch=arm64 KeQueryLogicalProcessorRelationship
@ stub -arch=arm64 KeQueryMaximumGroupCount
@ stub -arch=arm64 KeQueryNodeActiveAffinity
@ stub -arch=arm64 KeQueryNodeActiveAffinity2
@ stub -arch=arm64 KeQueryNodeActiveProcessorCount
@ stub -arch=arm64 KeQueryNodeMaximumProcessorCount
@ stub -arch=arm64 KeQueryPrcbAddress
@ stub -arch=arm64 KeQuerySystemCpuPartitionAffinity
@ stub -arch=arm64 KeQueryTotalCycleTimeThread
@ stub -arch=arm64 KeQueryTypeEvent
@ stub -arch=arm64 KeQueryUnbiasedInterruptTime
@ stub -arch=arm64 KeQueryUnbiasedInterruptTimePrecise
...
@ stub -arch=arm64 KeRevertToUserGroupAffinityThread
@ stub -arch=arm64 KeSaveExtendedProcessorState
@ stub -arch=arm64 KeSetActualBasePriorityThread
@ stub -arch=arm64 KeSetHardwareCounterConfiguration
@ stub -arch=arm64 KeSetHeteroCpuPolicyThread
@ stub -arch=arm64 KeSetSelectedCpuSetsThread
@ stub -arch=arm64 KeSetSystemGroupAffinityThread
@ stub -arch=arm64 KeSetTargetProcessorDpcEx
@ stub -arch=arm64 KeSetTimer2
...
@ stub -arch=arm64 KeSubtractAffinityEx
...
@ stub -arch=arm64 MmAllocateContiguousMemorySpecifyCacheNode
@ stub -arch=arm64 MmAllocateContiguousNodeMemory
@ stub -arch=arm64 MmAllocateMappingAddressEx
@ stub -arch=arm64 MmAllocateMdlForIoSpace
@ stub -arch=arm64 MmAllocateMemoryRanges
@ stub -arch=arm64 MmAllocateNodePagesForMdlEx
...
@ stub -arch=arm64 MmMapIoSpaceEx
...
@ stub -arch=arm64 ZwCreateWnfStateName
@ stub -arch=arm64 ZwDeleteWnfStateData
@ stub -arch=arm64 ZwDeleteWnfStateName
...
@ stub -arch=arm64 ZwQueryWnfStateData
@ stub -arch=arm64 ZwQueryWnfStateNameInformation
...
@ stub -arch=arm64 ZwUpdateWnfStateData
