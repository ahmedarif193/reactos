...
@ stdcall ExSetTimer(ptr int64 int64 ptr)
...
@ stdcall NtSetTimer(ptr ptr ptr ptr long long ptr)
...
@ stdcall CcCoherencyFlushAndPurgeCache(ptr ptr long ptr ptr)
...
@ stdcall ExInitializeDeleteTimerParameters(ptr)
