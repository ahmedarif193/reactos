...
RegisterToTrapFrame[] =
{
    ...
    {"pc",      FIELD_OFFSET(KDB_KTRAP_FRAME, Pc),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, Pc)},
    {"ra",      FIELD_OFFSET(KDB_KTRAP_FRAME, Ra),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, Ra)},
    {"sp",      FIELD_OFFSET(KDB_KTRAP_FRAME, Sp),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, Sp)},
    {"gp",      FIELD_OFFSET(KDB_KTRAP_FRAME, Gp),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, Gp)},
    {"tp",      FIELD_OFFSET(KDB_KTRAP_FRAME, Tp),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, Tp)},
    {"t0",      FIELD_OFFSET(KDB_KTRAP_FRAME, T0),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, T0)},
    {"t1",      FIELD_OFFSET(KDB_KTRAP_FRAME, T1),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, T1)},
    {"t2",      FIELD_OFFSET(KDB_KTRAP_FRAME, T2),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, T2)},
    {"s0",      FIELD_OFFSET(KDB_KTRAP_FRAME, S0),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, S0)},
    {"fp",      FIELD_OFFSET(KDB_KTRAP_FRAME, S0),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, S0)},
    {"s1",      FIELD_OFFSET(KDB_KTRAP_FRAME, S1),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, S1)},
    {"a0",      FIELD_OFFSET(KDB_KTRAP_FRAME, A0),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, A0)},
    {"a1",      FIELD_OFFSET(KDB_KTRAP_FRAME, A1),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, A1)},
    {"a2",      FIELD_OFFSET(KDB_KTRAP_FRAME, A2),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, A2)},
    {"a3",      FIELD_OFFSET(KDB_KTRAP_FRAME, A3),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, A3)},
    {"a4",      FIELD_OFFSET(KDB_KTRAP_FRAME, A4),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, A4)},
    {"a5",      FIELD_OFFSET(KDB_KTRAP_FRAME, A5),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, A5)},
    {"a6",      FIELD_OFFSET(KDB_KTRAP_FRAME, A6),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, A6)},
    {"a7",      FIELD_OFFSET(KDB_KTRAP_FRAME, A7),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, A7)},
    {"s2",      FIELD_OFFSET(KDB_KTRAP_FRAME, S2),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, S2)},
    {"s3",      FIELD_OFFSET(KDB_KTRAP_FRAME, S3),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, S3)},
    {"s4",      FIELD_OFFSET(KDB_KTRAP_FRAME, S4),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, S4)},
    {"s5",      FIELD_OFFSET(KDB_KTRAP_FRAME, S5),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, S5)},
    {"s6",      FIELD_OFFSET(KDB_KTRAP_FRAME, S6),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, S6)},
    {"s7",      FIELD_OFFSET(KDB_KTRAP_FRAME, S7),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, S7)},
    {"s8",      FIELD_OFFSET(KDB_KTRAP_FRAME, S8),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, S8)},
    {"s9",      FIELD_OFFSET(KDB_KTRAP_FRAME, S9),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, S9)},
    {"s10",     FIELD_OFFSET(KDB_KTRAP_FRAME, S10),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, S10)},
    {"s11",     FIELD_OFFSET(KDB_KTRAP_FRAME, S11),     RTL_FIELD_SIZE(KDB_KTRAP_FRAME, S11)},
    {"t3",      FIELD_OFFSET(KDB_KTRAP_FRAME, T3),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, T3)},
    {"t4",      FIELD_OFFSET(KDB_KTRAP_FRAME, T4),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, T4)},
    {"t5",      FIELD_OFFSET(KDB_KTRAP_FRAME, T5),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, T5)},
    {"t6",      FIELD_OFFSET(KDB_KTRAP_FRAME, T6),      RTL_FIELD_SIZE(KDB_KTRAP_FRAME, T6)},
    {"fcsr",    FIELD_OFFSET(KDB_KTRAP_FRAME, Fcsr),    RTL_FIELD_SIZE(KDB_KTRAP_FRAME, Fcsr)}
#else
