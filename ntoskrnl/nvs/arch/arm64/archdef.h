 ...
 * FILE:        ntoskrnl/nvs/arch/arm64/archdef.h
 * PURPOSE:     ARM64 memory manager architecture definitions
 *
...
#define MI_ARCH_ID_VALUE        0x00000004
#define MI_ARCH_NAME            "arm64"
