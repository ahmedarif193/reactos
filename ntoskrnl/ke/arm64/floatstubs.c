...
/* floor/pow/log10 intentionally NOT defined here: libcntpr provides the real
 * ARM64 implementations (sdk/lib/crt/math/arm64/), and an object-file copy
 * would shadow those archive members at link time. */
