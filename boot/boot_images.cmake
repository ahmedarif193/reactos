...
if(DEFINED EFI_PLATFORM_ID)
    # UEFI firmware discovers the FAT boot volume through the ESP type.
...
if(FREELDR_HAS_BIOS_BOOT)
    ...
    list(APPEND _preinstall_boot_partition_files -add ${_freeldr_file} /freeldr.sys)
    list(APPEND _preinstall_partition_deps fat32 freeldr)
