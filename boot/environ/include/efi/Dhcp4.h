/** @file
  ...
  Based on UEFI 2.5+ specification, Chapter 29.
...
/* EFI_SERVICE_BINDING_PROTOCOL is shared with HttpProtocol.h */
...
typedef enum {
    ...
    Dhcp4RcvdOffer      = 0x02,
    Dhcp4SelectOffer    = 0x04,
    Dhcp4SendRequest    = 0x08,
    Dhcp4RcvdAck        = 0x10,
    Dhcp4RcvdNak        = 0x20,
    Dhcp4SendDecline    = 0x40,
    Dhcp4BoundCompleted = 0x80,
    Dhcp4EnterRenewing  = 0x100,
    Dhcp4EnterRebinding = 0x200,
    Dhcp4AddressLost    = 0x400,
    Dhcp4Fail           = 0x800
} EFI_DHCP4_EVENT;
