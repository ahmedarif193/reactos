...
if(ARCH STREQUAL "arm64ec" AND COMMAND set_arm64ec_native_target)
    add_asm_files(blrtl_native_asm ${ASM_SOURCE})
    add_library(blrtl_native ${SOURCE} ${blrtl_native_asm})
    set_arm64ec_native_target(blrtl_native)
    add_pch(blrtl_native ${NTOS_RTL_SOURCE_DIR}/rtl.h SOURCE)
    add_dependencies(blrtl_native psdk asm)
endif()
