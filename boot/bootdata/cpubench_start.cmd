...
%S%\dbgprint.exe SMP_LOAD_15_CONTROL_TIMEDATE_BEFORE
if exist "%S%\control.exe" start "smp-load-15-control-timedate" "%S%\control.exe" timedate.cpl
%S%\dbgprint.exe SMP_LOAD_15_CONTROL_TIMEDATE_AFTER
...
%S%\dbgprint.exe SMP_LOAD_20_RUNDLL_TIMEDATE_BEFORE
if exist "%S%\rundll32.exe" start "smp-load-20-rundll-timedate" "%S%\rundll32.exe" shell32.dll,Control_RunDLL "%S%\timedate.cpl"
%S%\dbgprint.exe SMP_LOAD_20_RUNDLL_TIMEDATE_AFTER
%S%\dbgprint.exe SMP_LOAD_21_RUNDLL_SYSDM_BEFORE
if exist "%S%\rundll32.exe" start "smp-load-21-rundll-sysdm" "%S%\rundll32.exe" shell32.dll,Control_RunDLL "%S%\sysdm.cpl"
%S%\dbgprint.exe SMP_LOAD_21_RUNDLL_SYSDM_AFTER
%S%\dbgprint.exe SMP_LOAD_22_RUNDLL_MMSYS_BEFORE
if exist "%S%\rundll32.exe" start "smp-load-22-rundll-mmsys" "%S%\rundll32.exe" shell32.dll,Control_RunDLL "%S%\mmsys.cpl"
%S%\dbgprint.exe SMP_LOAD_22_RUNDLL_MMSYS_AFTER
%S%\dbgprint.exe SMP_LOAD_23_RUNDLL_HDWWIZ_BEFORE
if exist "%S%\rundll32.exe" start "smp-load-23-rundll-hdwwiz" "%S%\rundll32.exe" shell32.dll,Control_RunDLL "%S%\hdwwiz.cpl"
%S%\dbgprint.exe SMP_LOAD_23_RUNDLL_HDWWIZ_AFTER
%S%\dbgprint.exe SMP_LOAD_24_RUNDLL_POWER_BEFORE
if exist "%S%\rundll32.exe" start "smp-load-24-rundll-power" "%S%\rundll32.exe" shell32.dll,Control_RunDLL "%S%\powercfg.cpl"
%S%\dbgprint.exe SMP_LOAD_24_RUNDLL_POWER_AFTER
%S%\dbgprint.exe SMP_LOAD_25_DEVMGMT_BEFORE
if exist "%S%\devmgmt.exe" start "smp-load-25-devmgmt" "%S%\devmgmt.exe"
%S%\dbgprint.exe SMP_LOAD_25_DEVMGMT_AFTER
...
%S%\dbgprint.exe SMP_WIN32_10_DESK_BEFORE
if exist "%S%\control.exe" start "smp-win32-10-desk" "%S%\control.exe" desk.cpl
%S%\dbgprint.exe SMP_WIN32_10_DESK_AFTER
%S%\dbgprint.exe SMP_WIN32_11_MAIN_BEFORE
if exist "%S%\control.exe" start "smp-win32-11-main" "%S%\control.exe" main.cpl
%S%\dbgprint.exe SMP_WIN32_11_MAIN_AFTER
%S%\dbgprint.exe SMP_WIN32_12_MMSYS_BEFORE
if exist "%S%\control.exe" start "smp-win32-12-mmsys" "%S%\control.exe" mmsys.cpl
%S%\dbgprint.exe SMP_WIN32_12_MMSYS_AFTER
%S%\dbgprint.exe SMP_WIN32_13_RUNDLL_DESK_BEFORE
if exist "%S%\rundll32.exe" start "smp-win32-13-rundll-desk" "%S%\rundll32.exe" shell32.dll,Control_RunDLL "%S%\desk.cpl"
%S%\dbgprint.exe SMP_WIN32_13_RUNDLL_DESK_AFTER
%S%\dbgprint.exe SMP_WIN32_14_RUNDLL_MAIN_BEFORE
if exist "%S%\rundll32.exe" start "smp-win32-14-rundll-main" "%S%\rundll32.exe" shell32.dll,Control_RunDLL "%S%\main.cpl"
%S%\dbgprint.exe SMP_WIN32_14_RUNDLL_MAIN_AFTER
%S%\dbgprint.exe SMP_WIN32_15_RUNDLL_MMSYS_BEFORE
if exist "%S%\rundll32.exe" start "smp-win32-15-rundll-mmsys" "%S%\rundll32.exe" shell32.dll,Control_RunDLL "%S%\mmsys.cpl"
%S%\dbgprint.exe SMP_WIN32_15_RUNDLL_MMSYS_AFTER
