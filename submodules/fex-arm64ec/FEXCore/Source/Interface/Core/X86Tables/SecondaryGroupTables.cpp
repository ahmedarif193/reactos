...
constexpr std::array<X86InstInfo, MAX_INST_SECOND_GROUP_TABLE_SIZE> SecondInstGroupOps = []() consteval {
  ...
  constexpr U16U8InfoStruct SecondaryExtensionOpTable[] = {
    ...
    {OPD(TYPE_GROUP_6, PF_NONE, 2), 1, X86InstInfo{"LLDT",  TYPE_INST, FLAGS_NONE,       0}},
    ...
    {OPD(TYPE_GROUP_6, PF_F3, 2), 1, X86InstInfo{"LLDT",    TYPE_INST, FLAGS_NONE,       0}},
    ...
    {OPD(TYPE_GROUP_6, PF_66, 2), 1, X86InstInfo{"LLDT",    TYPE_INST, FLAGS_NONE,       0}},
    ...
    {OPD(TYPE_GROUP_6, PF_F2, 2), 1, X86InstInfo{"LLDT",    TYPE_INST, FLAGS_NONE,       0}},
