...
#if PLATFORM_WINDOWS
#define MEDIUM_PAGE_SIZE_SHIFT 19
#else
...
_Static_assert(MEDIUM_PAGE_SIZE >= MEDIUM_BLOCK_SIZE_LIMIT + PAGE_HEADER_SIZE, "Medium block exceeds page size");
_Static_assert(LARGE_PAGE_SIZE >= LARGE_BLOCK_SIZE_LIMIT + PAGE_HEADER_SIZE, "Large block exceeds page size");
