...
@ stdcall NtGdiDdDDICreatePagingQueue(ptr)
@ stdcall NtGdiDdDDICreateSynchronizationObject(ptr)
@ stdcall NtGdiDdDDICreateSynchronizationObject2(ptr)
...
@ stdcall NtGdiDdDDIDestroyPagingQueue(ptr)
@ stdcall NtGdiDdDDIDestroySynchronizationObject(ptr)
@ stdcall NtGdiDdDDIEscape(ptr)
@ stdcall NtGdiDdDDIFreeGpuVirtualAddress(ptr)
@ stdcall NtGdiDdDDIGetSharedPrimaryHandle(ptr)
@ stdcall NtGdiDdDDIInvalidateCache(ptr)
@ stdcall NtGdiDdDDILock(ptr)
@ stdcall NtGdiDdDDIMapGpuVirtualAddress(ptr)
@ stdcall NtGdiDdDDIOpenAdapterFromDeviceName(ptr)
@ stdcall NtGdiDdDDIOpenAdapterFromGdiDisplayName(ptr)
...
@ stdcall NtGdiDdDDIWaitForSynchronizationObjectFromCpu(ptr)
@ stdcall NtGdiDdDDIWaitForSynchronizationObjectFromGpu(ptr)
...
@ stdcall NtGdiGetFontFamilyInfo(ptr ptr ptr ptr)
...
@ stdcall NtUserBuildHwndList(ptr ptr long long long long ptr ptr)
@ stdcall NtUserBuildNameList(ptr long ptr ptr)
@ stdcall NtUserBuildPropList(ptr long ptr ptr)
...
@ stdcall NtUserChangeDisplaySettings(ptr ptr long ptr)
...
@ stdcall NtUserGetMonitorInfo(ptr ptr)
...
@ stdcall NtUserGetThreadDpiAwarenessContext()
...
@ stdcall NtUserMonitorFromPoint(long long long)
@ stdcall NtUserMonitorFromRect(ptr long)
@ stdcall NtUserMonitorFromWindow(ptr long)
...
@ stdcall -arch=win64 NtUserSetClassLongPtr(ptr long ptr long)
...
@ stdcall NtUserSetScrollBarInfo(ptr long ptr)
...
@ stdcall NtUserSetThreadDpiAwarenessContext(long)
...
@ stdcall -arch=win64 NtUserSetWindowLongPtr(ptr long ptr long)
