...
// ReactOS Display Driver Model
    ...
    SVC_(UserDisplayConfigGetDeviceInfo, 1)
    SVC_(UserEnableMouseInPointer, 1)
    SVC_(UserGetPointerDeviceRects, 3)
    SVC_(UserGetPointerInfoList, 8)
    SVC_(UserGetProcessDpiAwarenessContext, 1)
    SVC_(UserGetProp, 2)
    ...
    SVC_(GdiDdDDICreateSynchronizationObject2, 1)
    SVC_(GdiDdDDIWaitForSynchronizationObject2, 1)
    SVC_(GdiDdDDISignalSynchronizationObject2, 1)
    SVC_(GdiDdDDIMakeResident, 1)
    SVC_(GdiDdDDIEvict, 1)
    SVC_(GdiDdDDIQueryVideoMemoryInfo, 1)
    SVC_(GdiDdDDICreatePagingQueue, 1)
    SVC_(GdiDdDDIDestroyPagingQueue, 1)
    SVC_(GdiDdDDIOfferAllocations, 1)
    SVC_(GdiDdDDIReclaimAllocations, 1)
    SVC_(GdiDdDDIReserveGpuVirtualAddress, 1)
    ...
    SVC_(GdiDdDDIWaitForVerticalBlankEvent2, 1)
    SVC_(GdiDdDDICheckVidPnExclusiveOwnership, 1)
    SVC_(GdiDdDDIEnumAdapters, 1)
    SVC_(GdiDdDDIOpenAdapterFromLuid, 1)
    SVC_(GdiDdDDICreateAllocation2, 1)
    SVC_(GdiDdDDIOpenResource2, 1)
    SVC_(GdiDdDDIOpenSynchronizationObject, 1)
    SVC_(GdiDdDDICreateKeyedMutex, 1)
    SVC_(GdiDdDDIOpenKeyedMutex, 1)
    SVC_(GdiDdDDIDestroyKeyedMutex, 1)
    SVC_(GdiDdDDIAcquireKeyedMutex, 1)
    SVC_(GdiDdDDIReleaseKeyedMutex, 1)
    SVC_(GdiDdDDIGetOverlayState, 1)
    SVC_(GdiDdDDICheckSharedResourceAccess, 1)
    SVC_(GdiDdDDIEnumAdapters2, 1)
    SVC_(GdiDdDDIDestroyAllocation2, 1)
    SVC_(GdiDdDDILock2, 1)
    SVC_(GdiDdDDIUnlock2, 1)
    SVC_(GdiDdDDICreateHwQueue, 1)
    SVC_(GdiDdDDIDestroyHwQueue, 1)
    SVC_(GdiDdDDISubmitCommandToHwQueue, 1)
    SVC_(GdiDdDDISubmitCommand, 1)
    SVC_(GdiDdDDIGetAllocationPriority, 1)
    SVC_(GdiDdDDIUpdateAllocationProperty, 1)
    SVC_(GdiDdDDIChangeVideoMemoryReservation, 1)
    SVC_(GdiDdDDISetStablePowerState, 1)
    SVC_(GdiDdDDIQueryClockCalibration, 1)
    SVC_(GdiDdDDISetContextInProcessSchedulingPriority, 1)
    SVC_(GdiDdDDIGetContextInProcessSchedulingPriority, 1)
    SVC_(GdiDdDDIRegisterTrimNotification, 1)
    SVC_(GdiDdDDIUnregisterTrimNotification, 1)
    SVC_(GdiDdDDIRegisterBudgetChangeNotification, 1)
    SVC_(GdiDdDDIUnregisterBudgetChangeNotification, 1)
    SVC_(GdiDdDDIInvalidateCache, 1)
    SVC_(GdiDdDDIGetSharedResourceAdapterLuid, 1)
    SVC_(GdiDdDDIOpenResourceFromNtHandle, 1)
    SVC_(GdiDdDDIQueryResourceInfoFromNtHandle, 1)
    SVC_(GdiDdDDIOpenSyncObjectFromNtHandle, 1)
    SVC_(GdiDdDDIOpenSyncObjectFromNtHandle2, 1)
    SVC_(GdiDdDDIOpenSyncObjectNtHandleFromName, 1)
    SVC_(GdiDdDDIOpenNtHandleFromName, 1)
    SVC_(GdiDdDDICreateOutputDupl, 1)
    SVC_(GdiDdDDIDestroyOutputDupl, 1)
    SVC_(GdiDdDDIOutputDuplGetFrameInfo, 1)
    SVC_(GdiDdDDIOutputDuplGetMetaData, 1)
    SVC_(GdiDdDDIOutputDuplGetPointerShapeData, 1)
    SVC_(GdiDdDDIOutputDuplPresent, 1)
    SVC_(GdiDdDDIOutputDuplReleaseFrame, 1)
    SVC_(GdiDdDDIPresentMultiPlaneOverlay, 1)
    SVC_(GdiDdDDICheckMultiPlaneOverlaySupport, 1)
    SVC_(GdiDdDDIEnumAdapters3, 1)
    SVC_(GdiDdDDIAcquireKeyedMutex2, 1)
    SVC_(GdiDdDDICreateKeyedMutex2, 1)
    SVC_(GdiDdDDIOpenKeyedMutex2, 1)
    SVC_(GdiDdDDIReleaseKeyedMutex2, 1)
    SVC_(GdiDdDDICancelPresents, 1)
    SVC_(GdiDdDDICreateContextVirtual, 1)
    SVC_(GdiDdDDIGetDWMVerticalBlankEvent, 1)
    SVC_(GdiDdDDIGetMultiPlaneOverlayCaps, 1)
    SVC_(GdiDdDDIQueryVidPnExclusiveOwnership, 1)
    SVC_(GdiDdDDISetSyncRefreshCountWaitTarget, 1)
    SVC_(GdiDdDDISetVidPnSourceOwner2, 1)
    SVC_(GdiDdDDISignalSynchronizationObjectFromGpu, 1)
    SVC_(GdiDdDDICheckMultiPlaneOverlaySupport2, 1)
    SVC_(GdiDdDDICheckMultiPlaneOverlaySupport3, 1)
    SVC_(GdiDdDDIPresentMultiPlaneOverlay2, 1)
    ...
    SVC_(GdiDdDDIConfigureSharedResource, 1)
    SVC_(GdiDdDDICreateProtectedSession, 1)
    SVC_(GdiDdDDIDestroyProtectedSession, 1)
    SVC_(GdiDdDDIFlushHeapTransitions, 1)
    SVC_(GdiDdDDIGetPostCompositionCaps, 1)
    SVC_(GdiDdDDIGetProcessDeviceRemovalSupport, 1)
    SVC_(GdiDdDDIMarkDeviceAsError, 1)
    SVC_(GdiDdDDIOpenKeyedMutexFromNtHandle, 1)
    SVC_(GdiDdDDIOpenProtectedSessionFromNtHandle, 1)
    SVC_(GdiDdDDIPresentRedirected, 1)
    SVC_(GdiDdDDIQueryProcessOfferInfo, 1)
    SVC_(GdiDdDDIQueryProtectedSessionInfoFromNtHandle, 1)
    SVC_(GdiDdDDIQueryProtectedSessionStatus, 1)
    SVC_(GdiDdDDIQueryRemoteVidPnSourceFromGdiDisplayName, 1)
    SVC_(GdiDdDDISetHwProtectionTeardownRecovery, 1)
    SVC_(GdiDdDDISetVidPnSourceHwProtection, 1)
    SVC_(GdiDdDDITrimProcessCommitment, 1)
    SVC_(GdiDdDDIConnectDoorbell, 1)
    SVC_(GdiDdDDICreateDoorbell, 1)
    SVC_(GdiDdDDICreateNativeFence, 1)
    SVC_(GdiDdDDIDestroyDoorbell, 1)
    SVC_(GdiDdDDIGetNativeFenceLogDetail, 1)
    SVC_(GdiDdDDINotifyWorkSubmission, 1)
    SVC_(GdiDdDDIOpenNativeFenceFromNtHandle, 1)
    SVC_(GdiDdDDIOutputDuplPresentToHwQueue, 1)
    SVC_(GdiDdDDIRegisterVailProcess, 1)
    SVC_(UserAddClipboardFormatListener, 1)
    SVC_(UserRemoveClipboardFormatListener, 1)
    SVC_(DCompositionCreateConnection, 3)
    SVC_(DCompositionDestroyConnection, 1)
    SVC_(DCompositionCreateChannel, 3)
