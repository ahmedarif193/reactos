...
// ReactOS DWM Support
    ...
    SVC_(UserCheckDesktopByThreadId, 1)
    SVC_(UserGhostWindowFromHungWindow, 1)
    SVC_(UserHungWindowFromGhostWindow, 1)
    SVC_(UserRegisterErrorReportingDialog, 2)
