...
@ stdcall -version=0x600+ SetProcessDPIAware()
@ stdcall -version=0x600+ IsProcessDPIAware()
@ stdcall -version=0x601+ SetProcessDpiAwareness(long)
@ stdcall -version=0x601+ GetProcessDpiAwareness(ptr ptr)
@ stdcall -version=0xA00+ SetProcessDpiAwarenessContext(long)
@ stdcall -version=0xA00+ GetProcessDpiAwarenessInternal(long ptr)
@ stdcall -version=0xA00+ SetProcessDpiAwarenessInternal(long)
@ stdcall -version=0xA00+ GetDpiForSystem()
...
@ stdcall -version=0xA00+ GetDpiForMonitor(ptr long ptr ptr)
...
@ stdcall -version=0xA00+ SetThreadDpiAwarenessContext(long)
@ stdcall -version=0xA00+ GetWindowDpiAwarenessContext(ptr)
@ stdcall -version=0xA00+ GetDpiAwarenessContextForProcess(ptr)
...
@ stdcall -version=0xA00+ LogicalToPhysicalPointForPerMonitorDPI(ptr ptr)
@ stdcall -version=0xA00+ PhysicalToLogicalPointForPerMonitorDPI(ptr ptr)

; Windows 10 Touch and Pen Input APIs
@ stdcall -version=0x601+ RegisterTouchWindow(ptr long)
@ stdcall -version=0x601+ UnregisterTouchWindow(ptr)
@ stdcall -version=0x601+ IsTouchWindow(ptr ptr)
@ stdcall -version=0x601+ GetTouchInputInfo(ptr long ptr long)
@ stdcall -version=0x601+ CloseTouchInputHandle(ptr)
@ stdcall -version=0x601+ GetGestureInfo(ptr ptr)
@ stdcall -version=0x601+ GetGestureExtraArgs(ptr long ptr)
@ stdcall -version=0x601+ CloseGestureInfoHandle(ptr)
@ stdcall -version=0x601+ SetGestureConfig(ptr long long ptr long)
@ stdcall -version=0x601+ GetGestureConfig(ptr long long ptr ptr long)
@ stdcall -version=0x602+ GetPointerInfo(long ptr)
@ stdcall -version=0x602+ GetPointerType(long ptr)
@ stdcall -version=0x602+ GetPointerCursorId(long ptr)
@ stdcall -version=0x602+ GetPointerPenInfo(long ptr)
@ stdcall -version=0x602+ GetPointerPenInfoHistory(long ptr ptr)
@ stdcall -version=0x602+ GetPointerTouchInfo(long ptr)
@ stdcall -version=0x602+ GetPointerTouchInfoHistory(long ptr ptr)
@ stdcall -version=0x602+ GetPointerFrameInfo(long ptr ptr)
@ stdcall -version=0x602+ GetPointerFrameInfoHistory(long ptr ptr ptr)
@ stdcall -version=0x602+ GetPointerFramePenInfo(long ptr ptr)
@ stdcall -version=0x602+ GetPointerFramePenInfoHistory(long ptr ptr ptr)
...
@ stdcall -version=0x602+ GetPointerDevices(ptr ptr)
@ stdcall -version=0x602+ GetPointerDevice(ptr ptr)
@ stdcall -version=0x602+ GetPointerDeviceProperties(ptr ptr ptr)
@ stdcall -version=0x602+ GetPointerDeviceRects(ptr ptr ptr)
@ stdcall -version=0x602+ GetPointerDeviceCursors(ptr ptr ptr)
@ stdcall -version=0x602+ GetRawPointerDeviceData(long long long ptr ptr)
@ stdcall -version=0x602+ SkipPointerFrameMessages(long)
@ stdcall -version=0x602+ RegisterPointerDeviceNotifications(ptr long)
@ stdcall -version=0x602+ GetUnpredictedMessagePos()
@ stdcall -version=0x602+ RegisterTouchHitTestingWindow(ptr long)
@ stdcall -version=0x602+ EvaluateProximityToRect(ptr ptr ptr)
@ stdcall -version=0x602+ EvaluateProximityToPolygon(long ptr ptr ptr)
@ stdcall -version=0x602+ PackTouchHitTestingProximityEvaluation(ptr ptr)

; Windows 10 Window Management APIs
@ stdcall -version=0x601+ GetWindowDisplayAffinity(ptr ptr)
@ stdcall -version=0x601+ SetWindowDisplayAffinity(ptr long)
@ stdcall -version=0x601+ SetWindowCompositionAttribute(ptr ptr)
...
@ stdcall -version=0x600+ ShutdownBlockReasonQuery(ptr wstr ptr)
@ stdcall -version=0x600+ ShutdownBlockReasonDestroy(ptr)
@ stdcall -version=0x600+ DisableProcessWindowsGhosting()
...
; Windows 10 Accessibility and UI Automation APIs
@ stdcall -version=0x600+ NotifyWinEvent(long ptr long long)
@ stdcall -version=0x600+ SetWinEventHook(long long ptr ptr long long long)
@ stdcall -version=0x600+ UnhookWinEvent(ptr)
@ stdcall -version=0x600+ GetTitleBarInfo(ptr ptr)
@ stdcall -version=0x600+ GetScrollBarInfo(ptr long ptr)
@ stdcall -version=0x600+ GetComboBoxInfo(ptr ptr)
@ stdcall -version=0x600+ GetListBoxInfo(ptr)
@ stdcall -version=0x600+ GetMenuBarInfo(ptr long long ptr)
@ stdcall -version=0x600+ GetGUIThreadInfo(long ptr)
@ stdcall -version=0x600+ GetWindowInfo(ptr ptr)
@ stdcall -version=0x600+ GetAltTabInfoA(ptr long ptr str long)
@ stdcall -version=0x600+ GetAltTabInfoW(ptr long ptr wstr long)
@ stdcall -version=0x600+ RealGetWindowClassA(ptr str long)
@ stdcall -version=0x600+ RealGetWindowClassW(ptr wstr long)

; Windows 10 Shell Integration APIs
...
@ stdcall -version=0x600+ SHGetFolderPathEx(ptr long ptr long wstr long)
@ stdcall -version=0x600+ SHGetSpecialFolderLocation(ptr long ptr)
@ stdcall -version=0x600+ SHGetSpecialFolderPathA(ptr str long long)
@ stdcall -version=0x600+ SHGetSpecialFolderPathW(ptr wstr long long)

; Windows 10 Message Filtering and Clipboard APIs
@ stdcall -version=0x600+ AddClipboardFormatListener(ptr)
@ stdcall -version=0x600+ RemoveClipboardFormatListener(ptr)
@ stdcall -version=0x600+ GetUpdatedClipboardFormats(ptr long ptr)
@ stdcall -version=0x600+ GetClipboardSequenceNumber()
@ stdcall -version=0x600+ IsClipboardFormatAvailable(long)
@ stdcall -version=0x600+ GetPriorityClipboardFormat(ptr long)

; Windows 10 Raw Input APIs
@ stdcall -version=0x600+ GetRawInputData(ptr long ptr ptr long)
@ stdcall -version=0x600+ GetRawInputDeviceList(ptr ptr long)
@ stdcall -version=0x600+ GetRawInputDeviceInfoA(ptr long ptr ptr)
@ stdcall -version=0x600+ GetRawInputDeviceInfoW(ptr long ptr ptr)
@ stdcall -version=0x600+ GetRawInputBuffer(ptr ptr long)
@ stdcall -version=0x600+ GetRegisteredRawInputDevices(ptr ptr long)
@ stdcall -version=0x600+ RegisterRawInputDevices(ptr long long)
@ stdcall -version=0x600+ DefRawInputProc(ptr long long)
