 ...
 * recomposes. Called from IntBeginPaint / IntEndPaint. */
VOID IntCompositionPaintBegin(_In_ PWND Wnd);
VOID IntCompositionPaintEnd(_In_ PWND Wnd);

/* The painting thread drained its paint batch (cPaintsReady==0): self-heal the
 * bracket counter and present the finished frame once. Called from IntEndPaint. */
VOID IntCompositionPaintBatchDone(_In_ PWND Wnd);
