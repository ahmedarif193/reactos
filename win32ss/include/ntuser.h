...
enum SimpleCallRoutines
{
    ...
    HWNDPARAM_ROUTINE_ROS_GETWINDOW,
    HWNDPARAM_ROUTINE_ROS_GETWINDOWINFO,
    HWND_ROUTINE_ROS_ISWINDOWVISIBLE,
    HWND_ROUTINE_ROS_ISWINDOWUNICODE,
    HWND_ROUTINE_ROS_GETLASTACTIVEPOPUP
};

typedef struct _ROS_WINDOWINFO
{
    RECT rcWindow;
    RECT rcClient;
    DWORD style;
...
#define ONEPARAM_ROUTINE_ROS_GETSYSTEMMETRICS     0xfffe000f
#define ONEPARAM_ROUTINE_ROS_GETSYSCOLOR          0xfffe0010
#define ONEPARAM_ROUTINE_ROS_GETSYSCOLORBRUSH     0xfffe0011
#define ONEPARAM_ROUTINE_ROS_GETGRAYBRUSH         0xfffe0012
#define ONEPARAM_ROUTINE_DWMATTACH                0xfffe0013
#define ONEPARAM_ROUTINE_DWMGETFRAME              0xfffe0014
#define ONEPARAM_ROUTINE_DWMISENABLED              0xfffe0015
#define ONEPARAM_ROUTINE_DWMOPENSURFACE           0xfffe0016
#define ONEPARAM_ROUTINE_DWMDXSURFACE             0xfffe0017
#define ONEPARAM_ROUTINE_DWMSETBLUR                0xfffe0018
#define ONEPARAM_ROUTINE_DWMSETGPUOUTPUT           0xfffe0019
#define ONEPARAM_ROUTINE_DWMFLUSH                  0xfffe001b
#define ONEPARAM_ROUTINE_DWMPRESENTED              0xfffe001c
#define ONEPARAM_ROUTINE_ISJOBUILIMITED            0xfffe001a
#define ONEPARAM_ROUTINE_ROS_USEDEFAULTSYSCOLORS    0xfffe001b
...
#define TWOPARAM_ROUTINE_ROS_GETCALLPROCINFO 0x1006
#define HWNDPARAM_ROUTINE_ROS_CHANGEMESSAGEFILTER 0x1007
#define HWNDPARAM_ROUTINE_ROS_GETCLASSLONGA 0x1008
#define HWNDPARAM_ROUTINE_ROS_GETCLASSLONGW 0x1009
#define HWNDPARAM_ROUTINE_ROS_GETCLASSWORD 0x100a
#define HWNDPARAM_ROUTINE_ROS_GETDIRECTSENDPROC 0x100b

typedef struct _ROS_DIRECTSENDPROC
{
    ULONG64 Proc;
    ULONG IsAnsi;
} ROS_DIRECTSENDPROC, *PROS_DIRECTSENDPROC;

/* Fixed-width result shared by native and WoW64 USER32. No USER heap pointers. */
typedef struct _ROS_CALLPROCINFO
{
    ULONGLONG WindowProc;
    ULONG IsUnicode;
    ULONG Reserved;
} ROS_CALLPROCINFO, *PROS_CALLPROCINFO;

C_ASSERT(sizeof(ROS_CALLPROCINFO) == 16);
C_ASSERT(FIELD_OFFSET(ROS_CALLPROCINFO, IsUnicode) == 8);
