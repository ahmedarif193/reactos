...
BOOL FASTCALL ftGdiGetCharWidthInfo(PFONTGDI,const LOGFONTW*,PCHWIDTHINFO);
BOOL FASTCALL ftGdiGetFontRealizationInfo(PFONTGDI,PFONT_REALIZATION_INFO);
BOOL FASTCALL ftGdiGetFontFileInfo(DWORD,DWORD,PFONT_FILE_INFO,SIZE_T,PSIZE_T);
BOOL FASTCALL ftGdiGetFontFileData(DWORD,DWORD,ULONGLONG,PVOID,SIZE_T);
