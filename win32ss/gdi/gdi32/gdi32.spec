...
; Windows 10 DirectWrite and Advanced Typography APIs
@ stdcall -version=0x600+ DWriteCreateFactory(long ptr ptr)
@ stdcall -version=0x600+ DWriteCreateFontFileReference(wstr ptr ptr)
@ stdcall -version=0x600+ DWriteCreateCustomFontFileReference(ptr long ptr ptr)
@ stdcall -version=0x600+ DWriteCreateFontFace(long long ptr long long ptr)
@ stdcall -version=0x600+ DWriteCreateTextFormat(wstr ptr long long long long wstr ptr)
@ stdcall -version=0x600+ DWriteCreateTextLayout(wstr long ptr long long ptr)
@ stdcall -version=0x600+ DWriteCreateGdiCompatibleTextLayout(wstr long ptr long long long ptr ptr)
@ stdcall -version=0x600+ DWriteCreateEllipsisTrimmingSign(ptr ptr)
@ stdcall -version=0x600+ DWriteCreateTextAnalyzer(ptr)
@ stdcall -version=0x600+ DWriteCreateNumberSubstitution(long wstr long ptr)
@ stdcall -version=0x600+ DWriteCreateGlyphRunAnalysis(ptr ptr ptr long ptr long long ptr)

; Windows 10 Color Management APIs
@ stdcall -version=0x600+ GetColorProfileFromHandle(ptr ptr ptr)
@ stdcall -version=0x600+ SetColorProfileFromHandle(ptr ptr)
@ stdcall -version=0x600+ GetStandardColorSpaceProfileA(long str str ptr)
@ stdcall -version=0x600+ GetStandardColorSpaceProfileW(long wstr wstr ptr)
@ stdcall -version=0x600+ SetStandardColorSpaceProfileA(long str str)
@ stdcall -version=0x600+ SetStandardColorSpaceProfileW(long wstr wstr)
@ stdcall -version=0x600+ GetNamedProfileInfo(ptr ptr)
@ stdcall -version=0x600+ SetNamedProfileInfo(ptr ptr)
@ stdcall -version=0x600+ CreateColorTransformA(ptr ptr ptr long)
@ stdcall -version=0x600+ CreateColorTransformW(ptr ptr ptr long)
@ stdcall -version=0x600+ CreateMultiProfileTransform(ptr long ptr long long long)
@ stdcall -version=0x600+ DeleteColorTransform(ptr)
@ stdcall -version=0x600+ TranslateBitmapBits(ptr ptr long long ptr long ptr long ptr long)
@ stdcall -version=0x600+ TranslateColors(ptr ptr long long ptr long)
@ stdcall -version=0x600+ CheckBitmapBits(ptr ptr long long ptr long ptr long ptr long)
@ stdcall -version=0x600+ CheckColors(ptr ptr long long ptr long)
@ stdcall -version=0x600+ GetCMMInfo(ptr long)
@ stdcall -version=0x600+ RegisterCMMA(str long str)
@ stdcall -version=0x600+ RegisterCMMW(wstr long wstr)
@ stdcall -version=0x600+ UnregisterCMMA(str long)
@ stdcall -version=0x600+ UnregisterCMMW(wstr long)
@ stdcall -version=0x600+ SelectCMM(long)
@ stdcall -version=0x600+ GetPS2ColorSpaceArray(ptr long ptr ptr ptr ptr)
@ stdcall -version=0x600+ GetPS2ColorRenderingIntent(ptr long ptr ptr)
@ stdcall -version=0x600+ GetPS2ColorRenderingDictionary(ptr long ptr ptr ptr)
@ stdcall -version=0x600+ GetNamedColor(ptr str ptr ptr)
@ stdcall -version=0x600+ GetCountColorProfileElements(ptr ptr)
@ stdcall -version=0x600+ GetColorProfileElement(ptr long ptr ptr ptr ptr)
@ stdcall -version=0x600+ GetColorProfileElementTag(ptr long ptr)
@ stdcall -version=0x600+ IsColorProfileTagPresent(ptr long ptr)
@ stdcall -version=0x600+ IsColorProfileValid(ptr ptr)
@ stdcall -version=0x600+ CreateProfileFromLogColorSpaceA(ptr ptr)
@ stdcall -version=0x600+ CreateProfileFromLogColorSpaceW(ptr ptr)
@ stdcall -version=0x600+ GetLogColorSpaceA(ptr ptr long)
@ stdcall -version=0x600+ GetLogColorSpaceW(ptr ptr long)
@ stdcall -version=0x600+ CreateDeviceLinkProfile(ptr long ptr long long ptr long)
@ stdcall -version=0x600+ CreateColorSpaceA(ptr)
@ stdcall -version=0x600+ CreateColorSpaceW(ptr)
@ stdcall -version=0x600+ SetColorSpace(ptr ptr)
@ stdcall -version=0x600+ DeleteColorSpace(ptr)
@ stdcall -version=0x600+ GetColorSpace(ptr)

; Windows 10 Hardware Acceleration APIs
@ stdcall -version=0x600+ GetGraphicsAdapterInfo(ptr)
@ stdcall -version=0x600+ GetGraphicsAdapterLuid(ptr)
@ stdcall -version=0x600+ CreateGraphicsDevice(ptr ptr)
@ stdcall -version=0x600+ DeleteGraphicsDevice(ptr)
@ stdcall -version=0x600+ GetGraphicsDeviceInfo(ptr ptr)
@ stdcall -version=0x600+ SetGraphicsDeviceProperty(ptr long ptr)
@ stdcall -version=0x600+ GetGraphicsDeviceProperty(ptr long ptr)
@ stdcall -version=0x600+ CreateGraphicsContext(ptr ptr)
@ stdcall -version=0x600+ DeleteGraphicsContext(ptr)
@ stdcall -version=0x600+ SetGraphicsContextProperty(ptr long ptr)
@ stdcall -version=0x600+ GetGraphicsContextProperty(ptr long ptr)
@ stdcall -version=0x600+ CreateGraphicsBuffer(ptr ptr)
@ stdcall -version=0x600+ DeleteGraphicsBuffer(ptr)
@ stdcall -version=0x600+ MapGraphicsBuffer(ptr long ptr)
@ stdcall -version=0x600+ UnmapGraphicsBuffer(ptr)
@ stdcall -version=0x600+ CopyGraphicsBuffer(ptr ptr)
@ stdcall -version=0x600+ CreateGraphicsTexture(ptr ptr)
@ stdcall -version=0x600+ DeleteGraphicsTexture(ptr)
@ stdcall -version=0x600+ UpdateGraphicsTexture(ptr ptr)
@ stdcall -version=0x600+ CreateGraphicsRenderTarget(ptr ptr)
@ stdcall -version=0x600+ DeleteGraphicsRenderTarget(ptr)
@ stdcall -version=0x600+ SetGraphicsRenderTarget(ptr ptr)
@ stdcall -version=0x600+ ClearGraphicsRenderTarget(ptr ptr)
@ stdcall -version=0x600+ PresentGraphicsRenderTarget(ptr)

; Windows 10 Advanced Font Rendering APIs
@ stdcall -version=0x600+ GetFontFileInfo(wstr ptr)
@ stdcall -version=0x600+ GetFontMetrics(ptr ptr)
@ stdcall -version=0x600+ GetGlyphMetrics(ptr long ptr)
@ stdcall -version=0x600+ GetGlyphBitmap(ptr long ptr ptr ptr)
@ stdcall -version=0x600+ GetGlyphOutlineData(ptr long ptr ptr ptr)
@ stdcall -version=0x600+ GetKerningPairs(ptr ptr ptr)
@ stdcall -version=0x600+ GetCharacterWidths(ptr long long ptr)
@ stdcall -version=0x600+ GetTextExtentEx(ptr wstr long ptr ptr ptr)
@ stdcall -version=0x600+ GetFontLanguageInfo(ptr)
@ stdcall -version=0x600+ GetGlyphIndicesEx(ptr wstr long ptr long)
@ stdcall -version=0x600+ GetFontFeatures(ptr ptr ptr)
@ stdcall -version=0x600+ ApplyFontFeatures(ptr ptr long ptr)
@ stdcall -version=0x600+ GetOpenTypeFeatures(ptr ptr ptr)
@ stdcall -version=0x600+ GetFontVariations(ptr ptr ptr)
@ stdcall -version=0x600+ SetFontVariations(ptr ptr long)
@ stdcall -version=0x600+ GetColorGlyphInfo(ptr long ptr)
@ stdcall -version=0x600+ RenderColorGlyph(ptr long ptr ptr)

; Windows 10 Advanced Path and Geometry APIs
@ stdcall -version=0x600+ CreateGeometryRealization(ptr ptr)
@ stdcall -version=0x600+ DeleteGeometryRealization(ptr)
@ stdcall -version=0x600+ RealizeGeometry(ptr ptr ptr)
@ stdcall -version=0x600+ GetGeometryBounds(ptr ptr)
@ stdcall -version=0x600+ GetGeometryLength(ptr ptr)
@ stdcall -version=0x600+ SimplifyGeometry(ptr ptr ptr)
@ stdcall -version=0x600+ CreatePathGeometry(ptr)
@ stdcall -version=0x600+ OpenPathGeometry(ptr ptr)
@ stdcall -version=0x600+ ClosePathGeometry(ptr)
@ stdcall -version=0x600+ AddBezierToPath(ptr ptr)
@ stdcall -version=0x600+ AddLineToPath(ptr ptr)
@ stdcall -version=0x600+ AddArcToPath(ptr ptr)
@ stdcall -version=0x600+ CreateRectangleGeometry(ptr ptr)
@ stdcall -version=0x600+ CreateEllipseGeometry(ptr ptr)
@ stdcall -version=0x600+ CreateRoundedRectangleGeometry(ptr ptr)
@ stdcall -version=0x600+ CombineGeometry(ptr ptr ptr long ptr)
@ stdcall -version=0x600+ TransformGeometry(ptr ptr ptr)
@ stdcall -version=0x600+ TessellateGeometry(ptr ptr ptr ptr)
@ stdcall -version=0x600+ GetGeometryRelation(ptr ptr ptr)

; Windows 10 Enhanced Bitmap and Image APIs
@ stdcall -version=0x600+ CreateWICFactory(ptr)
@ stdcall -version=0x600+ CreateWICBitmapFromMemory(long long ptr long ptr ptr)
@ stdcall -version=0x600+ CreateWICBitmapFromFile(wstr ptr)
@ stdcall -version=0x600+ CreateWICBitmapFromHBITMAP(ptr ptr long ptr)
@ stdcall -version=0x600+ CreateWICBitmapFromHICON(ptr ptr)
@ stdcall -version=0x600+ CreateWICBitmapFromIDirect2D1Image(ptr ptr)
@ stdcall -version=0x600+ GetWICBitmapInfo(ptr ptr)
@ stdcall -version=0x600+ CopyWICBitmap(ptr ptr)
@ stdcall -version=0x600+ ConvertWICBitmapFormat(ptr ptr ptr)
@ stdcall -version=0x600+ ScaleWICBitmap(ptr long long ptr)
@ stdcall -version=0x600+ RotateWICBitmap(ptr long ptr)
@ stdcall -version=0x600+ FlipWICBitmap(ptr long ptr)
@ stdcall -version=0x600+ CropWICBitmap(ptr ptr ptr)
@ stdcall -version=0x600+ GetWICBitmapPixels(ptr ptr ptr ptr)
@ stdcall -version=0x600+ SetWICBitmapPixels(ptr ptr ptr ptr)
@ stdcall -version=0x600+ LockWICBitmap(ptr ptr long ptr)
@ stdcall -version=0x600+ UnlockWICBitmap(ptr)
@ stdcall -version=0x600+ SaveWICBitmapToFile(ptr wstr ptr)
@ stdcall -version=0x600+ SaveWICBitmapToStream(ptr ptr ptr)

; Windows 10 Enhanced Text Rendering APIs
@ stdcall -version=0x600+ CreateTextRenderer(ptr)
@ stdcall -version=0x600+ SetTextRenderingParams(ptr ptr)
@ stdcall -version=0x600+ GetTextRenderingParams(ptr ptr)
@ stdcall -version=0x600+ CreateCustomTextRenderer(ptr ptr)
@ stdcall -version=0x600+ RenderText(ptr wstr long ptr ptr ptr)
@ stdcall -version=0x600+ MeasureText(ptr wstr long ptr ptr)
@ stdcall -version=0x600+ HitTestText(ptr wstr long ptr long long ptr ptr ptr)
@ stdcall -version=0x600+ SetTextAntialiasMode(ptr long)
@ stdcall -version=0x600+ GetTextAntialiasMode(ptr ptr)
@ stdcall -version=0x600+ CreateTextFormat(ptr wstr ptr long long long long wstr ptr)
@ stdcall -version=0x600+ CreateTextLayout(ptr wstr long ptr long long ptr)
@ stdcall -version=0x600+ DrawTextLayout(ptr ptr ptr ptr)
@ stdcall -version=0x600+ GetTextLayoutMetrics(ptr ptr)
@ stdcall -version=0x600+ GetTextLayoutLineMetrics(ptr ptr ptr)
@ stdcall -version=0x600+ SetTextLayoutProperty(ptr long ptr)
@ stdcall -version=0x600+ GetTextLayoutProperty(ptr long ptr)
@ stdcall -version=0x600+ CreateInlineObject(ptr ptr)
@ stdcall -version=0x600+ SetTextLayoutInlineObject(ptr ptr long long ptr)
@ stdcall -version=0x600+ CreateTypography(ptr)
@ stdcall -version=0x600+ SetTextLayoutTypography(ptr ptr long long ptr)

; Windows 10 Enhanced Drawing and Effects APIs
@ stdcall -version=0x600+ CreateDrawingStateBlock(ptr ptr)
@ stdcall -version=0x600+ SaveDrawingState(ptr ptr)
@ stdcall -version=0x600+ RestoreDrawingState(ptr ptr)
@ stdcall -version=0x600+ CreateLayer(ptr ptr ptr)
@ stdcall -version=0x600+ PushLayer(ptr ptr ptr)
@ stdcall -version=0x600+ PopLayer(ptr)
@ stdcall -version=0x600+ CreateMask(ptr ptr ptr ptr)
@ stdcall -version=0x600+ PushAxisAlignedClip(ptr ptr long)
@ stdcall -version=0x600+ PopAxisAlignedClip(ptr)
@ stdcall -version=0x600+ CreateEffect(ptr ptr ptr)
@ stdcall -version=0x600+ SetEffectInput(ptr long ptr)
@ stdcall -version=0x600+ GetEffectInput(ptr long ptr)
@ stdcall -version=0x600+ SetEffectProperty(ptr long ptr)
@ stdcall -version=0x600+ GetEffectProperty(ptr long ptr)
@ stdcall -version=0x600+ DrawEffect(ptr ptr ptr)
@ stdcall -version=0x600+ CreateGradientStopCollection(ptr ptr long long ptr)
@ stdcall -version=0x600+ CreateLinearGradientBrush(ptr ptr ptr ptr)
@ stdcall -version=0x600+ CreateRadialGradientBrush(ptr ptr ptr ptr)
@ stdcall -version=0x600+ CreateBitmapBrush(ptr ptr ptr ptr)
@ stdcall -version=0x600+ SetBrushTransform(ptr ptr)
@ stdcall -version=0x600+ GetBrushTransform(ptr ptr)
@ stdcall -version=0x600+ SetBrushOpacity(ptr long)
@ stdcall -version=0x600+ GetBrushOpacity(ptr ptr)
