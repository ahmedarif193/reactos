...
@ stdcall -version=0xA00+ D3DKMTAdjustFullscreenGamma(ptr) NtGdiDdDDIAdjustFullscreenGamma
...
@ stdcall -version=0x600+ D3DKMTConfigureSharedResource(ptr) NtGdiDdDDIConfigureSharedResource
@ stdcall -version=0xA00+ D3DKMTConnectDoorbell(ptr) NtGdiDdDDIConnectDoorbell
...
@ stdcall -version=0xA00+ D3DKMTCreateDoorbell(ptr) NtGdiDdDDICreateDoorbell
@ stdcall -version=0xA00+ D3DKMTCreateHwContext(ptr) NtGdiDdDDICreateHwContext
@ stdcall -version=0xA00+ D3DKMTCreateNativeFence(ptr) NtGdiDdDDICreateNativeFence
@ stdcall -version=0x600+ D3DKMTCreateOverlay(ptr) NtGdiDdDDICreateOverlay
@ stdcall -version=0xA00+ D3DKMTCreateProtectedSession(ptr) NtGdiDdDDICreateProtectedSession
...
@ stdcall -version=0xA00+ D3DKMTDestroyDoorbell(ptr) NtGdiDdDDIDestroyDoorbell
...
@ stdcall -version=0xA00+ D3DKMTDestroyProtectedSession(ptr) NtGdiDdDDIDestroyProtectedSession
...
@ stdcall -version=0xA00+ D3DKMTFlushHeapTransitions(ptr) NtGdiDdDDIFlushHeapTransitions
...
@ stdcall -version=0xA00+ D3DKMTGetNativeFenceLogDetail(ptr) NtGdiDdDDIGetNativeFenceLogDetail
@ stdcall -version=0xA00+ D3DKMTGetPostCompositionCaps(ptr) NtGdiDdDDIGetPostCompositionCaps
@ stdcall -version=0x600+ D3DKMTGetPresentHistory(ptr) NtGdiDdDDIGetPresentHistory
@ stdcall -version=0xA00+ D3DKMTGetProcessDeviceRemovalSupport(ptr) NtGdiDdDDIGetProcessDeviceRemovalSupport
...
@ stdcall -version=0xA00+ D3DKMTMarkDeviceAsError(ptr) NtGdiDdDDIMarkDeviceAsError
@ stdcall -version=0xA00+ D3DKMTNotifyWorkSubmission(ptr) NtGdiDdDDINotifyWorkSubmission
...
@ stdcall -version=0xA00+ D3DKMTOpenKeyedMutexFromNtHandle(ptr) NtGdiDdDDIOpenKeyedMutexFromNtHandle
@ stdcall -version=0xA00+ D3DKMTOpenNativeFenceFromNtHandle(ptr) NtGdiDdDDIOpenNativeFenceFromNtHandle
@ stdcall -version=0xA00+ D3DKMTOpenProtectedSessionFromNtHandle(ptr) NtGdiDdDDIOpenProtectedSessionFromNtHandle
@ stdcall -version=0x600+ D3DKMTOpenResource(ptr) NtGdiDdDDIOpenResource
@ stdcall -version=0xA00+ D3DKMTOutputDuplPresentToHwQueue(ptr) NtGdiDdDDIOutputDuplPresentToHwQueue
...
@ stdcall -version=0xA00+ D3DKMTPresentRedirected(ptr) NtGdiDdDDIPresentRedirected
...
@ stdcall -version=0xA00+ D3DKMTQueryProcessOfferInfo(ptr) NtGdiDdDDIQueryProcessOfferInfo
@ stdcall -version=0xA00+ D3DKMTQueryProtectedSessionInfoFromNtHandle(ptr) NtGdiDdDDIQueryProtectedSessionInfoFromNtHandle
@ stdcall -version=0xA00+ D3DKMTQueryProtectedSessionStatus(ptr) NtGdiDdDDIQueryProtectedSessionStatus
@ stdcall -version=0xA00+ D3DKMTQueryRemoteVidPnSourceFromGdiDisplayName(ptr) NtGdiDdDDIQueryRemoteVidPnSourceFromGdiDisplayName
...
@ stdcall -version=0xA00+ D3DKMTRegisterVailProcess(ptr) NtGdiDdDDIRegisterVailProcess
...
@ stdcall -version=0xA00+ D3DKMTSetHwProtectionTeardownRecovery(ptr) NtGdiDdDDISetHwProtectionTeardownRecovery
...
@ stdcall -version=0xA00+ D3DKMTSetVidPnSourceHwProtection(ptr) NtGdiDdDDISetVidPnSourceHwProtection
...
@ stdcall -version=0xA00+ D3DKMTTrimProcessCommitment(ptr) NtGdiDdDDITrimProcessCommitment
...
@ stdcall -version=0x600+ D3DKMTCreateSynchronizationObject2(ptr) NtGdiDdDDICreateSynchronizationObject2
@ stdcall -version=0x600+ D3DKMTWaitForSynchronizationObject2(ptr) NtGdiDdDDIWaitForSynchronizationObject2
@ stdcall -version=0x600+ D3DKMTSignalSynchronizationObject2(ptr) NtGdiDdDDISignalSynchronizationObject2
@ stdcall -version=0x600+ D3DKMTMakeResident(ptr) NtGdiDdDDIMakeResident
@ stdcall -version=0x600+ D3DKMTEvict(ptr) NtGdiDdDDIEvict
@ stdcall -version=0x600+ D3DKMTQueryVideoMemoryInfo(ptr) NtGdiDdDDIQueryVideoMemoryInfo
@ stdcall -version=0x600+ D3DKMTCreatePagingQueue(ptr) NtGdiDdDDICreatePagingQueue
...
@ stdcall -version=0x600+ D3DKMTWaitForVerticalBlankEvent2(ptr) NtGdiDdDDIWaitForVerticalBlankEvent2
@ stdcall -version=0x600+ D3DKMTCheckVidPnExclusiveOwnership(ptr) NtGdiDdDDICheckVidPnExclusiveOwnership
@ stdcall -version=0x600+ D3DKMTEnumAdapters(ptr) NtGdiDdDDIEnumAdapters
@ stdcall -version=0x600+ D3DKMTOpenAdapterFromLuid(ptr) NtGdiDdDDIOpenAdapterFromLuid
@ stdcall -version=0x600+ D3DKMTCreateAllocation2(ptr) NtGdiDdDDICreateAllocation2
@ stdcall -version=0x600+ D3DKMTOpenResource2(ptr) NtGdiDdDDIOpenResource2
@ stdcall -version=0x600+ D3DKMTOpenSynchronizationObject(ptr) NtGdiDdDDIOpenSynchronizationObject
@ stdcall -version=0x600+ D3DKMTCreateKeyedMutex(ptr) NtGdiDdDDICreateKeyedMutex
@ stdcall -version=0x600+ D3DKMTOpenKeyedMutex(ptr) NtGdiDdDDIOpenKeyedMutex
@ stdcall -version=0x600+ D3DKMTDestroyKeyedMutex(ptr) NtGdiDdDDIDestroyKeyedMutex
@ stdcall -version=0x600+ D3DKMTAcquireKeyedMutex(ptr) NtGdiDdDDIAcquireKeyedMutex
@ stdcall -version=0x600+ D3DKMTReleaseKeyedMutex(ptr) NtGdiDdDDIReleaseKeyedMutex
@ stdcall -version=0x600+ D3DKMTGetOverlayState(ptr) NtGdiDdDDIGetOverlayState
...
@ stdcall -version=0x600+ D3DKMTDestroyAllocation2(ptr) NtGdiDdDDIDestroyAllocation2
@ stdcall -version=0x600+ D3DKMTLock2(ptr) NtGdiDdDDILock2
@ stdcall -version=0x600+ D3DKMTUnlock2(ptr) NtGdiDdDDIUnlock2
...
@ stdcall -version=0x600+ D3DKMTChangeVideoMemoryReservation(ptr) NtGdiDdDDIChangeVideoMemoryReservation
@ stdcall -version=0x600+ D3DKMTSetStablePowerState(ptr) NtGdiDdDDISetStablePowerState
@ stdcall -version=0x600+ D3DKMTQueryClockCalibration(ptr) NtGdiDdDDIQueryClockCalibration
@ stdcall -version=0x600+ D3DKMTSetContextInProcessSchedulingPriority(ptr) NtGdiDdDDISetContextInProcessSchedulingPriority
@ stdcall -version=0x600+ D3DKMTGetContextInProcessSchedulingPriority(ptr) NtGdiDdDDIGetContextInProcessSchedulingPriority
@ stdcall -version=0x600+ D3DKMTRegisterTrimNotification(ptr) NtGdiDdDDIRegisterTrimNotification
...
@ stdcall -version=0x600+ D3DKMTOpenSyncObjectFromNtHandle(ptr) NtGdiDdDDIOpenSyncObjectFromNtHandle
@ stdcall -version=0x600+ D3DKMTOpenSyncObjectFromNtHandle2(ptr) NtGdiDdDDIOpenSyncObjectFromNtHandle2
@ stdcall -version=0x600+ D3DKMTOpenSyncObjectNtHandleFromName(ptr) NtGdiDdDDIOpenSyncObjectNtHandleFromName
@ stdcall -version=0x600+ D3DKMTOpenNtHandleFromName(ptr) NtGdiDdDDIOpenNtHandleFromName
@ stdcall -version=0x600+ D3DKMTCreateOutputDupl(ptr) NtGdiDdDDICreateOutputDupl
@ stdcall -version=0x600+ D3DKMTDestroyOutputDupl(ptr) NtGdiDdDDIDestroyOutputDupl
@ stdcall -version=0x600+ D3DKMTOutputDuplGetFrameInfo(ptr) NtGdiDdDDIOutputDuplGetFrameInfo
@ stdcall -version=0x600+ D3DKMTOutputDuplGetMetaData(ptr) NtGdiDdDDIOutputDuplGetMetaData
@ stdcall -version=0x600+ D3DKMTOutputDuplGetPointerShapeData(ptr) NtGdiDdDDIOutputDuplGetPointerShapeData
@ stdcall -version=0x600+ D3DKMTOutputDuplPresent(ptr) NtGdiDdDDIOutputDuplPresent
@ stdcall -version=0x600+ D3DKMTOutputDuplReleaseFrame(ptr) NtGdiDdDDIOutputDuplReleaseFrame
@ stdcall -version=0x600+ D3DKMTPresentMultiPlaneOverlay(ptr) NtGdiDdDDIPresentMultiPlaneOverlay
@ stdcall -version=0x600+ D3DKMTCheckMultiPlaneOverlaySupport(ptr) NtGdiDdDDICheckMultiPlaneOverlaySupport
@ stdcall -version=0x600+ D3DKMTEnumAdapters3(ptr) NtGdiDdDDIEnumAdapters3
@ stdcall -version=0x600+ D3DKMTAcquireKeyedMutex2(ptr) NtGdiDdDDIAcquireKeyedMutex2
@ stdcall -version=0x600+ D3DKMTCreateKeyedMutex2(ptr) NtGdiDdDDICreateKeyedMutex2
@ stdcall -version=0x600+ D3DKMTOpenKeyedMutex2(ptr) NtGdiDdDDIOpenKeyedMutex2
@ stdcall -version=0x600+ D3DKMTReleaseKeyedMutex2(ptr) NtGdiDdDDIReleaseKeyedMutex2
@ stdcall -version=0x600+ D3DKMTCancelPresents(ptr) NtGdiDdDDICancelPresents
@ stdcall -version=0x600+ D3DKMTCreateContextVirtual(ptr) NtGdiDdDDICreateContextVirtual
@ stdcall -version=0x600+ D3DKMTGetDWMVerticalBlankEvent(ptr) NtGdiDdDDIGetDWMVerticalBlankEvent
@ stdcall -version=0x600+ D3DKMTGetMultiPlaneOverlayCaps(ptr) NtGdiDdDDIGetMultiPlaneOverlayCaps
...
@ stdcall -version=0x600+ D3DKMTGetPresentQueueEvent(long ptr) NtGdiDdDDIGetPresentQueueEvent
@ stdcall -version=0x600+ D3DKMTShareObjects(long ptr ptr long ptr) NtGdiDdDDIShareObjects
