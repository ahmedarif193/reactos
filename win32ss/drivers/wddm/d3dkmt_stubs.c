...
#define IOCTL_D3DKMT_DESTROYHWQUEUE \
    CTL_CODE(FILE_DEVICE_VIDEO, 0x19C, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_D3DKMT_SUBMITCOMMANDTOHWQUEUE \
    CTL_CODE(FILE_DEVICE_VIDEO, 0x19D, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_D3DKMT_SUBMITWAITFORSYNCOBJECTSTOHWQUEUE \
    CTL_CODE(FILE_DEVICE_VIDEO, 0x1C8, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_D3DKMT_SUBMITSIGNALSYNCOBJECTSTOHWQUEUE \
    CTL_CODE(FILE_DEVICE_VIDEO, 0x1C9, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_D3DKMT_SUBMITPRESENTBLTTOHWQUEUE \
    CTL_CODE(FILE_DEVICE_VIDEO, 0x1CA, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_D3DKMT_SUBMITPRESENTTOHWQUEUE \
    CTL_CODE(FILE_DEVICE_VIDEO, 0x1CB, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define WDDM_CA_FLAG_NT_SECURITY_SHARING   0x00000040U
    ...
    _Out_ PBOOLEAN StandardAllocation)
{
    ...
    *StandardAllocation = (RawFlags & WDDM_CA_FLAG_STANDARD_ALLOCATION) != 0;
    ...
    if ((RawFlags & WDDM_CA_FLAG_CREATE_SHARED) != 0 && (RawFlags & WDDM_CA_FLAG_CREATE_RESOURCE) == 0)
        return STATUS_INVALID_PARAMETER;
    if ((RawFlags & WDDM_CA_FLAG_NT_SECURITY_SHARING) != 0 &&
        (RawFlags & WDDM_CA_FLAG_CREATE_SHARED) == 0)
    {
        return STATUS_INVALID_PARAMETER;
    }
...
{
    return WddmBridgeRejectBadBuffer(WddmBridgeCaptureFixedIoctl(IOCTL_D3DKMT_CREATEHWQUEUE, pData, sizeof(*pData), TRUE));
}
...
{
    return WddmBridgeRejectBadBuffer(WddmBridgeCaptureFixedIoctl(IOCTL_D3DKMT_DESTROYHWQUEUE, (PVOID)pData, sizeof(*pData), FALSE));
}
...
{
    return WddmBridgeRejectBadBuffer(WddmBridgeCaptureFixedIoctl(IOCTL_D3DKMT_SUBMITWAITFORSYNCOBJECTSTOHWQUEUE, (PVOID)pData, sizeof(*pData), FALSE));
}
...
{
    return WddmBridgeRejectBadBuffer(WddmBridgeCaptureFixedIoctl(IOCTL_D3DKMT_SUBMITSIGNALSYNCOBJECTSTOHWQUEUE, (PVOID)pData, sizeof(*pData), FALSE));
}
...
{
    return WddmBridgeRejectBadBuffer(WddmBridgeCaptureFixedIoctl(IOCTL_D3DKMT_SUBMITPRESENTBLTTOHWQUEUE, (PVOID)pData, sizeof(*pData), FALSE));
}
...
{
    return WddmBridgeRejectBadBuffer(WddmBridgeCaptureFixedIoctl(IOCTL_D3DKMT_SUBMITPRESENTTOHWQUEUE, pData, sizeof(*pData), FALSE));
}
...
NTSTATUS
APIENTRY
D3DKMTCreateHwContext(_Inout_ struct _D3DKMT_CREATEHWCONTEXT *pData)
{
...
#else
    UNREFERENCED_PARAMETER(pData);
    return WddmBridgeSendIoctl(IOCTL_D3DKMT_CREATEHWCONTEXT, NULL, 0, NULL, 0);
#endif
}

NTSTATUS
APIENTRY
D3DKMTDestroyHwContext(_In_ CONST struct _D3DKMT_DESTROYHWCONTEXT *pData)
{
#if (REACTOS_WDDM_TARGET_LEVEL < 2200)
    UNREFERENCED_PARAMETER(pData);
    return STATUS_NOT_IMPLEMENTED;
#else
    UNREFERENCED_PARAMETER(pData);
    return WddmBridgeSendIoctl(IOCTL_D3DKMT_DESTROYHWCONTEXT, NULL, 0, NULL, 0);
#endif
}

NTSTATUS
APIENTRY
D3DKMTSetMonitorColorSpaceTransform(_In_ struct _D3DKMT_SET_COLORSPACE_TRANSFORM *pData)
{
