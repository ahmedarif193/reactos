...
@ stdcall -version=0x600+ AlpcRundownCompletionList(ptr)
...
@ stdcall -version=0x600+ EtwEventSetInformation(int64 long ptr long)
@ stdcall -version=0x600+ EtwEventUnregister(int64)
@ stdcall -version=0x600+ EtwEventWrite(int64 ptr long ptr)
@ stdcall -version=0x601+ EtwEventWriteEx(int64 ptr int64 long ptr ptr long ptr)
...
@ stdcall -version=0x600+ EtwEventWriteString(int64 long int64 wstr)
...
@ stub -version=0x600+ -arch=win64 ExpInterlockedPopEntrySListEnd8
@ stdcall -arch=x86_64,arm64 ExpInterlockedPopEntrySListFault()
@ stub -version=0x600+ -arch=win64 ExpInterlockedPopEntrySListFault8
@ stdcall -arch=x86_64,arm64 ExpInterlockedPopEntrySListResume()
@ stub -version=0x600+ -arch=win64 ExpInterlockedPopEntrySListResume8
...
@ stdcall -stub -version=0x600+ -arch=win64 LdrGetKnownDllSectionHandle(wstr long ptr)
...
@ stdcall -stub -version=0x600+ -arch=win64 LdrProcessInitializationComplete()
...
@ stdcall -version=0x602+ LdrResolveDelayLoadsFromDll(ptr str long)
@ stdcall -version=0x600+ LdrResFindResource(ptr long long long ptr ptr ptr ptr long)
@ stdcall -version=0x600+ LdrResFindResourceDirectory(ptr long long ptr ptr ptr long ptr)
...
@ stdcall NtAlertThreadByThreadId(long)
...
@ stdcall -version=0x602+ NtCreateWaitCompletionPacket(ptr long ptr)
@ stdcall -version=0x602+ NtAssociateWaitCompletionPacket(ptr ptr ptr ptr ptr long ptr ptr)
@ stdcall -version=0x602+ NtCancelWaitCompletionPacket(ptr long)
...
@ stdcall -version=0x600+ NtCreatePrivateNamespace(ptr long ptr ptr)
...
@ stdcall -arch=win64 NtCreateSectionEx(ptr long ptr ptr long long ptr ptr long)
...
@ stdcall -version=0x600+ NtCreateTransactionManager(ptr long ptr ptr long long)
...
@ stdcall -version=0x602+ NtCreateWnfStateName(ptr long long long ptr long ptr)
...
@ stdcall -version=0x602+ NtDeleteWnfStateData(ptr ptr)
@ stdcall -version=0x602+ NtDeleteWnfStateName(ptr)
...
@ stdcall -version=0x602+ NtCreateLowBoxToken(ptr ptr long ptr ptr long ptr long ptr)
@ stdcall NtFindAtom(ptr long ptr)
@ stdcall NtFlushBuffersFile(long ptr)
@ stdcall NtFlushBuffersFileEx(long long ptr long ptr)
...
@ stdcall -arch=win64 NtMapViewOfSectionEx(long long ptr ptr ptr long long ptr long)
...
@ stdcall NtNotifyChangeDirectoryFileEx(long long ptr ptr ptr ptr long long long long)
...
@ stdcall -version=0x600+ NtOpenKeyTransactedEx(ptr long ptr long long)
...
@ stdcall -version=0x600+ NtOpenPrivateNamespace(ptr long ptr ptr)
...
@ stdcall NtQueryInformationByName(ptr ptr ptr long long)
...
@ stdcall -version=0x602+ NtQueryWnfStateData(ptr ptr ptr ptr ptr ptr)
@ stdcall -version=0x602+ NtQueryWnfStateNameInformation(ptr long ptr ptr long)
...
@ stdcall -version=0x602+ NtSubscribeWnfStateChange(ptr long long ptr)
...
@ stdcall -arch=win64 NtUnmapViewOfSectionEx(long ptr long)
@ stdcall -version=0x602+ NtUnsubscribeWnfStateChange(ptr)
@ stdcall -version=0x602+ NtUpdateWnfStateData(ptr ptr long ptr ptr long long)
@ stdcall NtVdmControl(long ptr)
@ stdcall NtWaitForDebugEvent(ptr long ptr ptr)
@ stdcall NtWaitForKeyedEvent(ptr ptr long ptr)
@ stdcall NtWaitForAlertByThreadId(ptr ptr)
...
@ stdcall -arch=win64 RtlAddFunctionTable(ptr long long)
@ stdcall -arch=win64 RtlAddGrowableFunctionTable(ptr ptr long long long long)
@ stdcall -version=0x600+ RtlAddMandatoryAce(ptr long long long long ptr)
@ stdcall RtlAddRefActivationContext(ptr)
@ stdcall RtlAddRefMemoryStream(ptr)
@ stdcall -version=0x600+ RtlAddSIDToBoundaryDescriptor(ptr ptr)
@ stdcall -version=0x600+ RtlAddIntegrityLabelToBoundaryDescriptor(ptr ptr) ; not present in Win11
...
@ stdcall -stub -version=0x600+ -arch=win64 RtlCompleteProcessCloning(long)
...
@ stdcall -version=0x600+ RtlCreateBoundaryDescriptor(ptr long)
...
@ stdcall -version=0x600+ RtlCreateProcessParametersEx(ptr wstr ptr wstr wstr ptr wstr wstr ptr ptr long)
...
@ stdcall -version=0x602+ RtlIsCapabilitySid(ptr)
@ stdcall -version=0x602+ RtlGetAppContainerSidType(ptr ptr)
@ stdcall -version=0x602+ RtlGetAppContainerParent(ptr ptr)
@ stdcall -version=0x602+ RtlIsParentOfChildAppContainer(ptr ptr)
@ stdcall -version=0x602+ RtlCheckTokenMembershipEx(ptr ptr long ptr)
...
@ stdcall -version=0x600+ RtlDeleteBoundaryDescriptor(ptr)
@ stdcall RtlDeleteCriticalSection(ptr)
@ stdcall RtlDeleteElementGenericTable(ptr ptr)
@ stdcall RtlDeleteElementGenericTableAvl(ptr ptr)
@ cdecl -arch=win64 RtlDeleteFunctionTable(ptr)
@ stdcall -arch=win64 RtlDeleteGrowableFunctionTable(ptr)
...
@ stdcall -arch=arm64 ChpeMarkEcCodeRange(ptr long)
...
@ stdcall -version=0x600+ -arch=win64 RtlGetExtendedContextLength2(long ptr int64)
@ stdcall -version=0x600+ -arch=win64 -ret64 RtlGetExtendedFeaturesMask(ptr)
...
@ stdcall -arch=win64 RtlGetFunctionTableListHead()
...
@ stdcall -version=0x600+ RtlGetProcessPreferredUILanguages(long ptr ptr ptr)
...
@ stdcall -version=0x600+ -arch=win64 RtlInitializeExtendedContext(ptr long ptr)
@ stdcall -version=0x600+ -arch=win64 RtlInitializeExtendedContext2(ptr long ptr int64)
...
@ stdcall -arch=win64 RtlInstallFunctionTableCallback(double double long ptr ptr ptr)
@ stdcall -arch=win64 RtlGrowFunctionTable(ptr long)
...
@ stdcall -arch=win64 RtlInterlockedPushListSList(ptr ptr ptr long)
...
@ stdcall -version=0x600+ RtlIsCurrentProcess(ptr)
...
@ stdcall -version=0xA00+ RtlLogUnexpectedCodepath(ptr)
...
@ stub -version=0x600+ -arch=win64 RtlNtdllName
...
@ stdcall RtlRegisterCfgTargetRange(ptr long)
...
@ stdcall RtlSetCfgTargetValidity(ptr long long ptr)
...
@ stdcall -version=0x600+ -arch=win64 RtlSetExtendedFeaturesMask(ptr int64)
...
@ stdcall -version=0x600+ RtlSetProcessPreferredUILanguages(long ptr ptr)
...
@ stdcall -version=0x600+ -arch=win64 RtlOpenCrossProcessEmulatorWorkConnection(ptr ptr ptr)
...
@ stdcall -version=0x600+ -arch=x86_64 RtlWow64GetSharedInfoProcess(ptr ptr ptr)
...
@ stdcall -stub -version=0x600+ -arch=win64 RtlWow64LogMessageInEventLogger(long long long)
@ stdcall -version=0x600+ -arch=win64 RtlWow64PopCrossProcessWorkFromFreeList(ptr)
@ stdcall -version=0x600+ -arch=win64 RtlWow64PushCrossProcessWorkOntoWorkList(ptr ptr ptr)
@ stdcall -version=0x600+ -arch=win64 RtlWow64RequestCrossProcessHeavyFlush(ptr)
...
@ stdcall -stub -version=0x600+ -arch=win64 RtlpQueryProcessDebugInformationFromWow64(long ptr)
...
@ stdcall -version=0x600+ TpAllocAlpcCompletion(ptr ptr ptr ptr ptr)
@ stdcall -version=0x600+ TpAllocAlpcCompletionEx(ptr ptr ptr ptr ptr)
...
@ stdcall -version=0x600+ TpAlpcRegisterCompletionList(ptr)
@ stdcall -version=0x600+ TpAlpcUnregisterCompletionList(ptr)
...
@ stdcall -version=0x600+ TpCallbackSendAlpcMessageOnCompletion(ptr ptr long ptr)
@ stdcall -version=0x600+ TpCallbackSendPendingAlpcMessage(ptr)
...
@ stdcall -version=0x600+ TpReleaseAlpcCompletion(ptr)
...
@ stdcall -version=0x602+ TpSetWaitEx(ptr long ptr ptr)
@ stdcall -version=0x600+ TpSimpleTryPost(ptr ptr ptr)
@ stdcall -version=0x600+ TpStartAsyncIoOperation(ptr)
@ stdcall -version=0x600+ TpWaitForAlpcCompletion(ptr)
...
@ stdcall ZwAlertThreadByThreadId(long)
...
@ stdcall -version=0x600+ ZwCancelSynchronousIoFile(ptr ptr ptr)
...
@ stdcall -version=0x602+ ZwCreateWaitCompletionPacket(ptr long ptr)
@ stdcall -version=0x602+ ZwAssociateWaitCompletionPacket(ptr ptr ptr ptr ptr long ptr ptr)
@ stdcall -version=0x602+ ZwCancelWaitCompletionPacket(ptr long)
...
@ stdcall -version=0x600+ ZwCreateTransactionManager(ptr long ptr ptr long long) NtCreateTransactionManager
...
@ stdcall -version=0x602+ ZwCreateWnfStateName(ptr long long long ptr long ptr)
...
@ stdcall -version=0x602+ ZwDeleteWnfStateData(ptr ptr)
@ stdcall -version=0x602+ ZwDeleteWnfStateName(ptr)
...
@ stdcall -version=0x602+ ZwCreateLowBoxToken(ptr ptr long ptr ptr long ptr long ptr)
@ stdcall -version=0x600+ ZwCreatePrivateNamespace(ptr long ptr ptr)
@ stdcall ZwFindAtom(ptr long ptr)
@ stdcall ZwFlushBuffersFile(long ptr)
@ stdcall ZwFlushBuffersFileEx(long long ptr long ptr)
...
@ stdcall -version=0x600+ ZwFlushProcessWriteBuffers()
...
@ stdcall ZwNotifyChangeDirectoryFileEx(long long ptr ptr ptr ptr long long long long)
...
@ stdcall -version=0x600+ ZwOpenPrivateNamespace(ptr long ptr ptr)
...
@ stdcall ZwQueryDirectoryFileEx(long long ptr ptr ptr ptr long long long ptr)
...
@ stdcall ZwQueryInformationByName(ptr ptr ptr long long)
...
@ stdcall -version=0x601+ ZwQuerySystemInformationEx(long ptr long ptr long ptr)
...
@ stdcall -version=0x602+ ZwQueryWnfStateData(ptr ptr ptr ptr ptr ptr)
@ stdcall -version=0x602+ ZwQueryWnfStateNameInformation(ptr long ptr ptr long)
...
@ stdcall -version=0x602+ ZwSubscribeWnfStateChange(ptr long long ptr)
...
@ stdcall -version=0x602+ ZwUnsubscribeWnfStateChange(ptr)
@ stdcall -version=0x602+ ZwUpdateWnfStateData(ptr ptr long ptr ptr long long)
@ stdcall ZwVdmControl(long ptr)
@ stdcall ZwWaitForDebugEvent(ptr long ptr ptr)
@ stdcall ZwWaitForKeyedEvent(ptr ptr long ptr)
@ stdcall ZwWaitForAlertByThreadId(ptr ptr)
...
@ cdecl -stub -version=0x600+ -arch=win64 __misaligned_access()
