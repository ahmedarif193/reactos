...
@ stdcall -version=0x501+ LdrFindCreateProcessManifest(long ptr ptr long ptr)
...
@ stdcall -stub NtCancelSynchronousIoFile(long ptr ptr)
...
@ stdcall -stub NtFlushProcessWriteBuffers()
...
@ stdcall -version=0x600+ NtQuerySystemInformationEx(long long long long long long)
...
@ stdcall -stub NtRemoveIoCompletionEx(ptr ptr long ptr ptr long)
...
@ stdcall -arch=x86_64 NtWow64AllocateVirtualMemory64(long ptr int64 ptr long long)
@ stdcall -arch=x86_64 NtWow64GetContextThread(long ptr)
@ stdcall -arch=x86_64 NtWow64GetNativeSystemInformation(long ptr long ptr)
@ stdcall -arch=x86_64 NtWow64IsProcessorFeaturePresent(long)
@ stdcall -arch=x86_64 NtWow64QueryInformationProcess64(long long ptr long ptr)
@ stdcall -arch=x86_64 NtWow64ReadVirtualMemory64(long int64 ptr int64 ptr)
@ stdcall -arch=x86_64 NtWow64SetContextThread(long ptr)
@ stdcall -arch=x86_64 NtWow64WriteVirtualMemory64(long int64 ptr int64 ptr)
...
@ stdcall -version=0x600+ ZwQuerySystemInformationEx(long long long long long long)
...
@ stdcall -arch=x86_64 ZwWow64GetContextThread(long ptr)
@ stdcall -arch=x86_64 ZwWow64SetContextThread(long ptr)
