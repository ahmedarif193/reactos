...
@ stdcall -stub NtCancelIoFileEx(long ptr ptr)
...
@ stdcall NtWow64AllocateVirtualMemory64(long ptr int64 ptr long long)
@ stdcall NtWow64GetContextThread(long ptr)
@ stdcall NtWow64GetNativeSystemInformation(long ptr long ptr)
@ stdcall NtWow64IsProcessorFeaturePresent(long)
@ stdcall NtWow64QueryInformationProcess64(long long ptr long ptr)
@ stdcall NtWow64ReadVirtualMemory64(long int64 ptr int64 ptr)
@ stdcall NtWow64SetContextThread(long ptr)
@ stdcall NtWow64WriteVirtualMemory64(long int64 ptr int64 ptr)
...
@ stdcall ZwWow64GetContextThread(long ptr)
@ stdcall ZwWow64SetContextThread(long ptr)
