...
@ stdcall -arch=riscv64 NtCurrentTeb()
...
@ stdcall -version=0x600+ -arch=x86_64 RtlCopyExtendedContext(ptr long ptr)
...
@ stdcall -version=0x600+ -arch=x86_64 RtlGetExtendedContextLength2(long ptr int64)
...
@ stdcall -version=0x600+ -arch=x86_64 RtlInitializeExtendedContext(ptr long ptr)
@ stdcall -version=0x600+ -arch=x86_64 RtlInitializeExtendedContext2(ptr long ptr int64)
...
@ stdcall -version=0x600+ -arch=x86_64 RtlWow64GetCpuAreaInfo(ptr long ptr)
...
@ stdcall -stub -version=0x600+ -arch=arm64 RtlWow64GetThreadContext(ptr ptr)
@ stdcall -version=0x600+ -arch=x86_64 RtlWow64GetThreadSelectorEntry(ptr ptr long ptr)
...
@ stdcall -stub -version=0x600+ -arch=arm64 RtlWow64SetThreadContext(ptr ptr)
