...
@ stdcall -version=0x600+ -arch=x86_64,arm64 RtlGetExtendedContextLength(long ptr)
@ stdcall -version=0x600+ -arch=win64 RtlGetExtendedContextLength2(long ptr int64)
@ stdcall -version=0x600+ -arch=x86_64,arm64 -ret64 RtlGetExtendedFeaturesMask(ptr)
...
@ stdcall -version=0x600+ -arch=x86_64,arm64 RtlInitializeExtendedContext(ptr long ptr)
...
@ stdcall -version=0x600+ -arch=x86_64,arm64 RtlSetExtendedFeaturesMask(ptr int64)
