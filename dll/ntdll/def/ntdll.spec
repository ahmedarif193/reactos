...
@ stdcall -version=0x600+ -arch=x86_64 RtlOpenCrossProcessEmulatorWorkConnection(ptr ptr ptr)
@ stdcall -version=0x600+ -arch=x86_64 RtlWow64GetCpuAreaInfo(ptr long ptr)
@ stdcall -version=0x600+ -arch=x86_64 RtlWow64GetCurrentMachine()
@ stdcall -version=0x600+ -arch=x86_64 RtlWow64GetProcessMachines(ptr ptr ptr)
...
@ stdcall -version=0x600+ -arch=x86_64 RtlWow64PopCrossProcessWorkFromFreeList(ptr)
@ stdcall -version=0x600+ -arch=x86_64 RtlWow64PushCrossProcessWorkOntoWorkList(ptr ptr ptr)
@ stdcall -version=0x600+ -arch=x86_64 RtlWow64RequestCrossProcessHeavyFlush(ptr)
