# api-ms-win-crt-stdio-l1-1-0 - Auto-generated forwarders to ucrtbase.dll
...
@ cdecl __conio_common_vcscanf(int64 str ptr ptr) ucrtbase.__conio_common_vcscanf
...
@ cdecl __conio_common_vcwscanf(int64 wstr ptr ptr) ucrtbase.__conio_common_vcwscanf
...
@ cdecl _getcwd(ptr long) ucrtbase._getcwd
...
@ cdecl _o___conio_common_vcscanf() ucrtbase._o___conio_common_vcscanf
...
@ cdecl _o___conio_common_vcwscanf() ucrtbase._o___conio_common_vcwscanf
...
@ cdecl _o__cgets_s() ucrtbase._o__cgets_s
...
@ cdecl _o__getsystime() ucrtbase._o__getsystime
