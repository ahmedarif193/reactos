# api-ms-win-crt-math-l1-1-0 - Auto-generated forwarders to ucrtbase.dll
...
@ cdecl __conio_common_vcprintf_p(int64 str ptr ptr) ucrtbase.__conio_common_vcprintf_p
@ cdecl __conio_common_vcprintf_s(int64 str ptr ptr) ucrtbase.__conio_common_vcprintf_s
@ cdecl __conio_common_vcwprintf(int64 wstr ptr ptr) ucrtbase.__conio_common_vcwprintf
@ cdecl __conio_common_vcwprintf_p(int64 wstr ptr ptr) ucrtbase.__conio_common_vcwprintf_p
@ cdecl __conio_common_vcwprintf_s(int64 wstr ptr ptr) ucrtbase.__conio_common_vcwprintf_s
...
@ cdecl _ismbbkprint_l(long ptr) ucrtbase._ismbbkprint_l
@ cdecl _ismbbprint(long) ucrtbase._ismbbprint
@ cdecl _ismbbprint_l(long ptr) ucrtbase._ismbbprint_l
...
@ cdecl _ldexp(ptr double long) ucrtbase._ldexp
@ cdecl _ldlog(double long) ucrtbase._ldlog
@ cdecl _ldsin(double long) ucrtbase._ldsin
...
@ cdecl _o___conio_common_vcwprintf_p() ucrtbase._o___conio_common_vcwprintf_p
@ cdecl _o___conio_common_vcwprintf_s() ucrtbase._o___conio_common_vcwprintf_s
...
@ cdecl _o__dlog(double long) ucrtbase._o__dlog
@ cdecl _o__dsin(double long) ucrtbase._o__dsin
@ cdecl _o__expand(ptr long) ucrtbase._o__expand
@ cdecl _o__fdexp(ptr float long) ucrtbase._o__fdexp
@ cdecl _o__fdlog(float long) ucrtbase._o__fdlog
@ cdecl _o__fdsin(float long) ucrtbase._o__fdsin
...
@ cdecl _o__ismbbkprint() ucrtbase._o__ismbbkprint
@ cdecl _o__ismbbkprint_l() ucrtbase._o__ismbbkprint_l
@ cdecl _o__ismbbprint() ucrtbase._o__ismbbprint
@ cdecl _o__ismbbprint_l() ucrtbase._o__ismbbprint_l
@ cdecl _o__ismbcprint(long) ucrtbase._o__ismbcprint
@ cdecl _o__ismbcprint_l(long ptr) ucrtbase._o__ismbcprint_l
@ cdecl _o__ldexp(ptr double long) ucrtbase._o__ldexp
@ cdecl _o__ldlog(double long) ucrtbase._o__ldlog
@ cdecl _o__ldsin(double long) ucrtbase._o__ldsin
