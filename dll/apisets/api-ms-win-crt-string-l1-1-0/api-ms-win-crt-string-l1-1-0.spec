# api-ms-win-crt-string-l1-1-0 - Auto-generated forwarders to ucrtbase.dll
...
@ cdecl _mbstrnlen(str long) ucrtbase._mbstrnlen
@ cdecl _mbstrnlen_l(str long ptr) ucrtbase._mbstrnlen_l
@ cdecl _o__mbstrlen(str) ucrtbase._o__mbstrlen
@ cdecl _o__mbstrlen_l(str ptr) ucrtbase._o__mbstrlen_l
@ cdecl _o__mbstrnlen() ucrtbase._o__mbstrnlen
@ cdecl _o__mbstrnlen_l() ucrtbase._o__mbstrnlen_l
...
@ cdecl _o__strerror_s() ucrtbase._o__strerror_s
...
@ cdecl _strerror_s(str) ucrtbase._strerror_s
