...
@ stdcall -version=0x602+ DeleteAppContainerProfile(wstr)
@ stdcall -version=0x602+ GetAppContainerRegistryLocation(long ptr)
@ stdcall -version=0x602+ GetAppContainerFolderPath(wstr ptr)
