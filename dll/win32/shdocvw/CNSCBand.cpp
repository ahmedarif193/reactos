...
{
    m_bFocused = TRUE;
    IUnknown_OnFocusChangeIS(m_pSite, static_cast<IUnknown*>(static_cast<IDeskBand*>(this)), TRUE);
    bHandled = FALSE;
    return 0;
}
...
{
    IUnknown_OnFocusChangeIS(m_pSite, static_cast<IUnknown*>(static_cast<IDeskBand*>(this)), FALSE);
    m_bFocused = FALSE;
    return 0;
}
