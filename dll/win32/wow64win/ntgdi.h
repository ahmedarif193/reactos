...
W32KAPI BOOL     WINAPI NtGdiGetTextExtent( HDC hdc, const WCHAR *str, INT count, SIZE *size, UINT flags );
...
#ifdef __REACTOS__
W32KAPI NTSTATUS WINAPI NtGdiDdDDIOpenAdapterFromGdiDisplayName( D3DKMT_OPENADAPTERFROMGDIDISPLAYNAME *desc );
#endif
