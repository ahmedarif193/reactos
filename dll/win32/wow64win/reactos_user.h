...
C_ASSERT(sizeof(ROS_GETCLIPBDATA32) == 0xc);
C_ASSERT(sizeof(ROS_GETCLIPBDATA64) == 0x10);
...
C_ASSERT(sizeof(ROS_SETCLIPBDATA) == 0x8);
...
typedef HANDLE (WINAPI *ROS_NTUSER_GET_CLIPBOARD_DATA)(UINT, ROS_GETCLIPBDATA64 *);
typedef HANDLE (WINAPI *ROS_NTUSER_SET_CLIPBOARD_DATA)(UINT, HANDLE, ROS_SETCLIPBDATA *);
