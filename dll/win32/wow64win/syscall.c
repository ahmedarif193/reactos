...
#ifdef __REACTOS__
NTSYSAPI void WINAPI RtlRaiseException( EXCEPTION_RECORD *record );
#endif
...
#define SYSCALL_STUB(name) NTSTATUS WINAPI wow64_stub_ ## name( UINT *args ) { stub_syscall( #name ); }
ALL_SYSCALL_STUBS

static void * const win32_syscalls[] =
{
#define SYSCALL_ENTRY(id,name,handler,args) handler,
    ALL_SYSCALLS32
#undef SYSCALL_ENTRY
};
...
{
#define SYSCALL_ENTRY(id,name,handler,args) args,
    ALL_SYSCALLS32
#undef SYSCALL_ENTRY
};
