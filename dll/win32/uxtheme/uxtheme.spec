...
@ stdcall -stub -version=0x601+ BeginPanningFeedback(long)
@ stdcall -stub -version=0x601+ EndPanningFeedback(long long)
@ stdcall -stub -version=0x601+ UpdatePanningFeedback(long long long long)
