...
NTSTATUS WINAPI wow64_NtCreateThreadEx( UINT *args )
{
    ...
    *handle_ptr = 0;
    ...
    {
        status = NtCreateThreadEx( &handle, access, objattr_32to64( &attr, attr32 ), process, start, param, flags, get_zero_bits( zero_bits ), stack_commit, stack_reserve, ps_attributes_32to64( &attr_list, attr_list32 ));
...
NTSTATUS WINAPI wow64_NtQueueApcThread( UINT *args )
{
    ...
    return NtQueueApcThread( handle, apc_32to64( func ), (ULONG_PTR)apc_param_32to64( func, arg1 ), arg2, arg3 );
}
...
NTSTATUS WINAPI wow64_NtQueueApcThreadEx( UINT *args )
{
    ...
    return NtQueueApcThreadEx2( handle, reserve_handle, 0, apc_32to64( func ), (ULONG_PTR)apc_param_32to64( func, arg1 ), arg2, arg3 );
}
...
NTSTATUS WINAPI wow64_NtQueueApcThreadEx2( UINT *args )
{
    ...
    return NtQueueApcThreadEx2( handle, reserve_handle, flags, apc_32to64( func ), (ULONG_PTR)apc_param_32to64( func, arg1 ), arg2, arg3 );
}
