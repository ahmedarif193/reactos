...
@ stdcall -version=0x600+ GetActiveProcessorGroupCount()
@ stdcall -version=0x600+ GetMaximumProcessorCount(long)
@ stdcall -version=0x600+ GetMaximumProcessorGroupCount()
@ stdcall -version=0x600+ GetNumaNodeNumberFromHandle(ptr ptr)
@ stdcall -version=0x600+ SetThreadGroupAffinity(ptr ptr ptr)
@ stdcall -version=0x600+ GetThreadGroupAffinity(ptr ptr)
@ stdcall -version=0x600+ SetProcessGroupAffinity(ptr ptr)
@ stdcall -version=0x600+ GetProcessGroupAffinity(ptr ptr)

; Windows 10 UWP and AppContainer APIs
@ stdcall -version=0x602+ GetPackageFullName(ptr ptr wstr)
@ stdcall -version=0x602+ GetPackageFamilyName(ptr ptr wstr)
@ stdcall -version=0x602+ GetApplicationUserModelId(ptr ptr wstr)
@ stdcall -version=0x602+ GetPackageApplicationIds(wstr ptr ptr ptr)
@ stdcall -version=0x602+ GetPackageInfo(ptr long ptr ptr wstr)
@ stdcall -version=0x602+ GetPackagePath(ptr long ptr wstr)
@ stdcall -version=0x602+ GetStagedPackageOrigin(wstr ptr)
@ stdcall -version=0x602+ PackageFullNameFromId(ptr wstr ptr)
@ stdcall -version=0x602+ PackageFamilyNameFromId(ptr wstr ptr)
@ stdcall -version=0x602+ PackageFamilyNameFromFullName(wstr wstr ptr)
@ stdcall -version=0x602+ PackageIdFromFullName(wstr long ptr ptr)
@ stdcall -version=0x602+ PackageNameAndPublisherIdFromFamilyName(wstr wstr ptr wstr ptr)
@ stdcall -version=0x602+ ParseApplicationUserModelId(wstr wstr ptr wstr ptr)
@ stdcall -version=0x602+ FormatApplicationUserModelId(wstr wstr wstr ptr)
@ stdcall -version=0x602+ GetCurrentApplicationUserModelId(ptr wstr)
@ stdcall -version=0x602+ IsAppContainerProcess(ptr ptr)

; Windows 10 Memory Management APIs
@ stdcall -version=0x600+ GetMemoryErrorHandlingCapabilities(ptr)
@ stdcall -version=0x600+ RegisterBadMemoryNotification(ptr)
@ stdcall -version=0x600+ UnregisterBadMemoryNotification(ptr)
@ stdcall -version=0x600+ DiscardVirtualMemory(ptr long)
@ stdcall -version=0x600+ PrefetchVirtualMemory(ptr long ptr long)
@ stdcall -version=0x600+ OfferVirtualMemory(ptr long long)
@ stdcall -version=0x600+ ReclaimVirtualMemory(ptr long)
@ stdcall -version=0x600+ MapUserPhysicalPagesScatterNuma(ptr long ptr long)
@ stdcall -version=0x600+ VirtualAllocFromApp(ptr long long long)
@ stdcall -version=0x600+ VirtualProtectFromApp(ptr long long ptr)
@ stdcall -version=0x600+ OpenFileMappingFromApp(long long wstr)
@ stdcall -version=0x600+ CreateFileMappingFromApp(ptr ptr long long long wstr)
@ stdcall -version=0x600+ MapViewOfFileFromApp(ptr long long long long)
@ stdcall -version=0x600+ UnmapViewOfFileEx(ptr long)

; Windows 10 File System APIs
@ stdcall -version=0x600+ CreateFile2(wstr long long long ptr)
@ stdcall -version=0x600+ CreateFileFromAppW(wstr long long long ptr long ptr)
@ stdcall -version=0x600+ CreateDirectoryFromAppW(wstr wstr ptr)
@ stdcall -version=0x600+ RemoveDirectoryFromAppW(wstr)
@ stdcall -version=0x600+ DeleteFileFromAppW(wstr)
@ stdcall -version=0x600+ MoveFileFromAppW(wstr wstr)
@ stdcall -version=0x600+ CopyFileFromAppW(wstr wstr long)
@ stdcall -version=0x600+ GetFileAttributesExFromAppW(wstr long ptr)
@ stdcall -version=0x600+ SetFileAttributesFromAppW(wstr long)
@ stdcall -version=0x600+ FindFirstFileExFromAppW(wstr long ptr long ptr long)
@ stdcall -version=0x600+ GetTempPathFromAppW(long wstr)
@ stdcall -version=0x600+ GetFileInformationByHandleEx(ptr long ptr long)
@ stdcall -version=0x600+ SetFileInformationByHandle(ptr long ptr long)
@ stdcall -version=0x600+ GetVolumeInformationByHandleW(ptr wstr long ptr ptr ptr wstr long)
@ stdcall -version=0x600+ CopyFile2(wstr wstr ptr)
@ stdcall -version=0x600+ CopyFileExFromAppW(wstr wstr ptr ptr ptr long)
@ stdcall -version=0x600+ MoveFileExFromAppW(wstr wstr long)
@ stdcall -version=0x600+ ReplaceFileFromAppW(wstr wstr wstr long ptr ptr)

; Windows 10 Registry APIs
...
; Windows 10 Security and Synchronization APIs
@ stdcall -version=0x600+ CreateRemoteThreadEx(ptr ptr long ptr ptr long ptr ptr)
@ stdcall -version=0x600+ GetThreadIdealProcessorEx(ptr ptr)
@ stdcall -version=0x600+ SetThreadIdealProcessorEx(ptr ptr ptr)
...
@ stdcall -version=0x600+ TryAcquireSRWLockExclusive(ptr)
@ stdcall -version=0x600+ TryAcquireSRWLockShared(ptr)

; Windows 10 Error Handling and Debugging APIs
@ stdcall -version=0x600+ RaiseFailFastException(ptr ptr long)
@ stdcall -version=0x600+ GetErrorMode()
@ stdcall -version=0x600+ SetThreadErrorMode(long ptr)
@ stdcall -version=0x600+ GetThreadErrorMode()

; Windows 10 DLL and Library Management APIs
@ stdcall -version=0x600+ LoadPackagedLibrary(wstr long)
...
; Windows 10 Console and I/O APIs
@ stdcall -version=0x600+ GetConsoleScreenBufferInfoEx(ptr ptr)
@ stdcall -version=0x600+ SetConsoleScreenBufferInfoEx(ptr ptr)
@ stdcall -version=0x600+ GetCurrentConsoleFontEx(ptr long ptr)
@ stdcall -version=0x600+ SetCurrentConsoleFontEx(ptr long ptr)
@ stdcall -version=0x600+ GetConsoleHistoryInfo(ptr)
@ stdcall -version=0x600+ SetConsoleHistoryInfo(ptr)
@ stdcall -version=0x600+ GetConsoleOriginalTitleA(str long)
@ stdcall -version=0x600+ GetConsoleOriginalTitleW(wstr long)
@ stdcall -version=0x600+ GetConsoleSelectionInfo(ptr)
@ stdcall -version=0x600+ SetStdHandleEx(long ptr ptr)
...
@ stdcall -version=0x600+ SetLocaleInfoEx(wstr long wstr)
@ stdcall -version=0x600+ GetCalendarInfoEx(wstr long wstr long wstr long ptr)
@ stdcall -version=0x600+ SetCalendarInfoEx(wstr long wstr long wstr)
@ stdcall -version=0x600+ GetDateFormatEx(wstr long ptr wstr wstr long wstr)
@ stdcall -version=0x600+ GetTimeFormatEx(wstr long ptr wstr wstr long)
@ stdcall -version=0x600+ GetNumberFormatEx(wstr long wstr ptr wstr long)
@ stdcall -version=0x600+ GetCurrencyFormatEx(wstr long wstr ptr wstr long)
...
@ stdcall -version=0x600+ CompareStringOrdinal(wstr long wstr long long)
@ stdcall -version=0x600+ LCMapStringEx(long long wstr long ptr long ptr ptr long)
@ stdcall -version=0x600+ FindNLSString(long wstr long wstr long ptr)
@ stdcall -version=0x600+ FindNLSStringEx(wstr long wstr long wstr long ptr ptr ptr ptr)
