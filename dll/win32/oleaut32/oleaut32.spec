...
# Windows 10 OLE Automation Enhancements
444 stdcall -stub -version=0x600+ VarI8FromDecEx(ptr long ptr)
445 stdcall -stub -version=0x600+ VarUI8FromDecEx(ptr long ptr)
446 stdcall -stub -version=0x600+ VarDecFromI8Ex(int64 long ptr)
447 stdcall -stub -version=0x600+ VarDecFromUI8Ex(int64 long ptr)
448 stdcall -stub -version=0x600+ VarFormatEx(ptr ptr long long long ptr long)
449 stdcall -stub -version=0x600+ VarFormatCurrency(ptr long long long long ptr long)
450 stdcall -stub -version=0x600+ VarFormatNumber(ptr long long long long long ptr)
451 stdcall -stub -version=0x600+ VarFormatPercent(ptr long long long long long ptr)
452 stdcall -stub -version=0x600+ VariantChangeTypeEx(ptr ptr long long long)
453 stdcall -stub -version=0x600+ VariantCopyIndEx(ptr ptr long)
454 stdcall -stub -version=0x600+ SafeArrayCreateEx(long long ptr ptr ptr)
455 stdcall -stub -version=0x600+ SafeArrayCreateVectorEx(long long long ptr ptr)
456 stdcall -stub -version=0x600+ SafeArrayDestroyEx(ptr long)
457 stdcall -stub -version=0x600+ SafeArrayGetElementEx(ptr ptr ptr long)
458 stdcall -stub -version=0x600+ SafeArrayPutElementEx(ptr ptr ptr long)
459 stdcall -stub -version=0x600+ SafeArrayCopyEx(ptr ptr long)
460 stdcall -stub -version=0x600+ SafeArrayRedimEx(ptr ptr long)
461 stdcall -stub -version=0x600+ SafeArrayLockEx(ptr long)
462 stdcall -stub -version=0x600+ SafeArrayUnlockEx(ptr long)
463 stdcall -stub -version=0x600+ SafeArrayAccessDataEx(ptr ptr long)
464 stdcall -stub -version=0x600+ SafeArrayUnaccessDataEx(ptr long)
465 stdcall -stub -version=0x600+ SafeArrayAllocDescriptorEx(long ptr ptr)
466 stdcall -stub -version=0x600+ SafeArrayAllocDataEx(ptr long)
467 stdcall -stub -version=0x600+ SafeArrayDestroyDescriptorEx(ptr long)
468 stdcall -stub -version=0x600+ SafeArrayDestroyDataEx(ptr long)

# Enhanced BSTR Support for Unicode
469 stdcall -stub -version=0x600+ SysAllocStringByteLen(ptr long)
470 stdcall -stub -version=0x600+ SysReAllocStringByteLen(ptr ptr long)
471 stdcall -stub -version=0x600+ SysStringByteLen(ptr)
472 stdcall -stub -version=0x600+ SysAllocStringFromBuffer(ptr long)
473 stdcall -stub -version=0x600+ SysReAllocStringFromBuffer(ptr ptr long)

# Enhanced Error Info Support
474 stdcall -stub -version=0x600+ CreateErrorInfoEx(ptr ptr)
475 stdcall -stub -version=0x600+ SetErrorInfoEx(long ptr ptr)
476 stdcall -stub -version=0x600+ GetErrorInfoEx(long ptr ptr)

# Windows Runtime VARIANT Support
477 stdcall -stub -version=0x600+ VariantToPropertyValue(ptr ptr)
478 stdcall -stub -version=0x600+ PropertyValueToVariant(ptr ptr)
479 stdcall -stub -version=0x600+ VariantToInspectable(ptr ptr)
480 stdcall -stub -version=0x600+ InspectableToVariant(ptr ptr)

# Enhanced TypeLib Support
481 stdcall -stub -version=0x600+ LoadTypeLibEx(wstr long ptr)
482 stdcall -stub -version=0x600+ LoadTypeLibFromResource(ptr wstr long ptr)
483 stdcall -stub -version=0x600+ RegisterTypeLibEx(ptr wstr wstr ptr)
484 stdcall -stub -version=0x600+ UnRegisterTypeLibEx(ptr long long long long ptr)
485 stdcall -stub -version=0x600+ GetTypeLibAttr(ptr ptr)
486 stdcall -stub -version=0x600+ ReleaseTypeLibAttr(ptr ptr)

# Modern Marshaling Support
487 stdcall -stub -version=0x600+ BSTR_UserSizeEx(ptr long ptr long)
488 stdcall -stub -version=0x600+ BSTR_UserMarshalEx(ptr ptr ptr long)
489 stdcall -stub -version=0x600+ BSTR_UserUnmarshalEx(ptr ptr ptr long)
490 stdcall -stub -version=0x600+ BSTR_UserFreeEx(ptr ptr long)
491 stdcall -stub -version=0x600+ VARIANT_UserSizeEx(ptr long ptr long)
492 stdcall -stub -version=0x600+ VARIANT_UserMarshalEx(ptr ptr ptr long)
493 stdcall -stub -version=0x600+ VARIANT_UserUnmarshalEx(ptr ptr ptr long)
494 stdcall -stub -version=0x600+ VARIANT_UserFreeEx(ptr ptr long)
495 stdcall -stub -version=0x600+ SAFEARRAY_UserSizeEx(ptr long ptr long)
496 stdcall -stub -version=0x600+ SAFEARRAY_UserMarshalEx(ptr ptr ptr long)
497 stdcall -stub -version=0x600+ SAFEARRAY_UserUnmarshalEx(ptr ptr ptr long)
498 stdcall -stub -version=0x600+ SAFEARRAY_UserFreeEx(ptr ptr long)
