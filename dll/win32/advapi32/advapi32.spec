...
; Windows 10 Enhanced Security APIs
@ stdcall -version=0x600+ CreateRestrictedToken(ptr long ptr long ptr long ptr ptr)
@ stdcall -version=0x600+ IsTokenRestricted(ptr)
@ stdcall -version=0x600+ SetTokenInformation(ptr long ptr long)
@ stdcall -version=0x600+ GetTokenInformation(ptr long ptr long ptr)
@ stdcall -version=0x600+ CheckTokenMembership(ptr ptr ptr)
@ stdcall -version=0x600+ CreateWellKnownSid(long ptr ptr ptr)
@ stdcall -version=0x600+ IsWellKnownSid(ptr long)
@ stdcall -version=0x600+ GetWindowsAccountDomainSid(ptr ptr ptr)
@ stdcall -version=0x600+ IsValidSid(ptr)
@ stdcall -version=0x600+ ConvertSidToStringSidA(ptr ptr)
@ stdcall -version=0x600+ ConvertSidToStringSidW(ptr ptr)
@ stdcall -version=0x600+ ConvertStringSidToSidA(str ptr)
@ stdcall -version=0x600+ ConvertStringSidToSidW(wstr ptr)
@ stdcall -version=0x600+ GetLengthSid(ptr)
@ stdcall -version=0x600+ CopySid(long ptr ptr)
@ stdcall -version=0x600+ EqualSid(ptr ptr)
@ stdcall -version=0x600+ EqualPrefixSid(ptr ptr)
@ stdcall -version=0x600+ GetSidSubAuthority(ptr long)
@ stdcall -version=0x600+ GetSidSubAuthorityCount(ptr)
@ stdcall -version=0x600+ GetSidLengthRequired(long)
@ stdcall -version=0x600+ InitializeSid(ptr ptr long)
@ stdcall -version=0x600+ GetSidIdentifierAuthority(ptr)

; Windows 10 Enhanced Registry APIs
@ stdcall -version=0x600+ RegCreateKeyTransactedA(ptr str long ptr long long ptr ptr ptr)
@ stdcall -version=0x600+ RegCreateKeyTransactedW(ptr wstr long ptr long long ptr ptr ptr)
@ stdcall -version=0x600+ RegDeleteKeyTransactedA(ptr str long long ptr)
@ stdcall -version=0x600+ RegDeleteKeyTransactedW(ptr wstr long long ptr)
@ stdcall -version=0x600+ RegOpenKeyTransactedA(ptr str long long ptr ptr)
@ stdcall -version=0x600+ RegOpenKeyTransactedW(ptr wstr long long ptr ptr)
...
@ stdcall -version=0x600+ RegQueryReflectionKey(ptr ptr)
@ stdcall -version=0x600+ RegDisableReflectionKey(ptr)
@ stdcall -version=0x600+ RegEnableReflectionKey(ptr)

; Windows 10 Service Control Manager APIs
@ stdcall -version=0x600+ CreateServiceA(ptr str str long long long long str str ptr str str str)
@ stdcall -version=0x600+ CreateServiceW(ptr wstr wstr long long long long wstr wstr ptr wstr wstr wstr)
@ stdcall -version=0x600+ OpenSCManagerA(str str long)
@ stdcall -version=0x600+ OpenSCManagerW(wstr wstr long)
@ stdcall -version=0x600+ OpenServiceA(ptr str long)
@ stdcall -version=0x600+ OpenServiceW(ptr wstr long)
@ stdcall -version=0x600+ CloseServiceHandle(ptr)
@ stdcall -version=0x600+ DeleteService(ptr)
@ stdcall -version=0x600+ StartServiceA(ptr long ptr)
@ stdcall -version=0x600+ StartServiceW(ptr long ptr)
@ stdcall -version=0x600+ ControlService(ptr long ptr)
@ stdcall -version=0x600+ ControlServiceExA(ptr long long ptr)
@ stdcall -version=0x600+ ControlServiceExW(ptr long long ptr)
@ stdcall -version=0x600+ QueryServiceStatus(ptr ptr)
@ stdcall -version=0x600+ QueryServiceStatusEx(ptr long ptr long ptr)
@ stdcall -version=0x600+ QueryServiceConfigA(ptr ptr long ptr)
@ stdcall -version=0x600+ QueryServiceConfigW(ptr ptr long ptr)
@ stdcall -version=0x600+ QueryServiceConfig2A(ptr long ptr long ptr)
@ stdcall -version=0x600+ QueryServiceConfig2W(ptr long ptr long ptr)
@ stdcall -version=0x600+ ChangeServiceConfigA(ptr long long long str str ptr str str str str)
@ stdcall -version=0x600+ ChangeServiceConfigW(ptr long long long wstr wstr ptr wstr wstr wstr wstr)
@ stdcall -version=0x600+ ChangeServiceConfig2A(ptr long ptr)
@ stdcall -version=0x600+ ChangeServiceConfig2W(ptr long ptr)
@ stdcall -version=0x600+ EnumServicesStatusA(ptr long long ptr long ptr ptr ptr)
@ stdcall -version=0x600+ EnumServicesStatusW(ptr long long ptr long ptr ptr ptr)
@ stdcall -version=0x600+ EnumServicesStatusExA(ptr long long long ptr long ptr ptr ptr str)
@ stdcall -version=0x600+ EnumServicesStatusExW(ptr long long long ptr long ptr ptr ptr wstr)
@ stdcall -version=0x600+ GetServiceKeyNameA(ptr str ptr ptr)
@ stdcall -version=0x600+ GetServiceKeyNameW(ptr wstr ptr ptr)
@ stdcall -version=0x600+ GetServiceDisplayNameA(ptr str ptr ptr)
@ stdcall -version=0x600+ GetServiceDisplayNameW(ptr wstr ptr ptr)
@ stdcall -version=0x600+ LockServiceDatabase(ptr)
@ stdcall -version=0x600+ UnlockServiceDatabase(ptr)
@ stdcall -version=0x600+ NotifyBootConfigStatus(long)
@ stdcall -version=0x600+ QueryServiceLockStatusA(ptr ptr long ptr)
@ stdcall -version=0x600+ QueryServiceLockStatusW(ptr ptr long ptr)
@ stdcall -version=0x600+ RegisterServiceCtrlHandlerA(str ptr)
@ stdcall -version=0x600+ RegisterServiceCtrlHandlerW(wstr ptr)
@ stdcall -version=0x600+ RegisterServiceCtrlHandlerExA(str ptr ptr)
@ stdcall -version=0x600+ RegisterServiceCtrlHandlerExW(wstr ptr ptr)
@ stdcall -version=0x600+ SetServiceStatus(ptr ptr)
@ stdcall -version=0x600+ StartServiceCtrlDispatcherA(ptr)
@ stdcall -version=0x600+ StartServiceCtrlDispatcherW(ptr)

; Windows 10 Event Tracing APIs
@ stdcall -version=0x600+ StartTraceA(ptr str ptr)
@ stdcall -version=0x600+ StartTraceW(ptr wstr ptr)
@ stdcall -version=0x600+ StopTraceA(double str ptr)
@ stdcall -version=0x600+ StopTraceW(double wstr ptr)
@ stdcall -version=0x600+ ControlTraceA(double str ptr long)
@ stdcall -version=0x600+ ControlTraceW(double wstr ptr long)
@ stdcall -version=0x600+ EnableTrace(long long long ptr double)
@ stdcall -version=0x600+ EnableTraceEx(ptr ptr double long long double ptr)
@ stdcall -version=0x600+ EnableTraceEx2(double ptr long long double ptr long ptr)
@ stdcall -version=0x600+ TraceEvent(double ptr)
@ stdcall -version=0x600+ TraceEventInstance(double ptr ptr ptr)
@ stdcall -version=0x600+ RegisterTraceGuidsA(ptr ptr ptr long ptr str str ptr)
@ stdcall -version=0x600+ RegisterTraceGuidsW(ptr ptr ptr long ptr wstr wstr ptr)
@ stdcall -version=0x600+ UnregisterTraceGuids(double)
@ stdcall -version=0x600+ GetTraceLoggerHandle(ptr)
@ stdcall -version=0x600+ GetTraceEnableLevel(double)
@ stdcall -version=0x600+ GetTraceEnableFlags(double)
@ stdcall -version=0x600+ OpenTraceA(ptr)
@ stdcall -version=0x600+ OpenTraceW(ptr)
@ stdcall -version=0x600+ ProcessTrace(ptr long ptr ptr)
@ stdcall -version=0x600+ CloseTrace(double)
@ stdcall -version=0x600+ FlushTraceA(double str ptr)
@ stdcall -version=0x600+ FlushTraceW(double wstr ptr)
@ stdcall -version=0x600+ QueryTraceA(double str ptr)
@ stdcall -version=0x600+ QueryTraceW(double wstr ptr)
@ stdcall -version=0x600+ UpdateTraceA(double str ptr)
@ stdcall -version=0x600+ UpdateTraceW(double wstr ptr)
@ stdcall -version=0x600+ QueryAllTracesA(ptr long ptr)
@ stdcall -version=0x600+ QueryAllTracesW(ptr long ptr)

; Windows 10 Cryptographic Service Provider APIs
@ stdcall -version=0x600+ CryptAcquireContextA(ptr str str long long)
@ stdcall -version=0x600+ CryptAcquireContextW(ptr wstr wstr long long)
@ stdcall -version=0x600+ CryptReleaseContext(ptr long)
@ stdcall -version=0x600+ CryptGenRandom(ptr long ptr)
@ stdcall -version=0x600+ CryptCreateHash(ptr long ptr long ptr)
@ stdcall -version=0x600+ CryptHashData(ptr ptr long long)
@ stdcall -version=0x600+ CryptHashSessionKey(ptr ptr long)
@ stdcall -version=0x600+ CryptGetHashParam(ptr long ptr ptr long)
@ stdcall -version=0x600+ CryptSetHashParam(ptr long ptr long)
@ stdcall -version=0x600+ CryptSignHashA(ptr long str long ptr ptr)
@ stdcall -version=0x600+ CryptSignHashW(ptr long wstr long ptr ptr)
@ stdcall -version=0x600+ CryptVerifySignatureA(ptr ptr long ptr long str)
@ stdcall -version=0x600+ CryptVerifySignatureW(ptr ptr long ptr long wstr)
@ stdcall -version=0x600+ CryptDestroyHash(ptr)
@ stdcall -version=0x600+ CryptGenKey(ptr long long ptr)
@ stdcall -version=0x600+ CryptDeriveKey(ptr long ptr long ptr)
@ stdcall -version=0x600+ CryptDestroyKey(ptr)
@ stdcall -version=0x600+ CryptSetKeyParam(ptr long ptr long)
@ stdcall -version=0x600+ CryptGetKeyParam(ptr long ptr ptr long)
@ stdcall -version=0x600+ CryptSetProvParam(ptr long ptr long)
@ stdcall -version=0x600+ CryptGetProvParam(ptr long ptr ptr long)
@ stdcall -version=0x600+ CryptEncrypt(ptr ptr long long ptr ptr long)
@ stdcall -version=0x600+ CryptDecrypt(ptr ptr long long ptr ptr)
@ stdcall -version=0x600+ CryptExportKey(ptr ptr long long ptr ptr)
@ stdcall -version=0x600+ CryptImportKey(ptr ptr long ptr long ptr)
@ stdcall -version=0x600+ CryptDuplicateHash(ptr ptr long ptr)
@ stdcall -version=0x600+ CryptDuplicateKey(ptr ptr long ptr)
