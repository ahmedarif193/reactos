...
static const char * debugstr_sid(PSID sid)
{
    ...
    case 2:
        return wine_dbg_sprintf("S-%d-%d-%lu-%lu", psid->Revision, auth,
            *GetSidSubAuthority(psid, 0), *GetSidSubAuthority(psid, 1));
    case 3:
    ...
    case 4:
        return wine_dbg_sprintf("S-%d-%d-%lu-%lu-%lu-%lu", psid->Revision, auth,
            *GetSidSubAuthority(psid, 0), *GetSidSubAuthority(psid, 1),
            *GetSidSubAuthority(psid, 2), *GetSidSubAuthority(psid, 3));
    case 5:
        return wine_dbg_sprintf("S-%d-%d-%lu-%lu-%lu-%lu-%lu", psid->Revision, auth,
            *GetSidSubAuthority(psid, 0), *GetSidSubAuthority(psid, 1),
            *GetSidSubAuthority(psid, 2), *GetSidSubAuthority(psid, 3),
            *GetSidSubAuthority(psid, 4));
    case 6:
        return wine_dbg_sprintf("S-%d-%d-%lu-%lu-%lu-%lu-%lu-%lu", psid->Revision, auth,
            *GetSidSubAuthority(psid, 3), *GetSidSubAuthority(psid, 1),
            *GetSidSubAuthority(psid, 2), *GetSidSubAuthority(psid, 0),
            *GetSidSubAuthority(psid, 4), *GetSidSubAuthority(psid, 5));
    case 7:
        return wine_dbg_sprintf("S-%d-%d-%lu-%lu-%lu-%lu-%lu-%lu-%lu", psid->Revision, auth,
            *GetSidSubAuthority(psid, 0), *GetSidSubAuthority(psid, 1),
            *GetSidSubAuthority(psid, 2), *GetSidSubAuthority(psid, 3),
            *GetSidSubAuthority(psid, 4), *GetSidSubAuthority(psid, 5),
            *GetSidSubAuthority(psid, 6));
    case 8:
        return wine_dbg_sprintf("S-%d-%d-%lu-%lu-%lu-%lu-%lu-%lu-%lu-%lu", psid->Revision, auth,
            *GetSidSubAuthority(psid, 0), *GetSidSubAuthority(psid, 1),
            *GetSidSubAuthority(psid, 2), *GetSidSubAuthority(psid, 3),
            *GetSidSubAuthority(psid, 4), *GetSidSubAuthority(psid, 5),
            *GetSidSubAuthority(psid, 6), *GetSidSubAuthority(psid, 7));
    }
    return "(too-big)";
}
