...
HRESULT WINAPI DllGetVersion(DLLVERSIONINFO *info)
{
    ...
    info->dwMajorVersion = COMCTL32_VERSION;
    info->dwMinorVersion = COMCTL32_VERSION_MINOR;
    info->dwBuildNumber = 2919;
    info->dwPlatformID = 6304;
    return S_OK;
}
#endif
...
{
#ifdef __REACTOS__
    return COMCTL32_ReactOSDrawShadowText(hdc, text, length, rect, flags, crText, crShadow,
            offset_x, offset_y);
#else
    int bkmode, ret;
    COLORREF clr;
