    ...
    try {
        switch (uMsg) {
            case WM_INITDIALOG:
            {
                ...
                s = ros_to_wstring(opts->usage_start);
                ...
                s = ros_to_wstring(opts->usage_end);
                ...
                s = ros_to_wstring(opts->drange_start);
                SetDlgItemTextW(hwndDlg, IDC_DRANGE_START, s.c_str());

                s = ros_to_wstring(opts->drange_end);
                ...
                s = ros_to_wstring(opts->vrange_start);
                SetDlgItemTextW(hwndDlg, IDC_VRANGE_START, s.c_str());

                s = ros_to_wstring(opts->vrange_end);
                ...
                s = ros_to_wstring(opts->limit_start);
                ...
                s = ros_to_wstring(opts->limit_end);
                ...
                s = ros_to_wstring(opts->stripes_start);
                ...
                s = ros_to_wstring(opts->stripes_end);
