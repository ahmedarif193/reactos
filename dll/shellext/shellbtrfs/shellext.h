...
#ifdef __REACTOS__
inline wstring ros_to_wstring(uint8_t a) { WCHAR buffer[16]; swprintf(buffer, L"%d", a); return wstring(buffer); }
inline wstring ros_to_wstring(uint16_t a) { WCHAR buffer[16]; swprintf(buffer, L"%d", a); return wstring(buffer); }
inline wstring ros_to_wstring(uint32_t a) { WCHAR buffer[32]; swprintf(buffer, L"%lu", static_cast<unsigned long>(a)); return wstring(buffer); }
inline wstring ros_to_wstring(uint64_t a) { WCHAR buffer[64]; swprintf(buffer, L"%I64u", static_cast<unsigned long long>(a)); return wstring(buffer); }
#endif
