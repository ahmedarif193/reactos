...
/* DISPATCH-safe MMU cache flush + TLB clear (rpi5vc4_v3d.c). */
BOOLEAN
 ...
 * Entry points keep the VP_STATUS/Win32-code contract of the XPDM StartIO
 * dispatch; the WDDM escape wrapper maps them onto NTSTATUS.
 * ====================================================================== */
...
Rpi5V3dUploadTexture(
    _Inout_ PRPI5VC4_DEVICE_EXTENSION DeviceExtension,
    _In_reads_bytes_(RequestBufferLength) PRPI5VC4_V3D_TEXTURE_UPLOAD_REQUEST Request,
    _In_ ULONG RequestBufferLength,
...
Rpi5V3dPresentGdi(
    _Inout_ PRPI5VC4_DEVICE_EXTENSION DeviceExtension,
    _In_reads_bytes_(RequestBufferLength) PRPI5VC4_GDI_PRESENT_REQUEST Request,
    _In_ ULONG RequestBufferLength,
...
Rpi5V3dRenderGraph(
    _Inout_ PRPI5VC4_DEVICE_EXTENSION DeviceExtension,
    _In_reads_bytes_(RequestBufferLength) PRPI5VC4_V3D_RENDER_GRAPH_REQUEST Request,
    _In_ ULONG RequestBufferLength,
...
Rpi5V3dReadGraph(
    ...
    _Out_writes_bytes_(ResultBufferLength) PRPI5VC4_V3D_READ_GRAPH_RESULT Result,
    _In_ ULONG ResultBufferLength,
    _Out_ PULONG BytesReturned);
...
Rpi5V3dReadTexture(
    ...
    _Out_writes_bytes_(ResultBufferLength) PRPI5VC4_V3D_READ_TEXTURE_RESULT Result,
    _In_ ULONG ResultBufferLength,
    _Out_ PULONG BytesReturned);

/* Free the exec work buffers and clear the poison/busy latches. */
VOID
Rpi5V3dExecRelease(
    _Inout_ PRPI5VC4_DEVICE_EXTENSION DeviceExtension);

VOID
Rpi5V3dReleasePresent(
    _Inout_ PRPI5VC4_DEVICE_EXTENSION DeviceExtension,
