    ...
    _In_ PUNICODE_STRING RegistryPath)
{
    ...
    {
        /*
         * The ARM64 image is shared with generic UEFI machines.  Decline
         * before registering with dxgkrnl so softgpu/viogpudo drive the
         * display there; the ROOT\RPI5VC4 devnode simply fails to start.
         */
