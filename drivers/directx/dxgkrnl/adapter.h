...
NTSTATUS APIENTRY DxgkCbCreatePhysicalMemoryObject(
    IN_OUT_PDXGKARGCB_CREATE_PHYSICAL_MEMORY_OBJECT pArgs);
VOID APIENTRY DxgkCbDestroyPhysicalMemoryObject(
...
VOID APIENTRY DxgkCbUnmapPhysicalMemory(
    IN_CONST_PDXGKARGCB_UNMAP_PHYSICAL_MEMORY pArgs);
NTSTATUS APIENTRY DxgkCbAllocateAdl(
    IN_OUT_PDXGKARGCB_ALLOCATE_ADL pArgs);
VOID APIENTRY DxgkCbFreeAdl(
    IN_CONST_PDXGKARGCB_FREE_ADL pArgs);
NTSTATUS APIENTRY DxgkCbOpenPhysicalMemoryObject(
    IN_OUT_PDXGKARGCB_OPEN_PHYSICAL_MEMORY_OBJECT pArgs);
VOID APIENTRY DxgkCbClosePhysicalMemoryObject(
