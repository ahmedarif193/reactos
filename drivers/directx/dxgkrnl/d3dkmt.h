...
/* win32k-private display-to-render pairing selector. */
#define IOCTL_RXGK_OPENLOGICALADAPTERFROMDEVICENAME \
    CTL_CODE(DXGKRNL_DEVICE_TYPE, 0x113, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
/* RXGK_PRESENT_OVERLAYS followed by the flip's D3DKMT_PRESENT. */
...
#define IOCTL_D3DKMT_CREATEHWQUEUE \
    CTL_CODE(DXGKRNL_DEVICE_TYPE, 0x19B, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_D3DKMT_DESTROYHWQUEUE \
    CTL_CODE(DXGKRNL_DEVICE_TYPE, 0x19C, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_D3DKMT_SUBMITCOMMANDTOHWQUEUE \
    CTL_CODE(DXGKRNL_DEVICE_TYPE, 0x19D, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_D3DKMT_SUBMITWAITFORSYNCOBJECTSTOHWQUEUE \
    CTL_CODE(DXGKRNL_DEVICE_TYPE, 0x1C8, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_D3DKMT_SUBMITSIGNALSYNCOBJECTSTOHWQUEUE \
    CTL_CODE(DXGKRNL_DEVICE_TYPE, 0x1C9, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_D3DKMT_SUBMITPRESENTBLTTOHWQUEUE \
    CTL_CODE(DXGKRNL_DEVICE_TYPE, 0x1CA, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_D3DKMT_SUBMITPRESENTTOHWQUEUE \
    CTL_CODE(DXGKRNL_DEVICE_TYPE, 0x1CB, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_D3DKMT_QUERYCLOCKCALIBRATION \
    CTL_CODE(DXGKRNL_DEVICE_TYPE, 0x19E, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_D3DKMT_CHANGEVIDEOMEMORYRESERVATION \
    CTL_CODE(DXGKRNL_DEVICE_TYPE, 0x19F, METHOD_BUFFERED, FILE_ANY_ACCESS)

/* The scheduling-priority entry points take loose arguments rather than a
 * struct, so the bridge packs them into one for the ioctl. */
