...
/* These WDDM segments reserve ARM RAM independently of firmware gpu_mem.
 * Leave room for the 1080p compositor in the surface pool on a 1 GiB Pi 3. */
#define RPI3VC4_ALLOCATION_SLAB_SIZE       (192UL * 1024UL * 1024UL)
...
#define RPI3VC4_V3D_DMA_WORKSPACE_SIZE     (32UL * 1024UL * 1024UL)
