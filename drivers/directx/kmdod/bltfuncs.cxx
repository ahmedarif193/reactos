    ...
    _In_reads_(NumRects) CONST RECT *pRects)
{
    ...
    // ReactOS/MinGW: __try/__except (PSEH2) does not work reliably in C++ code on amd64.
    // The source buffer is already locked via MmProbeAndLockPages before reaching here,
    // so the SEH wrapper is redundant and we call the blit functions directly.
