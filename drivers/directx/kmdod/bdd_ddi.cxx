    ...
    _In_  UNICODE_STRING* pRegistryPath)
{
    ...
    InitialData.DxgkDdiSetPointerPosition           = (PDXGKDDI_SET_POINTER_POSITION)BddDdiSetPointerPosition;
    InitialData.DxgkDdiSetPointerShape              = (PDXGKDDI_SET_POINTER_SHAPE)BddDdiSetPointerShape;
    InitialData.DxgkDdiIsSupportedVidPn             = BddDdiIsSupportedVidPn;
    InitialData.DxgkDdiRecommendFunctionalVidPn     = (PDXGKDDI_RECOMMEND_FUNCTIONAL_VIDPN)BddDdiRecommendFunctionalVidPn;
    InitialData.DxgkDdiEnumVidPnCofuncModality      = (PDXGKDDI_ENUM_VIDPN_COFUNC_MODALITY)BddDdiEnumVidPnCofuncModality;
    InitialData.DxgkDdiSetVidPnSourceVisibility     = (PDXGKDDI_SET_VIDPN_SOURCE_VISIBILITY)BddDdiSetVidPnSourceVisibility;
    InitialData.DxgkDdiCommitVidPn                  = (PDXGKDDI_COMMIT_VIDPN)BddDdiCommitVidPn;
    InitialData.DxgkDdiUpdateActiveVidPnPresentPath = (PDXGKDDI_UPDATE_ACTIVE_VIDPN_PRESENT_PATH)BddDdiUpdateActiveVidPnPresentPath;
    InitialData.DxgkDdiRecommendMonitorModes        = (PDXGKDDI_RECOMMEND_MONITORMODES)BddDdiRecommendMonitorModes;
    InitialData.DxgkDdiQueryVidPnHwCapability       = BddDdiQueryVidPnHWCapability;
    InitialData.DxgkDdiPresentDisplayOnly           = (PVOID)BddDdiPresentDisplayOnly;
