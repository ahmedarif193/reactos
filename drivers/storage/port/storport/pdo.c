...
C_ASSERT(sizeof(STOR_ADDR_BTL8) == 12);
C_ASSERT(sizeof(SRBEX_DATA_SCSI_CDB16) == 36);
C_ASSERT(FIELD_OFFSET(PORT_SRBEX_REQUEST, Address) == 96);
C_ASSERT(FIELD_OFFSET(PORT_SRBEX_REQUEST, Scsi) == 108);
#endif
