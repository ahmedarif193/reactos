...
@ stdcall -arch=i386,arm,arm64 ScsiPortConvertUlongToPhysicalAddress(long) NTOSKRNL.RtlConvertUlongToLargeInteger
...
@ stdcall -arch=i386,arm,arm64 ScsiPortReadPortBufferUchar(ptr ptr long) HAL.READ_PORT_BUFFER_UCHAR
@ stdcall -arch=i386,arm,arm64 ScsiPortReadPortBufferUshort(ptr ptr long) HAL.READ_PORT_BUFFER_USHORT
@ stdcall -arch=i386,arm,arm64 ScsiPortReadPortBufferUlong(ptr ptr long) HAL.READ_PORT_BUFFER_ULONG
@ stdcall -arch=i386,arm,arm64 ScsiPortReadPortUchar(ptr) HAL.READ_PORT_UCHAR
@ stdcall -arch=i386,arm,arm64 ScsiPortReadPortUshort(ptr) HAL.READ_PORT_USHORT
@ stdcall -arch=i386,arm,arm64 ScsiPortReadPortUlong(ptr) HAL.READ_PORT_ULONG
@ stdcall -arch=i386,arm,arm64 ScsiPortReadRegisterBufferUchar(ptr ptr long) NTOSKRNL.READ_REGISTER_BUFFER_UCHAR
@ stdcall -arch=i386,arm,arm64 ScsiPortReadRegisterBufferUshort(ptr ptr long) NTOSKRNL.READ_REGISTER_BUFFER_USHORT
@ stdcall -arch=i386,arm,arm64 ScsiPortReadRegisterBufferUlong(ptr ptr long) NTOSKRNL.READ_REGISTER_BUFFER_ULONG
@ stdcall -arch=i386,arm,arm64 ScsiPortReadRegisterUchar(ptr) NTOSKRNL.READ_REGISTER_UCHAR
@ stdcall -arch=i386,arm,arm64 ScsiPortReadRegisterUshort(ptr) NTOSKRNL.READ_REGISTER_USHORT
@ stdcall -arch=i386,arm,arm64 ScsiPortReadRegisterUlong(ptr) NTOSKRNL.READ_REGISTER_ULONG
...
@ stdcall -arch=i386,arm,arm64 ScsiPortWritePortBufferUchar(ptr ptr long) HAL.WRITE_PORT_BUFFER_UCHAR
@ stdcall -arch=i386,arm,arm64 ScsiPortWritePortBufferUshort(ptr ptr long) HAL.WRITE_PORT_BUFFER_USHORT
@ stdcall -arch=i386,arm,arm64 ScsiPortWritePortBufferUlong(ptr ptr long) HAL.WRITE_PORT_BUFFER_ULONG
@ stdcall -arch=i386,arm,arm64 ScsiPortWritePortUchar(ptr long) HAL.WRITE_PORT_UCHAR
@ stdcall -arch=i386,arm,arm64 ScsiPortWritePortUshort(ptr long) HAL.WRITE_PORT_USHORT
@ stdcall -arch=i386,arm,arm64 ScsiPortWritePortUlong(ptr long) HAL.WRITE_PORT_ULONG
@ stdcall -arch=i386,arm,arm64 ScsiPortWriteRegisterBufferUchar(ptr ptr long) NTOSKRNL.WRITE_REGISTER_BUFFER_UCHAR
@ stdcall -arch=i386,arm,arm64 ScsiPortWriteRegisterBufferUshort(ptr ptr long) NTOSKRNL.WRITE_REGISTER_BUFFER_USHORT
@ stdcall -arch=i386,arm,arm64 ScsiPortWriteRegisterBufferUlong(ptr ptr long) NTOSKRNL.WRITE_REGISTER_BUFFER_ULONG
@ stdcall -arch=i386,arm,arm64 ScsiPortWriteRegisterUchar(ptr long) NTOSKRNL.WRITE_REGISTER_UCHAR
@ stdcall -arch=i386,arm,arm64 ScsiPortWriteRegisterUshort(ptr long) NTOSKRNL.WRITE_REGISTER_USHORT
@ stdcall -arch=i386,arm,arm64 ScsiPortWriteRegisterUlong(ptr long) NTOSKRNL.WRITE_REGISTER_ULONG
