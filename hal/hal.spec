...
@ stdcall -arch=i386,x86_64,arm,arm64 HalAcquireDisplayOwnership(ptr)
@ stdcall HalAdjustResourceList(ptr)
@ stdcall HalAllProcessorsStarted()
@ stdcall HalAllocateAdapterChannel(ptr ptr long ptr)
@ stdcall -arch=i386,x86_64,arm,arm64 HalAllocateCommonBuffer(ptr long ptr long)
@ stdcall -arch=i386,x86_64,arm,arm64 HalAllocateCrashDumpRegisters(ptr ptr)
@ stdcall -arch=i386,x86_64,arm,arm64 -version=0x0601+ HalAllocateHardwareCounters(ptr long ptr ptr)
@ stdcall -arch=i386,x86_64,arm,arm64 -version=0x0601+ HalFreeHardwareCounters(ptr)
@ stdcall -arch=i386,x86_64,arm,arm64 -version=0x0601+ HalEnumerateEnvironmentVariablesEx(long ptr ptr)
@ stdcall -arch=i386,x86_64,arm,arm64 -version=0x0601+ HalSetEnvironmentVariableEx(ptr ptr ptr long long)
@ stdcall -arch=i386,x86_64,arm,arm64 -version=0x0601+ HalQueryEnvironmentVariableInfoEx(long ptr ptr ptr)
@ stdcall -arch=i386,x86_64,arm,arm64 -version=0x0601+ HalBugCheckSystem(ptr ptr)
...
@ stdcall -arch=i386,x86_64,arm,arm64 HalCalibratePerformanceCounter(ptr long long)
;@ stdcall -arch=x86_64 HalCallBios()
@ fastcall HalClearSoftwareInterrupt(long)
@ stdcall -arch=i386,x86_64,arm,arm64 -version=0x0601+ HalDisableInterrupt(ptr)
@ stdcall HalDisableSystemInterrupt(long long)
@ stdcall HalDisplayString(str)
@ stdcall -arch=i386,x86_64,arm,arm64 -version=0x0601+ HalEnableInterrupt(ptr)
@ stdcall HalEnableSystemInterrupt(long long long)
@ stdcall -arch=i386,arm,arm64,x86_64 HalEndSystemInterrupt(long long)
@ stdcall -arch=i386,x86_64,arm,arm64 HalFlushCommonBuffer(long long long long long)
@ stdcall -arch=i386,x86_64,arm,arm64 HalFreeCommonBuffer(ptr long long long ptr long)
...
@ stdcall -arch=arm64 HalGetPciConfigDataByOffset(long long long ptr long long)
@ stdcall -arch=i386,x86_64,arm,arm64 -version=0x0601+ HalGetEnvironmentVariableEx(ptr ptr ptr ptr ptr)
...
@ stdcall -arch=i386,x86_64,arm,arm64 -version=0x0601+ HalGetVectorInput(long ptr ptr ptr ptr)
@ stdcall -arch=i386,x86_64,arm,arm64 -version=0x0601+ HalGetMemoryCachingRequirements(int64 long ptr)
@ stdcall -version=0x0601+ HalGetMessageRoutingInfo(ptr)
@ stdcall -arch=i386,x86_64,arm,arm64 -version=0x0601+ HalGetProcessorIdByNtNumber(long ptr)
...
@ stdcall -arch=i386,x86_64,arm,arm64 HalInitializeProcessor(long ptr)
;@ stdcall -arch=x86_64 HalIsHyperThreadingEnabled()
@ stdcall HalMakeBeep(long)
@ stdcall HalProcessorIdle()
@ stdcall -arch=i386,x86_64,arm,arm64 HalQueryDisplayParameters(ptr ptr ptr ptr)
...
@ stdcall -arch=i386,x86_64,arm,arm64 HalReadDmaCounter(ptr)
...
@ stdcall -arch=i386,arm,x86_64 HalRequestIpi(long)
@ stdcall -arch=arm64 HalRequestIpi(long ptr)
...
@ stdcall -arch=arm64 HalSetPciConfigDataByOffset(long long long ptr long long)
@ stdcall -arch=i386,x86_64,arm,arm64 HalSetDisplayParameters(long long)
...
@ stdcall -arch=i386,x86_64,arm,arm64 HalStartNextProcessor(ptr ptr)
...
@ fastcall -arch=i386,x86_64,arm,arm64 HalSystemVectorDispatchEntry(long long long)
@ stdcall HalTranslateBusAddress(long long long long ptr ptr)
@ stdcall -arch=i386,x86_64,arm,arm64 -version=0x0601+ HalConvertDeviceIdtToIrql(long)
@ stdcall -arch=i386,x86_64,arm,arm64 HalpConfigurePciRootBridge(ptr)
@ stdcall -arch=arm64 HalpConfigureDmaAdapter(ptr ptr long)
@ stdcall -arch=i386,x86_64,arm,arm64 HalpRegisterPciRouteQuery(ptr)
@ stdcall -arch=i386,x86_64,arm,arm64 HalpSetPciRoutingMap(ptr long)
@ stdcall -arch=i386,x86_64,arm,arm64 HalpRecordPciMaxGsi(ptr)
...
@ stdcall -arch=i386,x86_64,arm,arm64 IoFlushAdapterBuffers(ptr ptr ptr ptr long long)
@ stdcall -arch=i386,x86_64,arm,arm64 IoFreeAdapterChannel(ptr)
@ stdcall -arch=i386,x86_64,arm,arm64 IoFreeMapRegisters(ptr ptr long)
@ stdcall -arch=i386,x86_64,arm,arm64 IoMapTransfer(ptr ptr ptr ptr ptr long)
...
@ extern -arch=i386,x86_64,arm,arm64 -constant KdHvComPortInUse ntoskrnl.KdHvComPortInUse
