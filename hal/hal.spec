...
@ stdcall -version=0x0602+ HalAllocateHardwareCounters(ptr long ptr ptr)
@ stdcall -version=0x0602+ HalFreeHardwareCounters(ptr)
@ stdcall -version=0x0602+ HalDmaAllocateCrashDumpRegistersEx(ptr long long ptr ptr)
@ stdcall -version=0x0602+ HalDmaFreeCrashDumpRegistersEx(ptr long)
@ stdcall -version=0x0602+ HalEnumerateEnvironmentVariablesEx(long ptr ptr)
@ stdcall -version=0x0602+ HalSetEnvironmentVariableEx(long ptr ptr ptr long)
@ stdcall -version=0x0602+ HalQueryEnvironmentVariableInfoEx(long ptr ptr ptr ptr)
@ stdcall -version=0x0603+ HalConvertDeviceIdtVectorToIrql(long long ptr)
@ stdcall -version=0x0603+ HalAllocateGsivForSecondaryIc(ptr long)
