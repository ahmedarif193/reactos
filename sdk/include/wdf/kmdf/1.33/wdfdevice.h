...
/*
 * Clang does not accept MSVC's forward declaration of an enum without an
 * explicit underlying type. Keep the public ABI unchanged and place the
 * definition here, before the device APIs which take WDF_REQUEST_TYPE.
 */
