...
#ifndef _MEMORY_RESERVE_OBJECT_TYPE_DEFINED
#define _MEMORY_RESERVE_OBJECT_TYPE_DEFINED
...
NTSYSAPI ULONG     WINAPI AlpcGetHeaderSize(ULONG);
...
NTSYSAPI NTSTATUS  WINAPI NtAccessCheckAndAuditAlarm(PUNICODE_STRING,HANDLE,PUNICODE_STRING,PUNICODE_STRING,PSECURITY_DESCRIPTOR,ACCESS_MASK,PGENERIC_MAPPING,BOOLEAN,PACCESS_MASK,NTSTATUS*,PBOOLEAN);
NTSYSAPI NTSTATUS  WINAPI NtAccessCheckByTypeAndAuditAlarm(PUNICODE_STRING,HANDLE,PUNICODE_STRING,PUNICODE_STRING,PSECURITY_DESCRIPTOR,PSID,ACCESS_MASK,AUDIT_EVENT_TYPE,ULONG,OBJECT_TYPE_LIST*,ULONG,PGENERIC_MAPPING,BOOLEAN,PACCESS_MASK,NTSTATUS*,PBOOLEAN);
...
NTSYSAPI NTSTATUS  WINAPI NtAlpcCancelMessage(HANDLE,ULONG,ALPC_CONTEXT_ATTR*);
...
NTSYSAPI NTSTATUS  WINAPI NtAlpcConnectPortEx(HANDLE*,OBJECT_ATTRIBUTES*,OBJECT_ATTRIBUTES*,ALPC_PORT_ATTRIBUTES*,ULONG,SECURITY_DESCRIPTOR*,ALPC_PORT_MESSAGE*,SIZE_T*,ALPC_MESSAGE_ATTRIBUTES*,ALPC_MESSAGE_ATTRIBUTES*,LARGE_INTEGER*);
...
NTSYSAPI NTSTATUS  WINAPI NtAlpcCreateResourceReserve(HANDLE,ULONG,SIZE_T,ULONG*);
...
NTSYSAPI NTSTATUS  WINAPI NtAlpcDeleteResourceReserve(HANDLE,ULONG,ULONG);
...
NTSYSAPI NTSTATUS  WINAPI NtAlpcImpersonateClientContainerOfPort(HANDLE,ALPC_PORT_MESSAGE*,ULONG);
NTSYSAPI NTSTATUS  WINAPI NtAlpcOpenSenderProcess(HANDLE*,HANDLE,ALPC_PORT_MESSAGE*,ULONG,ACCESS_MASK,OBJECT_ATTRIBUTES*);
NTSYSAPI NTSTATUS  WINAPI NtAlpcOpenSenderThread(HANDLE*,HANDLE,ALPC_PORT_MESSAGE*,ULONG,ACCESS_MASK,OBJECT_ATTRIBUTES*);
NTSYSAPI NTSTATUS  WINAPI NtAlpcQueryInformation(HANDLE,ALPC_PORT_INFORMATION_CLASS,void*,ULONG,ULONG*);
NTSYSAPI NTSTATUS  WINAPI NtAlpcQueryInformationMessage(HANDLE,ALPC_PORT_MESSAGE*,ALPC_MESSAGE_INFORMATION_CLASS,void*,ULONG,ULONG*);
NTSYSAPI NTSTATUS  WINAPI NtAlpcRevokeSecurityContext(HANDLE,ULONG,HANDLE);
...
NTSYSAPI NTSTATUS  WINAPI NtAlpcSetInformation(HANDLE,ALPC_PORT_INFORMATION_CLASS,void*,ULONG);
...
NTSYSAPI NTSTATUS  WINAPI NtWaitForMultipleObjects(ULONG,const HANDLE*,ULONG,BOOLEAN,const LARGE_INTEGER*);
...
NTSYSAPI BOOLEAN      WINAPI RtlEqualPrefixSid(PSID,PSID);
NTSYSAPI BOOLEAN      WINAPI RtlEqualSid(PSID,PSID);
...
NTSYSAPI NTSTATUS  WINAPI RtlDeriveCapabilitySidsFromName(UNICODE_STRING *,PSID,PSID);
...
NTSYSAPI NTSTATUS  WINAPI TpAllocAlpcCompletion(TP_ALPC **,HANDLE,PTP_ALPC_CALLBACK,void *,TP_CALLBACK_ENVIRON *);
NTSYSAPI NTSTATUS  WINAPI TpAllocAlpcCompletionEx(TP_ALPC **,HANDLE,PTP_ALPC_CALLBACK,void *,TP_CALLBACK_ENVIRON *);
...
NTSYSAPI NTSTATUS  WINAPI TpCallbackSendAlpcMessageOnCompletion(TP_CALLBACK_INSTANCE *,HANDLE,ULONG,PORT_MESSAGE *);
NTSYSAPI NTSTATUS  WINAPI TpCallbackSendPendingAlpcMessage(TP_CALLBACK_INSTANCE *);
...
NTSYSAPI void      WINAPI TpReleaseAlpcCompletion(TP_ALPC *);
...
NTSYSAPI BOOL      WINAPI TpSetWaitEx(TP_WAIT *,HANDLE,LARGE_INTEGER *,PVOID);
...
NTSYSAPI void      WINAPI TpAlpcRegisterCompletionList(TP_ALPC *);
NTSYSAPI void      WINAPI TpAlpcUnregisterCompletionList(TP_ALPC *);
NTSYSAPI void      WINAPI TpWaitForAlpcCompletion(TP_ALPC *);
