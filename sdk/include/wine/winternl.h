...
NTSYSAPI NTSTATUS  WINAPI NtWow64GetContextThread(HANDLE,WOW64_CONTEXT*);
NTSYSAPI NTSTATUS  WINAPI NtWow64GetNativeSystemInformation(SYSTEM_INFORMATION_CLASS,void*,ULONG,ULONG*);
NTSYSAPI NTSTATUS  WINAPI NtWow64IsProcessorFeaturePresent(ULONG);
...
NTSYSAPI NTSTATUS  WINAPI NtWow64SetContextThread(HANDLE,const WOW64_CONTEXT*);
