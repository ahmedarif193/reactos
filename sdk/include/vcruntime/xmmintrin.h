...
#if !defined(__clang__) && !HAS_BUILTIN(_mm_getcsr) && !defined(_MSC_VER)
...
#if !defined(__clang__) && !HAS_BUILTIN(_mm_setcsr) && !defined(_MSC_VER)
...
#if !defined(__clang__) && !HAS_BUILTIN(_mm_sfence) && !defined(_MSC_VER)
