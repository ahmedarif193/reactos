 ...
 * live in <d3dukmdt.h>, which d3dkmthk.h pulls in.  They are not repeated
 * here: two definitions of a version constant is exactly how a table guard
 * ends up evaluating against the wrong number.
 */
 ...
 *
 * They are the one genuine circularity in this interface: the signatures below
 * take them by pointer, and they in turn carry the tables of those signatures
 * by value.  Splitting each into a name now and a body later resolves that --
 * a pointer only needs the name.
 * ------------------------------------------------------------------------ */
typedef struct _D3DDDI_CREATEDEVICEFLAGS D3DDDI_CREATEDEVICEFLAGS;
 ...
 *
 * A topological sort of the closure, not the order they appear in the
 * published header.  A member used by value is a real ordering constraint; a
 * member used through a pointer is not.  Types this tree already defines
 * elsewhere are skipped, because a second definition of a shared type is how
...
struct _D3DDDIARG_AUTHENTICATEDCHANNELKEYEXCHANGE;
struct _D3DDDIARG_BLT;
struct _D3DDDIARG_BUFFERBLT1;
struct _D3DDDIARG_BUFFERBLT;
struct _D3DDDIARG_CAPTURETOSYSMEM;
struct _D3DDDIARG_CHECKDIRECTFLIPSUPPORT;
struct _D3DDDIARG_CHECKMULTIPLANEOVERLAYSUPPORT;
struct _D3DDDIARG_CLEAR;
struct _D3DDDIARG_COLORFILL;
struct _D3DDDIARG_COMPOSERECTS;
struct _D3DDDIARG_CONFIGUREAUTHENICATEDCHANNEL;
struct _D3DDDIARG_CREATEAUTHENICATEDCHANNEL;
struct _D3DDDIARG_CREATECRYPTOSESSION;
struct _D3DDDIARG_CREATEDECODEDEVICE;
struct _D3DDDIARG_CREATEEXTENSIONDEVICE;
struct _D3DDDIARG_CREATELIGHT;
struct _D3DDDIARG_CREATEOVERLAY;
struct _D3DDDIARG_CREATEPIXELSHADER;
struct _D3DDDIARG_CREATEQUERY;
struct _D3DDDIARG_CREATEVERTEXSHADERDECL;
struct _D3DDDIARG_CREATEVERTEXSHADERFUNC;
struct _D3DDDIARG_CREATEVIDEOPROCESSDEVICE;
struct _D3DDDIARG_CRYPTOSESSIONKEYEXCHANGE;
struct _D3DDDIARG_DECODEBEGINFRAME;
struct _D3DDDIARG_DECODEENDFRAME;
struct _D3DDDIARG_DECODEEXECUTE;
struct _D3DDDIARG_DECODEEXTENSIONEXECUTE;
struct _D3DDDIARG_DECRYPTIONBLT;
struct _D3DDDIARG_DEPTHFILL;
struct _D3DDDIARG_DESTROYAUTHENICATEDCHANNEL;
struct _D3DDDIARG_DESTROYCRYPTOSESSION;
struct _D3DDDIARG_DESTROYLIGHT;
struct _D3DDDIARG_DESTROYOVERLAY;
struct _D3DDDIARG_DISCARD;
struct _D3DDDIARG_DRAWINDEXEDPRIMITIVE2;
struct _D3DDDIARG_DRAWINDEXEDPRIMITIVE;
struct _D3DDDIARG_DRAWPRIMITIVE2;
struct _D3DDDIARG_DRAWPRIMITIVE;
struct _D3DDDIARG_DRAWRECTPATCH;
struct _D3DDDIARG_DRAWTRIPATCH;
struct _D3DDDIARG_DXVAHD_CREATEVIDEOPROCESSOR;
struct _D3DDDIARG_DXVAHD_GETVIDEOPROCESSBLTSTATEPRIVATE;
struct _D3DDDIARG_DXVAHD_GETVIDEOPROCESSSTREAMSTATEPRIVATE;
struct _D3DDDIARG_DXVAHD_SETVIDEOPROCESSBLTSTATE;
struct _D3DDDIARG_DXVAHD_SETVIDEOPROCESSSTREAMSTATE;
struct _D3DDDIARG_DXVAHD_VIDEOPROCESSBLTHD;
struct _D3DDDIARG_ENCRYPTIONBLT;
struct _D3DDDIARG_EXTENSIONEXECUTE;
struct _D3DDDIARG_FINISHSESSIONKEYREFRESH;
struct _D3DDDIARG_FLIPOVERLAY;
struct _D3DDDIARG_GENERATEMIPSUBLEVELS;
struct _D3DDDIARG_GETCAPS;
struct _D3DDDIARG_GETCAPTUREALLOCATIONHANDLE;
struct _D3DDDIARG_GETOVERLAYCOLORCONTROLS;
struct _D3DDDIARG_GETPITCH;
struct _D3DDDIARG_GETQUERYDATA;
struct _D3DDDIARG_ISSUEQUERY;
struct _D3DDDIARG_LOCK;
struct _D3DDDIARG_LOCKASYNC;
struct _D3DDDIARG_MULTIPLYTRANSFORM;
struct _D3DDDIARG_OFFERRESOURCES;
struct _D3DDDIARG_OPENRESOURCE;
struct _D3DDDIARG_PRESENT1;
struct _D3DDDIARG_PRESENT;
struct _D3DDDIARG_QUERYAUTHENICATEDCHANNEL;
struct _D3DDDIARG_QUERYRESOURCERESIDENCY;
struct _D3DDDIARG_RECLAIMRESOURCES;
struct _D3DDDIARG_RENAME;
struct _D3DDDIARG_RENDERSTATE;
struct _D3DDDIARG_RESOLVESHAREDRESOURCE;
struct _D3DDDIARG_SETCLIPPLANE;
struct _D3DDDIARG_SETCONVOLUTIONKERNELMONO;
struct _D3DDDIARG_SETDECODERENDERTARGET;
struct _D3DDDIARG_SETDEPTHSTENCIL;
struct _D3DDDIARG_SETDISPLAYMODE;
struct _D3DDDIARG_SETINDICES;
struct _D3DDDIARG_SETLIGHT;
struct _D3DDDIARG_SETMATERIAL;
struct _D3DDDIARG_SETOVERLAYCOLORCONTROLS;
struct _D3DDDIARG_SETPALETTE;
struct _D3DDDIARG_SETPIXELSHADERCONST;
struct _D3DDDIARG_SETPRIORITY;
struct _D3DDDIARG_SETRENDERTARGET;
struct _D3DDDIARG_SETSTREAMSOURCE;
struct _D3DDDIARG_SETSTREAMSOURCEFREQ;
struct _D3DDDIARG_SETSTREAMSOURCEUM;
struct _D3DDDIARG_SETTRANSFORM;
struct _D3DDDIARG_SETVERTEXSHADERCONST;
struct _D3DDDIARG_SETVIDEOPROCESSRENDERTARGET;
struct _D3DDDIARG_STARTSESSIONKEYREFRESH;
struct _D3DDDIARG_STATESET;
struct _D3DDDIARG_SYNCTOKEN;
struct _D3DDDIARG_TEXBLT1;
struct _D3DDDIARG_TEXBLT;
struct _D3DDDIARG_TEXTURESTAGESTATE;
struct _D3DDDIARG_UNLOCK;
struct _D3DDDIARG_UNLOCKASYNC;
struct _D3DDDIARG_UPDATEOVERLAY;
struct _D3DDDIARG_UPDATEPALETTE;
struct _D3DDDIARG_VALIDATETEXTURESTAGESTATE;
struct _D3DDDIARG_VIDEOPROCESSBLT;
struct _D3DDDIARG_VIDEOPROCESSENDFRAME;
struct _D3DDDIARG_VIEWPORTINFO;
struct _D3DDDIARG_VOLUMEBLT1;
struct _D3DDDIARG_VOLUMEBLT;
struct _D3DDDIARG_WINFO;
struct _D3DDDIARG_ZRANGE;
struct _D3DDDIBOX;
struct _D3DDDICB_ALLOCATE;
struct _D3DDDICB_CREATECONTEXT;
struct _D3DDDICB_CREATECONTEXTVIRTUAL;
struct _D3DDDICB_CREATEHWCONTEXT;
struct _D3DDDICB_CREATEHWQUEUE;
struct _D3DDDICB_CREATEOVERLAY;
struct _D3DDDICB_CREATESYNCHRONIZATIONOBJECT2;
struct _D3DDDICB_CREATESYNCHRONIZATIONOBJECT;
struct _D3DDDICB_DEALLOCATE2;
struct _D3DDDICB_DEALLOCATE;
struct _D3DDDICB_DESTROYCONTEXT;
struct _D3DDDICB_DESTROYHWCONTEXT;
struct _D3DDDICB_DESTROYHWQUEUE;
struct _D3DDDICB_DESTROYOVERLAY;
struct _D3DDDICB_DESTROYSYNCHRONIZATIONOBJECT;
struct _D3DDDICB_ESCAPE;
struct _D3DDDICB_FLIPOVERLAY;
struct _D3DDDICB_FREEGPUVIRTUALADDRESS;
struct _D3DDDICB_GETMULTISAMPLEMETHODLIST;
struct _D3DDDICB_INVALIDATECACHE;
struct _D3DDDICB_LOCK2;
struct _D3DDDICB_LOCK;
struct _D3DDDICB_OFFERALLOCATIONS;
struct _D3DDDICB_PRESENT;
struct _D3DDDICB_QUERYADAPTERINFO;
struct _D3DDDICB_QUERYRESIDENCY;
struct _D3DDDICB_RECLAIMALLOCATIONS2;
struct _D3DDDICB_RECLAIMALLOCATIONS3;
struct _D3DDDICB_RECLAIMALLOCATIONS;
struct _D3DDDICB_RENDER;
struct _D3DDDICB_RENDERFLAGS;
struct _D3DDDICB_SETDISPLAYMODE;
struct _D3DDDICB_SETDISPLAYPRIVATEDRIVERFORMAT;
struct _D3DDDICB_SETPRIORITY;
struct _D3DDDICB_SIGNALSYNCHRONIZATIONOBJECT2;
struct _D3DDDICB_SIGNALSYNCHRONIZATIONOBJECT;
struct _D3DDDICB_SUBMITCOMMAND;
struct _D3DDDICB_SUBMITCOMMANDFLAGS;
struct _D3DDDICB_SUBMITCOMMANDTOHWQUEUE;
struct _D3DDDICB_SUBMITCOMMANDTOHWQUEUEFLAGS;
struct _D3DDDICB_SUBMITSIGNALSYNCOBJECTSTOHWQUEUE;
struct _D3DDDICB_SUBMITWAITFORSYNCOBJECTSTOHWQUEUE;
struct _D3DDDICB_SYNCTOKEN;
struct _D3DDDICB_UNLOCK2;
struct _D3DDDICB_UNLOCK;
struct _D3DDDICB_UPDATEGPUVIRTUALADDRESS;
struct _D3DDDICB_UPDATEOVERLAY;
struct _D3DDDICB_WAITFORSYNCHRONIZATIONOBJECT2;
struct _D3DDDICB_WAITFORSYNCHRONIZATIONOBJECT;
struct _D3DDDIENCRYPTED_BLOCK_INFO;
struct _D3DDDIRANGE;
struct _D3DDDIRECTPATCH_INFO;
struct _D3DDDITRIPATCH_INFO;
struct _D3DDDIVERTEXELEMENT;
struct _D3DDDI_BLTFLAGS;
struct _D3DDDI_COLORFILLFLAGS;
struct _D3DDDI_FLIPOVERLAYFLAGS;
struct _D3DDDI_ISSUEQUERYFLAGS;
struct _D3DDDI_LIGHT;
struct _D3DDDI_LOCKASYNCFLAGS;
struct _D3DDDI_LOCKFLAGS;
struct _D3DDDI_MULTIPLANE_OVERLAY_ATTRIBUTES;
struct _D3DDDI_OPENRESOURCEFLAGS;
struct _D3DDDI_OVERLAYCOLORCONTROLS;
struct _D3DDDI_OVERLAYCOLORCONTROLSFLAGS;
struct _D3DDDI_OVERLAYINFO;
struct _D3DDDI_OVERLAYINFOFLAGS;
struct _D3DDDI_PRESENTFLAGS;
struct _D3DDDI_PRESENT_MULTIPLANE_OVERLAY;
struct _D3DDDI_UNLOCKASYNCFLAGS;
struct _D3DDDI_UNLOCKFLAGS;
struct _DXVADDI_AYUVSAMPLE16;
struct _DXVADDI_AYUVSAMPLE8;
struct _DXVADDI_CONFIGPICTUREDECODE;
struct _DXVADDI_DECODEBUFFERDESC;
struct _DXVADDI_EXTENDEDFORMAT;
struct _DXVADDI_FILTERVALUES;
struct _DXVADDI_FIXED32;
struct _DXVADDI_FREQUENCY;
struct _DXVADDI_PRIVATEBUFFER;
struct _DXVADDI_PRIVATEDATA;
struct _DXVADDI_PROCAMPVALUES;
struct _DXVADDI_PVP_SETKEY;
struct _DXVADDI_VIDEODESC;
struct _DXVADDI_VIDEOPROCESSBLTFLAGS;
struct _DXVADDI_VIDEOSAMPLE;
struct _DXVADDI_VIDEOSAMPLEFLAGS;
struct _DXVAHDDDI_BLT_STATE_PRIVATE_DATA;
struct _DXVAHDDDI_STREAM_DATA;
struct _DXVAHDDDI_STREAM_STATE_PRIVATE_DATA;
struct _DXVAHDDDI_SURFACE;
struct _GETENCRYPTIONBLTKEY;
...
/* Payloads for D3DDDICAPS_DDRAW and D3DDDICAPS_DDRAW_MODE_SPECIFIC. */
...
/* Payload for D3DDDICAPS_GETFORMATDATA. */
...
typedef HRESULT (APIENTRY *PFND3DDDI_QUERYADAPTERINFOCB2)(
    _In_ HANDLE hAdapter, _Inout_ CONST D3DDDICB_QUERYADAPTERINFO2 *Data);
...
/* ------------------------------------------------------------------------ *
 * Entry signatures.  Each takes the argument type the published interface
 * gives it, not one derived from the function name -- the two differ often
 * enough (BUFBLT takes D3DDDIARG_BUFFERBLT) that deriving them would leave
 * typedefs pointing at structures nothing defines.
 * ------------------------------------------------------------------------ */
typedef HRESULT (APIENTRY *PFND3DDDI_ALLOCATECB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_ALLOCATE*);
typedef HRESULT (APIENTRY *PFND3DDDI_AUTHENTICATEDCHANNELKEYEXCHANGE)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_AUTHENTICATEDCHANNELKEYEXCHANGE*);
typedef HRESULT (APIENTRY *PFND3DDDI_BLT)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_BLT*);
typedef HRESULT (APIENTRY *PFND3DDDI_BUFBLT)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_BUFFERBLT*);
typedef HRESULT (APIENTRY *PFND3DDDI_BUFBLT1)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_BUFFERBLT1*);
typedef HRESULT (APIENTRY *PFND3DDDI_CAPTURETOSYSMEM)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_CAPTURETOSYSMEM*);
typedef HRESULT (APIENTRY *PFND3DDDI_CHECKCOUNTER)(_In_ HANDLE hDevice, _In_ D3DDDIQUERYTYPE, _Out_ D3DDDI_COUNTER_TYPE*, _Out_ UINT*, _Out_writes_to_opt_(*pNameLength, *pNameLength) LPSTR, _Inout_opt_ UINT* pNameLength, _Out_writes_to_opt_(*pUnitsLength, *pUnitsLength) LPSTR, _Inout_opt_ UINT* pUnitsLength, _Out_writes_to_opt_(*pDescriptionLength, *pDescriptionLength) LPSTR, _Inout_opt_ UINT* pDescriptionLength);
typedef HRESULT (APIENTRY *PFND3DDDI_CHECKCOUNTERINFO)(_In_ HANDLE hDevice, _Out_ D3DDDIARG_COUNTER_INFO*);
typedef HRESULT (APIENTRY *PFND3DDDI_CHECKDIRECTFLIPSUPPORT)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CHECKDIRECTFLIPSUPPORT*);
typedef HRESULT (APIENTRY *PFND3DDDI_CHECKMULTIPLANEOVERLAYSUPPORT)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CHECKMULTIPLANEOVERLAYSUPPORT*);
typedef HRESULT (APIENTRY *PFND3DDDI_CHECKPRESENTDURATIONSUPPORT)(_In_ HANDLE hDevice, _In_ D3DDDIARG_CHECKPRESENTDURATIONSUPPORT*);
typedef HRESULT (APIENTRY *PFND3DDDI_CLEAR)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_CLEAR*, _In_ UINT, _In_ CONST RECT*);
typedef HRESULT (APIENTRY *PFND3DDDI_CLOSEADAPTER)(_In_ HANDLE hAdapter);
typedef HRESULT (APIENTRY *PFND3DDDI_COLORFILL)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_COLORFILL*);
typedef HRESULT (APIENTRY *PFND3DDDI_COMPOSERECTS)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_COMPOSERECTS*);
typedef HRESULT (APIENTRY *PFND3DDDI_CONFIGUREAUTHENICATEDCHANNEL)(_In_ HANDLE hDevice, _Inout_ CONST D3DDDIARG_CONFIGUREAUTHENTICATEDCHANNEL*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATEAUTHENTICATEDCHANNEL)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CREATEAUTHENTICATEDCHANNEL*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATECONTEXTCB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_CREATECONTEXT*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATECONTEXTVIRTUALCB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_CREATECONTEXTVIRTUAL*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATECRYPTOSESSION)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CREATECRYPTOSESSION*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATEDECODEDEVICE)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CREATEDECODEDEVICE*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATEDEVICE)(_In_ HANDLE hAdapter, _Inout_ D3DDDIARG_CREATEDEVICE*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATEEXTENSIONDEVICE)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CREATEEXTENSIONDEVICE*);
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM2_2_1)
typedef HRESULT (APIENTRY *PFND3DDDI_CREATEHWCONTEXTCB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_CREATEHWCONTEXT*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATEHWQUEUECB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_CREATEHWQUEUE*);
#endif
typedef HRESULT (APIENTRY *PFND3DDDI_CREATELIGHT)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_CREATELIGHT*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATEOVERLAY)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CREATEOVERLAY*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATEOVERLAYCB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_CREATEOVERLAY*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATEPAGINGQUEUECB)(_In_ HANDLE hDevice, _Out_ D3DDDICB_CREATEPAGINGQUEUE*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATEPIXELSHADER)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CREATEPIXELSHADER*, _In_ CONST UINT*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATEQUERY)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CREATEQUERY*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATERESOURCE)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CREATERESOURCE*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATERESOURCE2)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CREATERESOURCE2*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATESYNCHRONIZATIONOBJECT2CB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_CREATESYNCHRONIZATIONOBJECT2*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATESYNCHRONIZATIONOBJECTCB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_CREATESYNCHRONIZATIONOBJECT*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATEVERTEXSHADERDECL)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CREATEVERTEXSHADERDECL*, _In_ CONST D3DDDIVERTEXELEMENT*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATEVERTEXSHADERFUNC)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CREATEVERTEXSHADERFUNC*, _In_ CONST UINT*);
typedef HRESULT (APIENTRY *PFND3DDDI_CREATEVIDEOPROCESSDEVICE)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CREATEVIDEOPROCESSDEVICE*);
typedef HRESULT (APIENTRY *PFND3DDDI_CRYPTOSESSIONKEYEXCHANGE)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_CRYPTOSESSIONKEYEXCHANGE*);
typedef HRESULT (APIENTRY *PFND3DDDI_DEALLOCATE2CB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_DEALLOCATE2*);
typedef HRESULT (APIENTRY *PFND3DDDI_DEALLOCATECB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_DEALLOCATE*);
typedef HRESULT (APIENTRY *PFND3DDDI_DECODEBEGINFRAME)(_In_ HANDLE hDevice, _In_ D3DDDIARG_DECODEBEGINFRAME*);
typedef HRESULT (APIENTRY *PFND3DDDI_DECODEENDFRAME)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_DECODEENDFRAME*);
typedef HRESULT (APIENTRY *PFND3DDDI_DECODEEXECUTE)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_DECODEEXECUTE*);
typedef HRESULT (APIENTRY *PFND3DDDI_DECODEEXTENSIONEXECUTE)(_In_ HANDLE hDevice, _Inout_ CONST D3DDDIARG_DECODEEXTENSIONEXECUTE*);
typedef HRESULT (APIENTRY *PFND3DDDI_DECRYPTIONBLT)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_DECRYPTIONBLT*);
typedef HRESULT (APIENTRY *PFND3DDDI_DELETEPIXELSHADER)(_In_ HANDLE hDevice, _In_ HANDLE);
typedef HRESULT (APIENTRY *PFND3DDDI_DELETEVERTEXSHADERDECL)(_In_ HANDLE hDevice, _In_ HANDLE);
typedef HRESULT (APIENTRY *PFND3DDDI_DELETEVERTEXSHADERFUNC)(_In_ HANDLE hDevice, _In_ HANDLE);
typedef HRESULT (APIENTRY *PFND3DDDI_DEPTHFILL)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_DEPTHFILL*);
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYAUTHENTICATEDCHANNEL)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_DESTROYAUTHENTICATEDCHANNEL*);
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYCONTEXTCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_DESTROYCONTEXT*);
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYCRYPTOSESSION)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_DESTROYCRYPTOSESSION*);
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYDECODEDEVICE)(_In_ HANDLE hDevice, _In_ HANDLE);
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYDEVICE)(_In_ HANDLE hDevice);
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYEXTENSIONDEVICE)(_In_ HANDLE hDevice, _In_ HANDLE hExtension);
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM2_2_1)
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYHWCONTEXTCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_DESTROYHWCONTEXT*);
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYHWQUEUECB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_DESTROYHWQUEUE*);
#endif
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYLIGHT)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_DESTROYLIGHT*);
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYOVERLAY)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_DESTROYOVERLAY*);
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYOVERLAYCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_DESTROYOVERLAY*);
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYPAGINGQUEUECB)(_In_ HANDLE hDevice, _In_ const D3DDDI_DESTROYPAGINGQUEUE*);
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYQUERY)(_In_ HANDLE hDevice, _In_ CONST HANDLE);
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYRESOURCE)(_In_ HANDLE hDevice, _In_ HANDLE);
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYSYNCHRONIZATIONOBJECTCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_DESTROYSYNCHRONIZATIONOBJECT*);
typedef HRESULT (APIENTRY *PFND3DDDI_DESTROYVIDEOPROCESSDEVICE)(_In_ HANDLE hDevice, _In_ HANDLE hVideoProcessor);
typedef HRESULT (APIENTRY *PFND3DDDI_DISCARD)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_DISCARD*);
typedef HRESULT (APIENTRY *PFND3DDDI_DRAWINDEXEDPRIMITIVE)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_DRAWINDEXEDPRIMITIVE*);
typedef HRESULT (APIENTRY *PFND3DDDI_DRAWINDEXEDPRIMITIVE2)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_DRAWINDEXEDPRIMITIVE2*, _In_ UINT, _In_ CONST VOID*, _In_opt_ CONST UINT*);
typedef HRESULT (APIENTRY *PFND3DDDI_DRAWPRIMITIVE)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_DRAWPRIMITIVE*, _In_opt_ CONST UINT*);
typedef HRESULT (APIENTRY *PFND3DDDI_DRAWPRIMITIVE2)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_DRAWPRIMITIVE2*);
typedef HRESULT (APIENTRY *PFND3DDDI_DRAWRECTPATCH)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_DRAWRECTPATCH*, _In_ CONST D3DDDIRECTPATCH_INFO*, _In_ CONST FLOAT*);
typedef HRESULT (APIENTRY *PFND3DDDI_DRAWTRIPATCH)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_DRAWTRIPATCH*, _In_ CONST D3DDDITRIPATCH_INFO*, _In_ CONST FLOAT*);
typedef HRESULT (APIENTRY *PFND3DDDI_DXVAHD_CREATEVIDEOPROCESSOR)(_In_ HANDLE, _Inout_ D3DDDIARG_DXVAHD_CREATEVIDEOPROCESSOR*);
typedef HRESULT (APIENTRY *PFND3DDDI_DXVAHD_DESTROYVIDEOPROCESSOR)(_In_ HANDLE, _In_ HANDLE);
typedef HRESULT (APIENTRY *PFND3DDDI_DXVAHD_GETVIDEOPROCESSBLTSTATEPRIVATE)(_In_ HANDLE, _Inout_ D3DDDIARG_DXVAHD_GETVIDEOPROCESSBLTSTATEPRIVATE*);
typedef HRESULT (APIENTRY *PFND3DDDI_DXVAHD_GETVIDEOPROCESSSTREAMSTATEPRIVATE)(_In_ HANDLE, _Inout_ D3DDDIARG_DXVAHD_GETVIDEOPROCESSSTREAMSTATEPRIVATE*);
typedef HRESULT (APIENTRY *PFND3DDDI_DXVAHD_SETVIDEOPROCESSBLTSTATE)(_In_ HANDLE, _In_ CONST D3DDDIARG_DXVAHD_SETVIDEOPROCESSBLTSTATE*);
typedef HRESULT (APIENTRY *PFND3DDDI_DXVAHD_SETVIDEOPROCESSSTREAMSTATE)(_In_ HANDLE, _In_ CONST D3DDDIARG_DXVAHD_SETVIDEOPROCESSSTREAMSTATE*);
typedef HRESULT (APIENTRY *PFND3DDDI_DXVAHD_VIDEOPROCESSBLTHD)(_In_ HANDLE, _In_ CONST D3DDDIARG_DXVAHD_VIDEOPROCESSBLTHD*);
typedef HRESULT (APIENTRY *PFND3DDDI_ENCRYPTIONBLT)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_ENCRYPTIONBLT*);
typedef HRESULT (APIENTRY *PFND3DDDI_ESCAPECB)(_In_ HANDLE hAdapter, _Inout_ CONST D3DDDICB_ESCAPE*);
typedef HRESULT (APIENTRY *PFND3DDDI_EVICTCB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_EVICT*);
typedef HRESULT (APIENTRY *PFND3DDDI_EXTENSIONEXECUTE)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_EXTENSIONEXECUTE*);
typedef HRESULT (APIENTRY *PFND3DDDI_FINISHSESSIONKEYREFRESH)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_FINISHSESSIONKEYREFRESH*);
typedef HRESULT (APIENTRY *PFND3DDDI_FLIPOVERLAY)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_FLIPOVERLAY*);
typedef HRESULT (APIENTRY *PFND3DDDI_FLIPOVERLAYCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_FLIPOVERLAY*);
typedef HRESULT (APIENTRY *PFND3DDDI_FLUSH)(_In_ HANDLE hDevice);
typedef HRESULT (APIENTRY *PFND3DDDI_FLUSH1)(_In_ HANDLE hDevice, UINT /*D3DDDI_FLUSH_FLAGS*/ FlushFlags);
typedef HRESULT (APIENTRY *PFND3DDDI_FREEGPUVIRTUALADDRESSCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_FREEGPUVIRTUALADDRESS*);
typedef HRESULT (APIENTRY *PFND3DDDI_GENERATEMIPSUBLEVELS)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_GENERATEMIPSUBLEVELS*);
typedef HRESULT (APIENTRY *PFND3DDDI_GETCAPS)(_In_ HANDLE hAdapter, _Inout_ CONST D3DDDIARG_GETCAPS*);
typedef HRESULT (APIENTRY *PFND3DDDI_GETCAPTUREALLOCATIONHANDLE)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_GETCAPTUREALLOCATIONHANDLE*);
typedef HRESULT (APIENTRY *PFND3DDDI_GETENCRYPTIONBLTKEY)(_In_ HANDLE hDevice, _Inout_ CONST D3DDDIARG_GETENCRYPTIONBLTKEY*);
typedef HRESULT (APIENTRY *PFND3DDDI_GETINFO)(_In_ HANDLE hDevice, _In_ UINT, _Out_writes_bytes_(DevInfoSize)VOID*, _In_ UINT DevInfoSize);
typedef HRESULT (APIENTRY *PFND3DDDI_GETMULTISAMPLEMETHODLISTCB)(_In_ HANDLE hAdapter, _Inout_ D3DDDICB_GETMULTISAMPLEMETHODLIST*);
typedef HRESULT (APIENTRY *PFND3DDDI_GETOVERLAYCOLORCONTROLS)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_GETOVERLAYCOLORCONTROLS*);
typedef HRESULT (APIENTRY *PFND3DDDI_GETPITCH)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_GETPITCH*);
typedef HRESULT (APIENTRY *PFND3DDDI_GETQUERYDATA)(_In_ HANDLE hDevice, _Inout_ CONST D3DDDIARG_GETQUERYDATA*);
typedef HRESULT (APIENTRY *PFND3DDDI_GETRESOURCEPRESENTPRIVATEDRIVERDATACB)(_In_ HANDLE hDevice, _Inout_ D3DDDI_GETRESOURCEPRESENTPRIVATEDRIVERDATA*);
typedef HRESULT (APIENTRY *PFND3DDDI_INVALIDATECACHECB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_INVALIDATECACHE*);
typedef HRESULT (APIENTRY *PFND3DDDI_ISSUEQUERY)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_ISSUEQUERY*);
typedef HRESULT (APIENTRY *PFND3DDDI_LOCK)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_LOCK*);
typedef HRESULT (APIENTRY *PFND3DDDI_LOCK2CB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_LOCK2*);
typedef HRESULT (APIENTRY *PFND3DDDI_LOCKASYNC)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_LOCKASYNC*);
typedef HRESULT (APIENTRY *PFND3DDDI_LOCKCB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_LOCK*);
typedef HRESULT (APIENTRY *PFND3DDDI_LOGUMDMARKERCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_LOGUMDMARKER*);
typedef HRESULT (APIENTRY *PFND3DDDI_MAKERESIDENTCB)(_In_ HANDLE hDevice, _Inout_ D3DDDI_MAKERESIDENT*);
typedef HRESULT (APIENTRY *PFND3DDDI_MAPGPUVIRTUALADDRESSCB)(_In_ HANDLE hDevice, _Inout_ D3DDDI_MAPGPUVIRTUALADDRESS*);
typedef HRESULT (APIENTRY *PFND3DDDI_MULTIPLYTRANSFORM)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_MULTIPLYTRANSFORM*);
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM2_1_1)
typedef HRESULT (APIENTRY *PFND3DDDI_OFFERALLOCATIONS2CB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_OFFERALLOCATIONS2*);
#endif
typedef HRESULT (APIENTRY *PFND3DDDI_OFFERALLOCATIONSCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_OFFERALLOCATIONS*);
typedef HRESULT (APIENTRY *PFND3DDDI_OFFERRESOURCES)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_OFFERRESOURCES*);
typedef HRESULT (APIENTRY *PFND3DDDI_OPENADAPTER)(_Inout_ D3DDDIARG_OPENADAPTER*);
typedef HRESULT (APIENTRY *PFND3DDDI_OPENRESOURCE)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_OPENRESOURCE*);
typedef HRESULT (APIENTRY *PFND3DDDI_PRESENT)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_PRESENT*);
typedef HRESULT (APIENTRY *PFND3DDDI_PRESENT1)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_PRESENT1*);
typedef HRESULT (APIENTRY *PFND3DDDI_PRESENTCB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_PRESENT*);
typedef HRESULT (APIENTRY *PFND3DDDI_PRESENTMULTIPLANEOVERLAY)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_PRESENTMULTIPLANEOVERLAY*);
typedef HRESULT (APIENTRY *PFND3DDDI_PRESENTMULTIPLANEOVERLAYCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_PRESENTMULTIPLANEOVERLAY*);
typedef HRESULT (APIENTRY *PFND3DDDI_QUERYADAPTERINFOCB)(_In_ HANDLE hAdapter, _Inout_ CONST D3DDDICB_QUERYADAPTERINFO*);
typedef HRESULT (APIENTRY *PFND3DDDI_QUERYAUTHENTICATEDCHANNEL)(_In_ HANDLE hDevice, _Inout_ CONST D3DDDIARG_QUERYAUTHENTICATEDCHANNEL*);
typedef HRESULT (APIENTRY *PFND3DDDI_QUERYRESIDENCYCB)(_In_ HANDLE hDevice, _Inout_ CONST D3DDDICB_QUERYRESIDENCY*);
typedef HRESULT (APIENTRY *PFND3DDDI_QUERYRESOURCERESIDENCY)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_QUERYRESOURCERESIDENCY*);
typedef HRESULT (APIENTRY *PFND3DDDI_RECLAIMALLOCATIONS2CB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_RECLAIMALLOCATIONS2*);
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM2_1_2)
typedef HRESULT (APIENTRY *PFND3DDDI_RECLAIMALLOCATIONS3CB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_RECLAIMALLOCATIONS3*);
#endif
typedef HRESULT (APIENTRY *PFND3DDDI_RECLAIMALLOCATIONSCB)(_In_ HANDLE hDevice, _Inout_ CONST D3DDDICB_RECLAIMALLOCATIONS*);
typedef HRESULT (APIENTRY *PFND3DDDI_RECLAIMRESOURCES)(_In_ HANDLE hDevice, _Inout_ CONST D3DDDIARG_RECLAIMRESOURCES*);
typedef HRESULT (APIENTRY *PFND3DDDI_RENAME)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_RENAME*);
typedef HRESULT (APIENTRY *PFND3DDDI_RENDERCB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_RENDER*);
typedef HRESULT (APIENTRY *PFND3DDDI_RESERVEGPUVIRTUALADDRESSCB)(_In_ HANDLE hDevice, _Inout_ D3DDDI_RESERVEGPUVIRTUALADDRESS*);
typedef HRESULT (APIENTRY *PFND3DDDI_RESOLVESHAREDRESOURCE)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_RESOLVESHAREDRESOURCE*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETASYNCCALLBACKSCB)(_In_ HANDLE hDevice, _In_ BOOL Enable);
typedef HRESULT (APIENTRY *PFND3DDDI_SETCLIPPLANE)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETCLIPPLANE*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETCONVOLUTIONKERNELMONO)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETCONVOLUTIONKERNELMONO*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETDECODERENDERTARGET)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETDECODERENDERTARGET*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETDEPTHSTENCIL)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETDEPTHSTENCIL*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETDISPLAYMODE)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETDISPLAYMODE*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETDISPLAYMODECB)(_In_ HANDLE hDevice, _Inout_ D3DDDICB_SETDISPLAYMODE*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETDISPLAYPRIVATEDRIVERFORMATCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_SETDISPLAYPRIVATEDRIVERFORMAT*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETINDICES)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETINDICES*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETINDICESUM)(_In_ HANDLE hDevice, _In_ UINT, _In_ CONST VOID*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETLIGHT)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETLIGHT*, _In_ CONST D3DDDI_LIGHT*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETMARKER)(_In_ HANDLE hDevice);
typedef HRESULT (APIENTRY *PFND3DDDI_SETMARKERMODE)(_In_ HANDLE hDevice, _In_ D3DDDI_MARKERTYPE Type, /*D3DDDI_SETMARKERMODE*/ UINT Flags);
typedef HRESULT (APIENTRY *PFND3DDDI_SETMATERIAL)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETMATERIAL*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETOVERLAYCOLORCONTROLS)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETOVERLAYCOLORCONTROLS*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETPALETTE)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETPALETTE*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETPIXELSHADER)(_In_ HANDLE hDevice, _In_ HANDLE);
typedef HRESULT (APIENTRY *PFND3DDDI_SETPIXELSHADERCONST)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETPIXELSHADERCONST*, _In_ CONST FLOAT*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETPIXELSHADERCONSTB)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETPIXELSHADERCONSTB*, _In_ CONST BOOL*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETPIXELSHADERCONSTI)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETPIXELSHADERCONSTI*, _In_ CONST INT*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETPRIORITY)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETPRIORITY*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETPRIORITYCB)(_In_ HANDLE hDevice, _In_ D3DDDICB_SETPRIORITY*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETRENDERSTATE)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_RENDERSTATE*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETRENDERTARGET)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETRENDERTARGET*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETSCISSORRECT)(_In_ HANDLE hDevice, _In_ CONST RECT*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETSTREAMSOURCE)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETSTREAMSOURCE*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETSTREAMSOURCEFREQ)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETSTREAMSOURCEFREQ*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETSTREAMSOURCEUM)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETSTREAMSOURCEUM*, _In_ CONST VOID*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETTEXTURE)(_In_ HANDLE hDevice, _In_ UINT, _In_ HANDLE);
typedef HRESULT (APIENTRY *PFND3DDDI_SETTEXTURESTAGESTATE)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_TEXTURESTAGESTATE*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETTRANSFORM)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETTRANSFORM*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETVERTEXSHADERCONST)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETVERTEXSHADERCONST*, _In_ CONST VOID*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETVERTEXSHADERCONSTB)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETVERTEXSHADERCONSTB*, _In_ CONST BOOL*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETVERTEXSHADERCONSTI)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETVERTEXSHADERCONSTI*, _In_ CONST INT*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETVERTEXSHADERDECL)(_In_ HANDLE hDevice, _In_ HANDLE);
typedef HRESULT (APIENTRY *PFND3DDDI_SETVERTEXSHADERFUNC)(_In_ HANDLE hDevice, _In_ HANDLE);
typedef HRESULT (APIENTRY *PFND3DDDI_SETVIDEOPROCESSRENDERTARGET)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SETVIDEOPROCESSRENDERTARGET*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETVIEWPORT)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_VIEWPORTINFO*);
typedef HRESULT (APIENTRY *PFND3DDDI_SETZRANGE)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_ZRANGE*);
typedef HRESULT (APIENTRY *PFND3DDDI_SIGNALSYNCHRONIZATIONOBJECT2CB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_SIGNALSYNCHRONIZATIONOBJECT2*);
typedef HRESULT (APIENTRY *PFND3DDDI_SIGNALSYNCHRONIZATIONOBJECTCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_SIGNALSYNCHRONIZATIONOBJECT*);
typedef HRESULT (APIENTRY *PFND3DDDI_SIGNALSYNCHRONIZATIONOBJECTFROMCPUCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_SIGNALSYNCHRONIZATIONOBJECTFROMCPU*);
typedef HRESULT (APIENTRY *PFND3DDDI_SIGNALSYNCHRONIZATIONOBJECTFROMGPU2CB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_SIGNALSYNCHRONIZATIONOBJECTFROMGPU2*);
typedef HRESULT (APIENTRY *PFND3DDDI_SIGNALSYNCHRONIZATIONOBJECTFROMGPUCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_SIGNALSYNCHRONIZATIONOBJECTFROMGPU*);
typedef HRESULT (APIENTRY *PFND3DDDI_STARTSESSIONKEYREFRESH)(_In_ HANDLE hDevice, _Inout_ CONST D3DDDIARG_STARTSESSIONKEYREFRESH*);
typedef HRESULT (APIENTRY *PFND3DDDI_STATESET)(_In_ HANDLE hDevice, _In_ D3DDDIARG_STATESET*);
typedef HRESULT (APIENTRY *PFND3DDDI_SUBMITCOMMANDCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_SUBMITCOMMAND*);
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM2_2_1)
...
#endif
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM2_1_2)
typedef VOID (APIENTRY *PFND3DDDI_SYNCTOKEN)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_SYNCTOKEN*);
typedef HRESULT (APIENTRY *PFND3DDDI_SYNCTOKENCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_SYNCTOKEN*);
#if (D3D_UMD_INTERFACE_VERSION == D3D_UMD_INTERFACE_VERSION_WDDM2_1_2)
typedef PFND3DDDI_SYNCTOKENCB PFND3DDDI_ACQUIRERESOURCECB;
#endif
#endif
typedef HRESULT (APIENTRY *PFND3DDDI_TEXBLT)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_TEXBLT*);
typedef HRESULT (APIENTRY *PFND3DDDI_TEXBLT1)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_TEXBLT1*);
typedef HRESULT (APIENTRY *PFND3DDDI_TRIMRESIDENCYSET)(_In_ HANDLE hDevice, _In_ D3DDDIARG_TRIMRESIDENCYSET*);
typedef HRESULT (APIENTRY *PFND3DDDI_UNLOCK)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_UNLOCK*);
typedef HRESULT (APIENTRY *PFND3DDDI_UNLOCK2CB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_UNLOCK2*);
typedef HRESULT (APIENTRY *PFND3DDDI_UNLOCKASYNC)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_UNLOCKASYNC*);
typedef HRESULT (APIENTRY *PFND3DDDI_UNLOCKCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_UNLOCK*);
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM2_1_1)
typedef HRESULT (APIENTRY *PFND3DDDI_UPDATEALLOCATIONPROPERTYCB)(_In_ HANDLE hDevice, _Inout_ D3DDDI_UPDATEALLOCPROPERTY*);
#endif
typedef HRESULT (APIENTRY *PFND3DDDI_UPDATEGPUVIRTUALADDRESSCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_UPDATEGPUVIRTUALADDRESS*);
typedef HRESULT (APIENTRY *PFND3DDDI_UPDATEOVERLAY)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_UPDATEOVERLAY*);
typedef HRESULT (APIENTRY *PFND3DDDI_UPDATEOVERLAYCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_UPDATEOVERLAY*);
typedef HRESULT (APIENTRY *PFND3DDDI_UPDATEPALETTE)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_UPDATEPALETTE*, _In_ CONST PALETTEENTRY*);
typedef HRESULT (APIENTRY *PFND3DDDI_UPDATESUBRESOURCEUP)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_UPDATESUBRESOURCEUP*);
typedef HRESULT (APIENTRY *PFND3DDDI_UPDATEWINFO)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_WINFO*);
typedef HRESULT (APIENTRY *PFND3DDDI_VALIDATEDEVICE)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_VALIDATETEXTURESTAGESTATE*);
typedef HRESULT (APIENTRY *PFND3DDDI_VIDEOPROCESSBEGINFRAME)(_In_ HANDLE hDevice, _In_ HANDLE hVideoProcess);
typedef HRESULT (APIENTRY *PFND3DDDI_VIDEOPROCESSBLT)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_VIDEOPROCESSBLT*);
typedef HRESULT (APIENTRY *PFND3DDDI_VIDEOPROCESSENDFRAME)(_In_ HANDLE hDevice, _Inout_ D3DDDIARG_VIDEOPROCESSENDFRAME*);
typedef HRESULT (APIENTRY *PFND3DDDI_VOLBLT)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_VOLUMEBLT*);
typedef HRESULT (APIENTRY *PFND3DDDI_VOLBLT1)(_In_ HANDLE hDevice, _In_ CONST D3DDDIARG_VOLUMEBLT1*);
typedef HRESULT (APIENTRY *PFND3DDDI_WAITFORSYNCHRONIZATIONOBJECT2CB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_WAITFORSYNCHRONIZATIONOBJECT2*);
typedef HRESULT (APIENTRY *PFND3DDDI_WAITFORSYNCHRONIZATIONOBJECTCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_WAITFORSYNCHRONIZATIONOBJECT*);
typedef HRESULT (APIENTRY *PFND3DDDI_WAITFORSYNCHRONIZATIONOBJECTFROMCPUCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_WAITFORSYNCHRONIZATIONOBJECTFROMCPU*);
typedef HRESULT (APIENTRY *PFND3DDDI_WAITFORSYNCHRONIZATIONOBJECTFROMGPUCB)(_In_ HANDLE hDevice, _In_ CONST D3DDDICB_WAITFORSYNCHRONIZATIONOBJECTFROMGPU*);
typedef _Check_return_ HRESULT (APIENTRY CALLBACK *PFND3DDDI_QUERYADAPTERINFOCB)( _In_ HANDLE hAdapter, _Inout_ CONST D3DDDICB_QUERYADAPTERINFO*);
typedef _Check_return_ HRESULT (APIENTRY CALLBACK *PFND3DDDI_GETMULTISAMPLEMETHODLISTCB)( _In_ HANDLE hAdapter, _Inout_ D3DDDICB_GETMULTISAMPLEMETHODLIST*);
typedef _Check_return_ HRESULT (APIENTRY *PFND3DDDI_GETCAPS)( _In_ HANDLE hAdapter, _Inout_ CONST D3DDDIARG_GETCAPS*);
typedef _Check_return_ HRESULT (APIENTRY *PFND3DDDI_CREATEDEVICE)( _In_ HANDLE hAdapter, _Inout_ D3DDDIARG_CREATEDEVICE*);
typedef _Check_return_ HRESULT (APIENTRY *PFND3DDDI_CLOSEADAPTER)( _In_ HANDLE hAdapter);
...
/* ------------------------------------------------------------------------ *
 * Entry structure bodies, completing the declarations at the top.
 * ------------------------------------------------------------------------ */
struct _D3DDDI_CREATEDEVICEFLAGS
{
    union
    {
        struct
...
struct _D3DDDIARG_CREATEDEVICE
{
