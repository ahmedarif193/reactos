...
typedef NTSTATUS APIENTRY DXGKDDI_STOPCAPTURE(
...
typedef VOID (APIENTRY CALLBACK *DXGKCB_PRESENT_DISPLAYONLY_PROGRESS)(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARGCB_PRESENT_DISPLAYONLY_PROGRESS pProgress);
...
typedef NTSTATUS APIENTRY DXGKDDI_PRESENTDISPLAYONLY(
    IN_CONST_HANDLE hAdapter,
...
DEFINE_GUID(GUID_DXGKDDI_POWER_VOLTAGE,
            0x78ba81db, 0x0f5c, 0x45fd, 0x8f, 0x03, 0xc7, 0xb5, 0xcc, 0xd1, 0xe0, 0xda);
...
DEFINE_GUID(GUID_DXGKDDI_POWER_CLOCK,
            0x51c6873b, 0x1c29, 0x4c45, 0x82, 0x46, 0x05, 0xe4, 0xd6, 0xd8, 0x0d, 0x15);
...
typedef NTSTATUS APIENTRY DXGKDDI_CHECKMULTIPLANEOVERLAYSUPPORT(
    IN_CONST_HANDLE hAdapter,
...
typedef NTSTATUS APIENTRY DXGKDDI_SETVIDPNSOURCEADDRESSWITHMULTIPLANEOVERLAY(
    IN_CONST_HANDLE hAdapter,
...
typedef NTSTATUS APIENTRY DXGKDDI_CHECKMULTIPLANEOVERLAYSUPPORT2(
    IN_CONST_HANDLE hAdapter,
...
typedef NTSTATUS APIENTRY DXGKDDI_SETVIDPNSOURCEADDRESSWITHMULTIPLANEOVERLAY2(
    IN_CONST_HANDLE hAdapter,
...
typedef _Inout_ DXGKARGCB_FEATURE_SAMPLE_GETVALUE
    *INOUT_PDXGKARGCB_FEATURE_SAMPLE_GETVALUE;
...
typedef _Inout_ DXGKARG_FEATURE_SAMPLE_ADDVALUE
    *INOUT_PDXGKARG_FEATURE_SAMPLE_ADDVALUE;
...
typedef _Inout_ DXGKARG_FEATURE_SAMPLE_SUBTRACTVALUE
    *INOUT_PDXGKARG_FEATURE_SAMPLE_SUBTRACTVALUE;
...
typedef _Inout_ DXGKARG_BUILDTESTCOMMANDBUFFER
    *INOUT_PDXGKARG_BUILDTESTCOMMANDBUFFER;
...
C_ASSERT(sizeof(DXGKARGCB_FEATURE_SAMPLE_GETVALUE) == 0x4);
C_ASSERT(sizeof(DXGKARG_FEATURE_SAMPLE_ADDVALUE) == 0x8);
C_ASSERT(sizeof(DXGKARG_FEATURE_SAMPLE_SUBTRACTVALUE) == 0x8);
...
C_ASSERT(sizeof(DXGKARG_BUILDTESTCOMMANDBUFFER) == 0x70);
C_ASSERT(sizeof(DXGKDDI_KERNELMODETESTINGINTERFACE) == 0x8);
...
/* Command requires 8-byte alignment, including the structure's tail padding. */
C_ASSERT(FIELD_OFFSET(DXGKARG_BUILDTESTCOMMANDBUFFER, Command) == 0x8);
C_ASSERT(FIELD_OFFSET(DXGKARG_BUILDTESTCOMMANDBUFFER, pDmaBuffer) == 0x50);
C_ASSERT(FIELD_OFFSET(DXGKARG_BUILDTESTCOMMANDBUFFER, Flags) == 0x60);
C_ASSERT(sizeof(DXGKARG_BUILDTESTCOMMANDBUFFER) == 0x68);
C_ASSERT(sizeof(DXGKDDI_KERNELMODETESTINGINTERFACE) == 0x4);
...
/*
 * Canonical WDK callback parameter aliases.  ReactOS historically exposed
 * only its pointer-typedef callback table; external miniports also name the
 * function types and their SAL-decorated arguments directly.
 */
...
typedef VOID (APIENTRY CALLBACK *DXGKCB_NOTIFYVSYNC)(
    IN_CONST_HANDLE hAdapter,
    D3DDDI_VIDEO_PRESENT_SOURCE_ID VidPnSourceId);
...
C_ASSERT(sizeof(DXGKARG_QUERYDEPENDENTENGINEGROUP) == 0x10);
C_ASSERT(FIELD_OFFSET(DXGKARG_QUERYDEPENDENTENGINEGROUP, DependentNodeOrdinalMask) == 0x8);
#endif
...
#endif
C_ASSERT(sizeof(DXGKARG_HISTORYBUFFERPRECISION) == 0x4);
#endif

/* WDK function-name typedefs used by source-compatible display miniports. */
typedef NTSTATUS APIENTRY DXGKDDI_QUERYADAPTERINFO(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_QUERYADAPTERINFO pQueryAdapterInfo);

typedef NTSTATUS APIENTRY DXGKDDI_CREATEDEVICE(
    IN_CONST_HANDLE hAdapter,
    INOUT_PDXGKARG_CREATEDEVICE pCreateDevice);

typedef NTSTATUS APIENTRY DXGKDDI_CREATEALLOCATION(
    IN_CONST_HANDLE hAdapter,
    INOUT_PDXGKARG_CREATEALLOCATION pCreateAllocation);

typedef NTSTATUS APIENTRY DXGKDDI_DESTROYALLOCATION(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_DESTROYALLOCATION pDestroyAllocation);

typedef NTSTATUS APIENTRY DXGKDDI_DESCRIBEALLOCATION(
    IN_CONST_HANDLE hAdapter,
    INOUT_PDXGKARG_DESCRIBEALLOCATION pDescribeAllocation);

typedef NTSTATUS APIENTRY DXGKDDI_GETSTANDARDALLOCATIONDRIVERDATA(
    IN_CONST_HANDLE hAdapter,
    INOUT_PDXGKARG_GETSTANDARDALLOCATIONDRIVERDATA pStandardAllocationDriverData);

typedef NTSTATUS APIENTRY DXGKDDI_ACQUIRESWIZZLINGRANGE(
    IN_CONST_HANDLE hAdapter,
    INOUT_PDXGKARG_ACQUIRESWIZZLINGRANGE pAcquireSwizzlingRange);

typedef NTSTATUS APIENTRY DXGKDDI_RELEASESWIZZLINGRANGE(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_RELEASESWIZZLINGRANGE pReleaseSwizzlingRange);

typedef NTSTATUS APIENTRY DXGKDDI_PATCH(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_PATCH pPatch);

typedef NTSTATUS APIENTRY DXGKDDI_SUBMITCOMMAND(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_SUBMITCOMMAND pSubmitCommand);

typedef NTSTATUS APIENTRY DXGKDDI_PREEMPTCOMMAND(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_PREEMPTCOMMAND pPreemptCommand);

typedef NTSTATUS APIENTRY DXGKDDI_CANCELCOMMAND(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_CANCELCOMMAND pCancelCommand);

typedef NTSTATUS APIENTRY DXGKDDI_BUILDPAGINGBUFFER(
    IN_CONST_HANDLE hAdapter,
    IN_PDXGKARG_BUILDPAGINGBUFFER pBuildPagingBuffer);

typedef NTSTATUS APIENTRY DXGKDDI_RESETFROMTIMEOUT(
    IN_CONST_HANDLE hAdapter);

typedef NTSTATUS APIENTRY DXGKDDI_RESTARTFROMTIMEOUT(
    IN_CONST_HANDLE hAdapter);

typedef NTSTATUS APIENTRY DXGKDDI_ESCAPE(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_ESCAPE pEscape);

typedef NTSTATUS APIENTRY DXGKDDI_COLLECTDBGINFO(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_COLLECTDBGINFO pCollectDbgInfo);

typedef NTSTATUS APIENTRY DXGKDDI_QUERYCURRENTFENCE(
    IN_CONST_HANDLE hAdapter,
    INOUT_PDXGKARG_QUERYCURRENTFENCE pCurrentFence);

typedef NTSTATUS APIENTRY DXGKDDI_RECOMMENDVIDPNTOPOLOGY(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_RECOMMENDVIDPNTOPOLOGY_CONST pRecommendVidPnTopology);

typedef NTSTATUS APIENTRY DXGKDDI_CREATEOVERLAY(
    IN_CONST_HANDLE hAdapter,
    INOUT_PDXGKARG_CREATEOVERLAY pCreateOverlay);

typedef NTSTATUS APIENTRY DXGKDDI_UPDATEOVERLAY(
    IN_CONST_HANDLE hOverlay,
    IN_CONST_PDXGKARG_UPDATEOVERLAY pUpdateOverlay);

typedef NTSTATUS APIENTRY DXGKDDI_FLIPOVERLAY(
    IN_CONST_HANDLE hOverlay,
    IN_CONST_PDXGKARG_FLIPOVERLAY pFlipOverlay);

typedef NTSTATUS APIENTRY DXGKDDI_DESTROYOVERLAY(
    IN_CONST_HANDLE hOverlay);

typedef NTSTATUS APIENTRY DXGKDDI_DESTROYDEVICE(
    IN_CONST_HANDLE hDevice);

typedef NTSTATUS APIENTRY DXGKDDI_CLOSEALLOCATION(
    IN_CONST_HANDLE hDevice,
    IN_CONST_PDXGKARG_CLOSEALLOCATION pCloseAllocation);

typedef NTSTATUS APIENTRY DXGKDDI_RENDER(
    IN_CONST_HANDLE hContext,
    INOUT_PDXGKARG_RENDER pRender);

typedef NTSTATUS APIENTRY DXGKDDI_CREATECONTEXT(
    IN_CONST_HANDLE hDevice,
    INOUT_PDXGKARG_CREATECONTEXT pCreateContext);

typedef NTSTATUS APIENTRY DXGKDDI_DESTROYCONTEXT(
    IN_CONST_HANDLE hContext);

typedef NTSTATUS APIENTRY DXGKDDI_SETDISPLAYPRIVATEDRIVERFORMAT(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_SETDISPLAYPRIVATEDRIVERFORMAT pSetDisplayPrivateDriverFormat);

typedef NTSTATUS APIENTRY DXGKDDI_PRESENT(
    IN_CONST_HANDLE hContext,
    INOUT_PDXGKARG_PRESENT pPresent);

typedef NTSTATUS APIENTRY DXGKDDI_OPENALLOCATIONINFO(
    IN_CONST_HANDLE hDevice,
    IN_CONST_PDXGKARG_OPENALLOCATION pOpenAllocation);

typedef NTSTATUS APIENTRY DXGKDDI_SETPALETTE(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_SETPALETTE pSetPalette);

typedef NTSTATUS APIENTRY DXGKDDI_SETPOINTERSHAPE(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_SETPOINTERSHAPE pSetPointerShape);

typedef NTSTATUS APIENTRY DXGKDDI_SETPOINTERPOSITION(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_SETPOINTERPOSITION pSetPointerPosition);

typedef NTSTATUS APIENTRY DXGKDDI_CONTROLINTERRUPT(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_DXGK_INTERRUPT_TYPE InterruptType,
    IN_BOOLEAN EnableInterrupt);

typedef NTSTATUS APIENTRY DXGKDDI_GETSCANLINE(
    IN_CONST_HANDLE hAdapter,
    INOUT_PDXGKARG_GETSCANLINE pGetScanLine);

typedef NTSTATUS APIENTRY DXGKDDI_ISSUPPORTEDVIDPN(
    IN_CONST_HANDLE hAdapter,
    INOUT_PDXGKARG_ISSUPPORTEDVIDPN pIsSupportedVidPn);

typedef NTSTATUS APIENTRY DXGKDDI_ENUMVIDPNCOFUNCMODALITY(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_ENUMVIDPNCOFUNCMODALITY_CONST pEnumCofuncModality);

typedef NTSTATUS APIENTRY DXGKDDI_RECOMMENDFUNCTIONALVIDPN(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_RECOMMENDFUNCTIONALVIDPN_CONST pRecommendFunctionalVidPn);

typedef NTSTATUS APIENTRY DXGKDDI_SETVIDPNSOURCEADDRESS(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_SETVIDPNSOURCEADDRESS pSetVidPnSourceAddress);

typedef NTSTATUS APIENTRY DXGKDDI_SETVIDPNSOURCEVISIBILITY(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_SETVIDPNSOURCEVISIBILITY pSetVidPnSourceVisibility);

typedef NTSTATUS APIENTRY DXGKDDI_COMMITVIDPN(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_COMMITVIDPN_CONST pCommitVidPn);

typedef NTSTATUS APIENTRY DXGKDDI_UPDATEACTIVEVIDPNPRESENTPATH(
    IN_CONST_HANDLE hAdapter,
    IN_CONST_PDXGKARG_UPDATEACTIVEVIDPNPRESENTPATH_CONST pUpdateActiveVidPnPresentPath);

typedef NTSTATUS APIENTRY DXGKDDI_QUERYVIDPNHWCAPABILITY(
    IN_CONST_HANDLE hAdapter,
    INOUT_PDXGKARG_QUERYVIDPNHWCAPABILITY pVidPnHWCaps);

typedef NTSTATUS APIENTRY DXGKDDI_RECOMMENDMONITORMODES(
    IN_CONST_HANDLE hAdapter,
...
#if (DXGKDDI_INTERFACE_VERSION >= DXGKDDI_INTERFACE_VERSION_WIN8)
typedef NTSTATUS APIENTRY DXGKDDI_QUERYDEPENDENTENGINEGROUP(
    IN_CONST_HANDLE hAdapter,
    INOUT_DXGKARG_QUERYDEPENDENTENGINEGROUP pQueryDependentEngineGroup);

typedef NTSTATUS APIENTRY DXGKDDISETPOWERCOMPONENTFSTATE(
    IN_CONST_HANDLE DriverContext,
    UINT ComponentIndex,
    UINT FState);

typedef NTSTATUS APIENTRY DXGKDDIPOWERRUNTIMECONTROLREQUEST(
    IN_CONST_HANDLE DriverContext,
...
typedef NTSTATUS APIENTRY DXGKDDI_QUERYENGINESTATUS(
    IN_CONST_HANDLE hAdapter,
    INOUT_PDXGKARG_QUERYENGINESTATUS pQueryEngineStatus);

typedef NTSTATUS APIENTRY DXGKDDI_RESETENGINE(
    IN_CONST_HANDLE hAdapter,
...
typedef NTSTATUS APIENTRY DXGKDDI_GETNODEMETADATA(
    IN_CONST_HANDLE hAdapter,
    UINT NodeOrdinalAndAdapterIndex,
    OUT_PDXGKARG_GETNODEMETADATA pGetNodeMetadata);

typedef NTSTATUS APIENTRY DXGKDDISETPOWERPSTATE(
    IN_CONST_HANDLE DriverContext,
    UINT ComponentIndex,
    UINT RequestedComponentPState);

typedef NTSTATUS APIENTRY DXGKDDI_FORMATHISTORYBUFFER(
    IN_CONST_HANDLE hContext,
    DXGKARG_FORMATHISTORYBUFFER *pFormatData);

typedef NTSTATUS APIENTRY DXGKDDI_CALIBRATEGPUCLOCK(
    IN_CONST_HANDLE hAdapter,
    UINT32 NodeOrdinal,
...
C_ASSERT(sizeof(DXGK_HISTORY_BUFFER_HEADER) == 0x10);
#endif
