...
CMAPI CONFIGRET WINAPI CM_Get_Class_Property_ExW(const GUID *, const DEVPROPKEY *, DEVPROPTYPE *, BYTE *, ULONG *, ULONG, HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Class_Property_Keys(const GUID *, DEVPROPKEY *, ULONG *, ULONG);
CMAPI CONFIGRET WINAPI CM_Get_Class_Property_Keys_Ex(const GUID *, DEVPROPKEY *, ULONG *, ULONG, HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Class_PropertyW(const GUID *, const DEVPROPKEY *, DEVPROPTYPE *, BYTE *, ULONG *, ULONG);
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_Property_ExW(const WCHAR *, const DEVPROPKEY *, DEVPROPTYPE *, BYTE *, ULONG *, ULONG, HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_Property_Keys_ExW(const WCHAR *, DEVPROPKEY *, ULONG *, ULONG, HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_Property_KeysW(const WCHAR *, DEVPROPKEY *, ULONG *, ULONG);
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Property_ExW(DEVINST, const DEVPROPKEY *, DEVPROPTYPE *, BYTE *, ULONG *, ULONG, HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Property_Keys(DEVINST, DEVPROPKEY *, ULONG *, ULONG);
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Property_Keys_Ex(DEVINST, DEVPROPKEY *, ULONG *, ULONG, HMACHINE);
CMAPI CONFIGRET WINAPI CM_Get_DevNode_PropertyW(DEVINST, const DEVPROPKEY *, DEVPROPTYPE *, BYTE *, ULONG *, ULONG);
CMAPI DWORD WINAPI CM_MapCrToWin32Err(CONFIGRET, DWORD);
CMAPI CONFIGRET WINAPI CM_Set_Class_Property_ExW(const GUID *, const DEVPROPKEY *, DEVPROPTYPE, const BYTE *, ULONG, ULONG, HMACHINE);
CMAPI CONFIGRET WINAPI CM_Set_Class_PropertyW(const GUID *, const DEVPROPKEY *, DEVPROPTYPE, const BYTE *, ULONG, ULONG);
CMAPI CONFIGRET WINAPI CM_Set_Device_Interface_Property_ExW(const WCHAR *, const DEVPROPKEY *, DEVPROPTYPE, const BYTE *, ULONG, ULONG, HMACHINE);
CMAPI CONFIGRET WINAPI CM_Set_Device_Interface_PropertyW(const WCHAR *, const DEVPROPKEY *, DEVPROPTYPE, const BYTE *, ULONG, ULONG);
CMAPI CONFIGRET WINAPI CM_Set_DevNode_Property_ExW(DEVINST, const DEVPROPKEY *, DEVPROPTYPE, const BYTE *, ULONG, ULONG, HMACHINE);
CMAPI CONFIGRET WINAPI CM_Set_DevNode_PropertyW(DEVINST, const DEVPROPKEY *, DEVPROPTYPE, const BYTE *, ULONG, ULONG);
