...
{
    D3DKMT_PTR(VOID*, CurrentValueCpuVa);
...
#endif /* WDDM 3.1 native-fence and doorbell shared ABI */
...
typedef enum _DXGK_FEATURE_ID
{
    ...
    DXGK_FEATURE_QUERYSTATISTICS_EXTENSIONS =
        DXGK_DEFINE_FEATURE_ID(
            ...
            DXGK_OS_FEATURE_QUERYSTATISTICS_EXTENSIONS)
} DXGK_FEATURE_ID;
...
typedef struct _D3DDDI_DRIVERESCAPE_BUILDTESTCOMMANDBUFFER
{
    ...
    D3DKMT_PTR(_Field_size_bytes_(DmaBufferPrivateDataSize) PVOID, pDmaBufferPrivateData);
    UINT DmaBufferSize;
