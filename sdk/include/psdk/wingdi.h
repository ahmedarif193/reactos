...
/* Undocumented negative types; kept out of the enum so mixing them with
 * DISPLAYCONFIG_DEVICE_INFO_FORCE_UINT32 cannot widen it past 32 bits. */
#define DISPLAYCONFIG_DEVICE_INFO_SET_SOURCE_DPI_SCALE ((DISPLAYCONFIG_DEVICE_INFO_TYPE)-4)
#define DISPLAYCONFIG_DEVICE_INFO_GET_SOURCE_DPI_SCALE ((DISPLAYCONFIG_DEVICE_INFO_TYPE)-3)
