...
WINCOMMDLGAPI BOOL WINAPI ChooseColorA(LPCHOOSECOLORA);
WINCOMMDLGAPI BOOL WINAPI ChooseColorW(LPCHOOSECOLORW);
...
WINCOMMDLGAPI BOOL WINAPI GetOpenFileNameA(LPOPENFILENAMEA);
WINCOMMDLGAPI BOOL WINAPI GetOpenFileNameW(LPOPENFILENAMEW);
WINCOMMDLGAPI BOOL WINAPI GetSaveFileNameA(LPOPENFILENAMEA);
WINCOMMDLGAPI BOOL WINAPI GetSaveFileNameW(LPOPENFILENAMEW);
WINCOMMDLGAPI BOOL WINAPI PageSetupDlgA(LPPAGESETUPDLGA);
WINCOMMDLGAPI BOOL WINAPI PageSetupDlgW(LPPAGESETUPDLGW);
WINCOMMDLGAPI BOOL WINAPI PrintDlgA(LPPRINTDLGA);
WINCOMMDLGAPI BOOL WINAPI PrintDlgW(LPPRINTDLGW);
