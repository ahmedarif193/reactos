...
#define HID_USAGE_GENERIC_SYSTEM_POWER_DOWN   ((USAGE) 0x81)
#define HID_USAGE_GENERIC_SYSTEM_SLEEP        ((USAGE) 0x82)
#define HID_USAGE_GENERIC_SYSTEM_WAKE_UP      ((USAGE) 0x83)
...
#define HID_USAGE_DIGITIZER_CONFIDENCE                 ((USAGE) 0x0047)
#define HID_USAGE_DIGITIZER_TOUCH_VALID                HID_USAGE_DIGITIZER_CONFIDENCE
