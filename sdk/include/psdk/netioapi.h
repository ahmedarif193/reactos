...
IPHLPAPI_DLL_LINKAGE DWORD WINAPI CancelMibChangeNotify2(HANDLE);
...
IPHLPAPI_DLL_LINKAGE DWORD WINAPI NotifyIpInterfaceChange(ADDRESS_FAMILY,PIPINTERFACE_CHANGE_CALLBACK,PVOID,BOOLEAN,PHANDLE);
IPHLPAPI_DLL_LINKAGE DWORD WINAPI NotifyRouteChange2(ADDRESS_FAMILY,PIPFORWARD_CHANGE_CALLBACK,PVOID,BOOLEAN,PHANDLE);
IPHLPAPI_DLL_LINKAGE DWORD WINAPI NotifyUnicastIpAddressChange(ADDRESS_FAMILY,PUNICAST_IPADDRESS_CHANGE_CALLBACK,PVOID,BOOLEAN,PHANDLE);
