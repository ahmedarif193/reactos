...
#define RTLSUPPORT_ARM64EC_COMPATIBLE 1
#else
#define RTLSUPPORT_ARM64EC_COMPATIBLE 0
#endif

#if defined(__x86_64__) || defined(_M_AMD64) || RTLSUPPORT_ARM64EC_COMPATIBLE
#define RTLSUPPORT_HAS_EC_CODE_QUERY 1
#else
#define RTLSUPPORT_HAS_EC_CODE_QUERY 0
#endif
...
#if RTLSUPPORT_HAS_EC_CODE_QUERY
