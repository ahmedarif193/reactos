...
typedef struct _DOMAIN_CONFIGURATION DOMAIN_CONFIGURATION,
  *PDOMAIN_CONFIGURATION;
typedef struct _DEVICE_FAULT_CONFIGURATION DEVICE_FAULT_CONFIGURATION,
...
typedef VOID
(NTAPI IOMMU_INTERFACE_STATE_CHANGE_CALLBACK)(
...
#define IOMMU_DMA_DEVICE_INFORMATION_SIZE sizeof(IOMMU_DMA_DEVICE_INFORMATION)
#define IOMMU_DMA_DEVICE_INFORMATION_SIZE_MIN \
  RTL_SIZEOF_THROUGH_FIELD(IOMMU_DMA_DEVICE_INFORMATION, PasidFaultsSuppressed)

typedef NTSTATUS
(NTAPI IOMMU_DOMAIN_CREATE)(
...
typedef NTSTATUS
(NTAPI IOMMU_DOMAIN_DELETE)(
  _In_ PIOMMU_DMA_DOMAIN Domain);

typedef IOMMU_DOMAIN_DELETE *PIOMMU_DOMAIN_DELETE;

typedef NTSTATUS
(NTAPI IOMMU_DOMAIN_ATTACH_DEVICE)(
  _In_ PIOMMU_DMA_DOMAIN Domain,
  _In_ PDEVICE_OBJECT PhysicalDeviceObject,
...
typedef NTSTATUS
(NTAPI IOMMU_DOMAIN_DETACH_DEVICE)(
  _In_ PIOMMU_DMA_DOMAIN Domain,
  _In_ PDEVICE_OBJECT PhysicalDeviceObject,
...
typedef NTSTATUS
(NTAPI IOMMU_FLUSH_DOMAIN)(
  _In_ PIOMMU_DMA_DOMAIN Domain);

typedef IOMMU_FLUSH_DOMAIN *PIOMMU_FLUSH_DOMAIN;

typedef NTSTATUS
(NTAPI IOMMU_FLUSH_DOMAIN_VA_LIST)(
  _In_ PIOMMU_DMA_DOMAIN Domain,
...
typedef NTSTATUS
(NTAPI IOMMU_QUERY_INPUT_MAPPINGS)(
  _In_ PDEVICE_OBJECT PhysicalDeviceObject,
...
typedef NTSTATUS
(NTAPI IOMMU_UNMAP_LOGICAL_RANGE)(
  _In_ PIOMMU_DMA_DOMAIN Domain,
  _In_ ULONGLONG LogicalAddress,
...
typedef NTSTATUS
(NTAPI IOMMU_MAP_IDENTITY_RANGE)(
  _In_ PIOMMU_DMA_DOMAIN Domain,
  _In_ ULONG Permissions,
  _In_ PMDL Mdl);
...
typedef NTSTATUS
(NTAPI IOMMU_UNMAP_IDENTITY_RANGE)(
  _In_ PIOMMU_DMA_DOMAIN Domain,
  _In_ PMDL Mdl);
...
typedef NTSTATUS
(NTAPI IOMMU_SET_DEVICE_FAULT_REPORTING)(
  _In_ PDEVICE_OBJECT PhysicalDeviceObject,
  _In_ ULONG InputMappingIdBase,
  _In_ BOOLEAN Enable,
...
typedef NTSTATUS
(NTAPI IOMMU_DOMAIN_ATTACH_DEVICE_EX)(
  _In_ PIOMMU_DMA_DOMAIN Domain,
...
typedef NTSTATUS
(NTAPI IOMMU_MAP_IDENTITY_RANGE_EX)(
  _In_ PIOMMU_DMA_DOMAIN Domain,
  _In_ ULONG Permissions,
  _In_ PIOMMU_MAP_PHYSICAL_ADDRESS PhysicalAddressToMap);
...
typedef NTSTATUS
(NTAPI IOMMU_UNMAP_IDENTITY_RANGE_EX)(
  _In_ PIOMMU_DMA_DOMAIN Domain,
...
typedef VOID
(NTAPI IOMMU_DEVICE_QUERY_DOMAIN_TYPES)(
  _In_ PIOMMU_DMA_DEVICE DmaDevice,
...
typedef NTSTATUS
(NTAPI IOMMU_REGISTER_INTERFACE_STATE_CHANGE_CALLBACK)(
...
typedef NTSTATUS
(NTAPI IOMMU_UNREGISTER_INTERFACE_STATE_CHANGE_CALLBACK)(
  _In_ PIOMMU_INTERFACE_STATE_CHANGE_CALLBACK StateChangeCallback,
  _In_ PIOMMU_DMA_DEVICE DmaDevice);
...
typedef NTSTATUS
(NTAPI IOMMU_RESERVE_LOGICAL_ADDRESS_RANGE)(
  _In_ PIOMMU_DMA_DOMAIN Domain,
  _In_ SIZE_T Size,
  _In_opt_ PIOMMU_DMA_LOGICAL_ADDRESS ExplicitLogicalAddress,
  _In_opt_ PIOMMU_DMA_LOGICAL_ADDRESS MinLogicalAddress,
...
typedef IOMMU_RESERVE_LOGICAL_ADDRESS_RANGE
  *PIOMMU_RESERVE_LOGICAL_ADDRESS_RANGE;

typedef NTSTATUS
(NTAPI IOMMU_FREE_RESERVED_LOGICAL_ADDRESS_RANGE)(
  _In_ PIOMMU_DMA_LOGICAL_ADDRESS_TOKEN LogicalAddressToken);

typedef IOMMU_FREE_RESERVED_LOGICAL_ADDRESS_RANGE
  *PIOMMU_FREE_RESERVED_LOGICAL_ADDRESS_RANGE;

typedef NTSTATUS
(NTAPI IOMMU_MAP_RESERVED_LOGICAL_RANGE)(
...
typedef NTSTATUS
(NTAPI IOMMU_UNMAP_RESERVED_LOGICAL_RANGE)(
  _Inout_ PIOMMU_DMA_LOGICAL_ADDRESS_TOKEN_MAPPED_SEGMENT MappedSegment);

typedef IOMMU_UNMAP_RESERVED_LOGICAL_RANGE
  *PIOMMU_UNMAP_RESERVED_LOGICAL_RANGE;

typedef NTSTATUS
(NTAPI IOMMU_DEVICE_CREATE)(
  _In_ PDEVICE_OBJECT DeviceObject,
...
typedef NTSTATUS
(NTAPI IOMMU_DEVICE_DELETE)(
  _In_ PIOMMU_DMA_DEVICE DmaDevice);

typedef IOMMU_DEVICE_DELETE *PIOMMU_DEVICE_DELETE;

typedef NTSTATUS
(NTAPI IOMMU_SET_DEVICE_FAULT_REPORTING_EX)(
  _In_ PIOMMU_DMA_DEVICE DmaDevice,
  _In_ ULONG InputMappingIdBase,
  _In_ BOOLEAN Enable,
  _In_opt_ PDEVICE_FAULT_CONFIGURATION FaultConfig);
...
typedef NTSTATUS
(NTAPI IOMMU_PASID_DEVICE_CREATE)(
  _In_ PIOMMU_DMA_DEVICE DmaDevice,
...
typedef NTSTATUS
(NTAPI IOMMU_PASID_DEVICE_DELETE)(
  _In_ PIOMMU_DMA_PASID_DEVICE PasidDevice);

typedef IOMMU_PASID_DEVICE_DELETE *PIOMMU_PASID_DEVICE_DELETE;

typedef NTSTATUS
(NTAPI IOMMU_DOMAIN_ATTACH_PASID_DEVICE)(
  _In_ PIOMMU_DMA_DOMAIN Domain,
  _In_ PIOMMU_DMA_PASID_DEVICE PasidDevice);

typedef IOMMU_DOMAIN_ATTACH_PASID_DEVICE
  *PIOMMU_DOMAIN_ATTACH_PASID_DEVICE;

typedef NTSTATUS
(NTAPI IOMMU_DOMAIN_DETACH_PASID_DEVICE)(
  _In_ PIOMMU_DMA_PASID_DEVICE PasidDevice);

typedef IOMMU_DOMAIN_DETACH_PASID_DEVICE
  *PIOMMU_DOMAIN_DETACH_PASID_DEVICE;

typedef NTSTATUS
(NTAPI IOMMU_DEVICE_QUERY_INFORMATION)(
  _In_ PIOMMU_DMA_DEVICE DmaDevice,
  _In_ ULONG Size,
...
#define DMA_IOMMU_INTERFACE_EX_VERSION_3 3UL
#define DMA_IOMMU_INTERFACE_EX_VERSION_MIN DMA_IOMMU_INTERFACE_EX_VERSION_1
#define DMA_IOMMU_INTERFACE_EX_VERSION_MAX DMA_IOMMU_INTERFACE_EX_VERSION_3
#define DMA_IOMMU_INTERFACE_EX_VERSION DMA_IOMMU_INTERFACE_EX_VERSION_3
...
#define DMA_IOMMU_INTERFACE_EX_V1_SIZE \
  (FIELD_OFFSET(DMA_IOMMU_INTERFACE_EX, V1) + sizeof(DMA_IOMMU_INTERFACE_V1))

#define DMA_IOMMU_INTERFACE_EX_V2_SIZE \
  (FIELD_OFFSET(DMA_IOMMU_INTERFACE_EX, V2) + sizeof(DMA_IOMMU_INTERFACE_V2))

#define DMA_IOMMU_INTERFACE_EX_V3_SIZE \
  (FIELD_OFFSET(DMA_IOMMU_INTERFACE_EX, V3) + sizeof(DMA_IOMMU_INTERFACE_V3))
