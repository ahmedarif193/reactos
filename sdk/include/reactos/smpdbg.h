...
/* Firehose trace gated by the runtime flag; usable from shared (all-arch) files. */
#define SMPDBG_TRACE(...) do { if (SmpDbgEnabled) DbgPrint(__VA_ARGS__); } while (0)
