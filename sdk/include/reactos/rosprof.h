...
ROSPROF_STATIC_ASSERT(sizeof(ROSPROF_RECORD_HEADER) == 40);
ROSPROF_STATIC_ASSERT(offsetof(ROSPROF_RECORD_HEADER, Sequence) == 16);
ROSPROF_STATIC_ASSERT(sizeof(ROSPROF_SESSION_RECORD_V1) == 80);
ROSPROF_STATIC_ASSERT(sizeof(ROSPROF_SAMPLE_RECORD_V1) == 88);
ROSPROF_STATIC_ASSERT(sizeof(ROSPROF_LOSS_RECORD_V1) == 96);
ROSPROF_STATIC_ASSERT(sizeof(ROSPROF_PROCESS_RECORD_V1) == 88);
ROSPROF_STATIC_ASSERT(sizeof(ROSPROF_THREAD_RECORD_V1) == 80);
ROSPROF_STATIC_ASSERT(sizeof(ROSPROF_IMAGE_RECORD_V1) == 96);
ROSPROF_STATIC_ASSERT(sizeof(ROSPROF_CONTEXT_SWITCH_RECORD_V1) == 80);
ROSPROF_STATIC_ASSERT(sizeof(ROSPROF_SCHED_WAKEUP_RECORD_V1) == 80);
ROSPROF_STATIC_ASSERT(sizeof(ROSPROF_PMU_RECORD_V1) == 80);
ROSPROF_STATIC_ASSERT(sizeof(ROSPROF_SECURITY_RECORD_V1) == 80);
ROSPROF_STATIC_ASSERT(sizeof(ROSPROF_CLOCK_SYNC_RECORD_V1) == 80);
