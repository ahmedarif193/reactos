...
#define IOCTL_VIDEO_RPI5VC4_READ_TEXTURE \
    CTL_CODE(FILE_DEVICE_VIDEO, 0x83B, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_VIDEO_RPI5VC4_WAIT_VBLANK \
    CTL_CODE(FILE_DEVICE_VIDEO, 0x83C, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
typedef struct _RPI5VC4_V3D_READ_TEXTURE_REQUEST
{
    ULONG Size;
    ULONG AbiVersion;
    ULONG Generation;
    ULONG TextureSlot;
} RPI5VC4_V3D_READ_TEXTURE_REQUEST,
  *PRPI5VC4_V3D_READ_TEXTURE_REQUEST;

typedef struct _RPI5VC4_V3D_READ_TEXTURE_RESULT
{
    ULONG Size;
    ULONG AbiVersion;
    ULONG Status;
    ...
    ULONG PixelBytes;
    ULONG Pixels[1];
} RPI5VC4_V3D_READ_TEXTURE_RESULT,
  *PRPI5VC4_V3D_READ_TEXTURE_RESULT;

typedef struct _RPI5VC4_VBLANK_RESULT
{
    ULONG Size;
    ULONG AbiVersion;
    ULONG Status;
} RPI5VC4_VBLANK_RESULT, *PRPI5VC4_VBLANK_RESULT;
