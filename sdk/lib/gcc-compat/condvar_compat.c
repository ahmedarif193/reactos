 ...
 * On i386, MinGW import symbols are __imp__Name@N (two leading underscores:
 * the i386 C underscore prefix + the _imp_ prefix + _Name@N stdcall decoration).
 * These cannot be expressed as C identifiers, so use __asm__ to set the
 * exact linker symbol name.
 */
#ifdef _M_IX86
