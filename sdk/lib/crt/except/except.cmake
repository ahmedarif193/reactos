...
if(ARCH STREQUAL "arm64ec" AND COMMAND set_arm64ec_native_target)
    add_asm_files(chkstk_native_lib_asm ${CHKSTK_ASM_SOURCE})
    add_library(chkstk_native ${CHKSTK_SOURCE} ${chkstk_native_lib_asm})
    set_arm64ec_native_target(chkstk_native)
    set_target_properties(chkstk_native PROPERTIES LINKER_LANGUAGE "C")
    add_dependencies(chkstk_native asm)
endif()
