...
if(NOT _files)
    message(FATAL_ERROR "No FEX AMD64 files were provided for validation")
endif()

foreach(_file IN LISTS _files)
    if(NOT EXISTS "${_file}")
        message(FATAL_ERROR "Missing FEX AMD64 file: ${_file}")
    endif()
    ...
    if(NOT _dos_signature STREQUAL "4d5a")
        message(FATAL_ERROR "FEX AMD64 file has no DOS header: ${_file}")
    endif()
    ...
    if(NOT _pe_signature STREQUAL "50450000" OR
       NOT _machine STREQUAL "6486" OR
       NOT _optional_magic STREQUAL "0b02")
        message(FATAL_ERROR "FEX command is not PE32+/AMD64: ${_file}")
    endif()
endforeach()

list(LENGTH _files _file_count)
message(STATUS "Validated ${_file_count} FEX PE32+/AMD64 command files")
