...
set(RSYM_FLAGS "")
if(ROSSYM_COMPRESSION AND NOT NO_ROSSYM)
    set(RSYM_FLAGS "-c")
endif()
...
if(SEPARATE_DBG)
    ...
    if(NOT NO_ROSSYM)
        ...
        set(strip_debug "${RSYM} ${RSYM_FLAGS} -s ${REACTOS_SOURCE_DIR} <TARGET> <TARGET>")
    else()
...
elseif(NO_ROSSYM)
    ...
    set(CMAKE_C_LINK_EXECUTABLE
        ...
        "${RSYM} ${RSYM_FLAGS} -s ${REACTOS_SOURCE_DIR} <TARGET> <TARGET>")
    set(CMAKE_CXX_LINK_EXECUTABLE
...
function(set_subsystem MODULE SUBSYSTEM)
    ...
    target_link_options(${MODULE} PRIVATE "-Wl,--subsystem,${SUBSYSTEM}:${_subsystem_version}")
endfunction()
