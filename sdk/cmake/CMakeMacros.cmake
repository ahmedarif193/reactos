...
macro(dir_to_num dir var)
    ...
    elseif(${dir} STREQUAL reactos/system32)
        set(${var} 2)
    elseif(${dir} STREQUAL reactos/system32/arm64ec)
        set(${var} 85)
    elseif(${dir} STREQUAL reactos/SysWOW64)
        set(${var} 82)
    elseif(${dir} STREQUAL "Program Files/Windows NT/Accessories")
        set(${var} 83)
    ...
    elseif(${dir} STREQUAL reactos/Resources/Themes/Aero)
        set(${var} 70)
    elseif(${dir} STREQUAL reactos/Resources/Themes/Win8)
        set(${var} 86)
...
function(create_registry_hives)
    ...
    if(ARCH STREQUAL "riscv64")
        # This must follow common LiveCD and per-driver inputs so the bootstrap
        # driver quarantine is the final service-start policy.
        list(APPEND _livecd_inf_files
