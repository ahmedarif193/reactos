...
/* _ReadStatusReg/_WriteStatusReg and __getReg/__setReg intentionally omitted:
   they take a 15-bit encoded sysreg op0:op1:CRn:CRm:op2 immediate. Callers
   in HAL/KE should use named MSR/MRS asm wrappers instead. */
