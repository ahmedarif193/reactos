...
#ifdef __REACTOS__
static WCHAR okfile_path[MAX_PATH];
#endif
...
#ifdef __REACTOS__
    GetWindowsDirectoryW( okfile_path, ARRAY_SIZE(okfile_path) );
    lstrcatW( okfile_path, L"\\winetest_dinput_okfile" );
    okfile = CreateFileW( okfile_path, GENERIC_READ | GENERIC_WRITE,
#else
