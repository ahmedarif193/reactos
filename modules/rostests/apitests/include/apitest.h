...
#define ok_eq_typed(value, expected, type, spec)  ok((value) == (expected), #value " = " spec ", expected " spec "\n", (type)(value), (type)(expected))
#define ok_eq_pointer(value, expected)      ok_eq_print(value, expected, "%p")
#define ok_eq_int(value, expected)          ok_eq_typed(value, expected, int, "%d")
#define ok_eq_uint(value, expected)         ok_eq_typed(value, expected, unsigned int, "%u")
#define ok_eq_long(value, expected)         ok_eq_typed(value, expected, long, "%ld")
#define ok_eq_ulong(value, expected)        ok_eq_typed(value, expected, unsigned long, "%lu")
#define ok_eq_longlong(value, expected)     ok_eq_typed(value, expected, long long, "%I64d")
#define ok_eq_ulonglong(value, expected)    ok_eq_typed(value, expected, unsigned long long, "%I64u")
...
#ifndef _WIN64
#define ok_eq_size(value, expected)         ok_eq_typed(value, expected, SIZE_T, "%lu")
#define ok_eq_longptr(value, expected)      ok_eq_typed(value, expected, LONG_PTR, "%ld")
#define ok_eq_ulongptr(value, expected)     ok_eq_typed(value, expected, ULONG_PTR, "%lu")
#elif defined _WIN64
#define ok_eq_size(value, expected)         ok_eq_typed(value, expected, SIZE_T, "%I64u")
#define ok_eq_longptr(value, expected)      ok_eq_typed(value, expected, LONG_PTR, "%I64d")
#define ok_eq_ulongptr(value, expected)     ok_eq_typed(value, expected, ULONG_PTR, "%I64u")
#endif /* defined _WIN64 */
#define ok_eq_hex(value, expected)          ok_eq_typed(value, expected, unsigned long, "0x%08lx")
...
#define ok_eq_hex_(file, line, value, expected) ok_eq_print_(file, line, (unsigned long)(value), (unsigned long)(expected), "0x%08lx")
#define ok_eq_hex64_(file, line, value, expected) ok_eq_print_(file, line, (unsigned long long)(value), (unsigned long long)(expected), "%I64x")
#define ok_eq_hex64(value, expected)        ok_eq_typed(value, expected, unsigned long long, "%I64x")
