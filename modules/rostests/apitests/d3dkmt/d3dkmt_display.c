...
static void Test_GetDisplayModeList(void)
{
    ...
    /* NULL parameter */
    Status = pfnD3DKMTGetDisplayModeList(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTGetDisplayModeList(NULL) returned 0x%lx\n", Status);
...
static void Test_SetVidPnSourceOwner(void)
{
    ...
    /* NULL parameter */
    Status = pfnD3DKMTSetVidPnSourceOwner(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTSetVidPnSourceOwner(NULL) returned 0x%lx\n", Status);
...
static void Test_SetDisplayMode(void)
{
    ...
    /* NULL parameter */
    Status = pfnD3DKMTSetDisplayMode(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTSetDisplayMode(NULL) returned 0x%lx\n", Status);
}
...
static void Test_WaitForVerticalBlankEvent(void)
{
    ...
    /* NULL parameter */
    Status = pfnD3DKMTWaitForVerticalBlankEvent(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTWaitForVerticalBlankEvent(NULL) returned 0x%lx\n", Status);
}
...
static void Test_GetScanLine(void)
{
    ...
    /* NULL parameter */
    Status = pfnD3DKMTGetScanLine(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTGetScanLine(NULL) returned 0x%lx\n", Status);
...
static void Test_PollDisplayChildren(void)
{
    ...
    /* NULL parameter */
    Status = pfnD3DKMTPollDisplayChildren(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTPollDisplayChildren(NULL) returned 0x%lx\n", Status);
...
static void Test_InvalidateActiveVidPn(void)
{
    ...
    /* NULL parameter */
    Status = pfnD3DKMTInvalidateActiveVidPn(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTInvalidateActiveVidPn(NULL) returned 0x%lx\n", Status);
}
...
static void Test_SetGammaRamp(void)
{
    ...
    /* NULL parameter */
    Status = pfnD3DKMTSetGammaRamp(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTSetGammaRamp(NULL) returned 0x%lx\n", Status);
}
...
static void Test_Escape(void)
{
    ...
    /* NULL parameter */
    Status = pfnD3DKMTEscape(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTEscape(NULL) returned 0x%lx\n", Status);
