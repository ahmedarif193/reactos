...
C_ASSERT(FIELD_OFFSET(DXGK_NODE_PERFDATA, MaxTransitionLatency) == 36);
C_ASSERT(sizeof(D3DKMT_NODE_PERFDATA) == 56);
C_ASSERT(FIELD_OFFSET(D3DKMT_NODE_PERFDATA, MaxTransitionLatency) == 48);
C_ASSERT(sizeof(DXGK_ADAPTER_PERFDATA) == 53);
C_ASSERT(sizeof(DXGK_ADAPTER_PERFDATACAPS) == 28);
C_ASSERT(sizeof(DXGK_GPUVERSION) == 128);
#endif
...
C_ASSERT(sizeof(D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN) == 1056);
...
C_ASSERT(sizeof(D3DKMT_GET_PTE_EXT) == 1024);
C_ASSERT(FIELD_OFFSET(D3DKMT_VIDMM_ESCAPE, GetVads.GetPteExt) == 1088);
C_ASSERT(sizeof(D3DKMT_VIDMM_ESCAPE) == 2112);
...
C_ASSERT(D3DKMT_CLIENTHINT_OPEN_VINO == 27);
C_ASSERT(D3DKMT_CLIENTHINT_MAX == 28);
...
C_ASSERT(sizeof(D3DKMT_GET_PTE_EXT) == 0x400);
C_ASSERT(sizeof(D3DKMT_WAITSYNCFILE) == 0x10);
C_ASSERT(sizeof(D3DKMT_OPENSYNCOBJECTFROMSYNCFILE) == 0x28);
#endif
