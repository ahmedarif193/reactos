...
static void Test_Present_NullParam(void)
{
    ...
    Status = pfnD3DKMTPresent(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTPresent(NULL) returned 0x%lx\n", Status);
}
...
static void Test_Render_NullParam(void)
{
    ...
    Status = pfnD3DKMTRender(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTRender(NULL) returned 0x%lx\n", Status);
}
...
static void Test_GetPresentHistory_NullParam(void)
{
    ...
    Status = pfnD3DKMTGetPresentHistory(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTGetPresentHistory(NULL) returned 0x%lx\n", Status);
}
