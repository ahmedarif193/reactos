...
static void Test_CreateDestroyDevice(void)
{
    ...
    /* NULL parameter */
    Status = pfnD3DKMTCreateDevice(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTCreateDevice(NULL) returned 0x%lx\n", Status);

    Status = pfnD3DKMTDestroyDevice(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTDestroyDevice(NULL) returned 0x%lx\n", Status);
...
static void Test_GetDeviceState(void)
{
    ...
    /* NULL parameter */
    Status = pfnD3DKMTGetDeviceState(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTGetDeviceState(NULL) returned 0x%lx\n", Status);
...
static void Test_CreateDestroyContext(void)
{
    ...
    /* NULL parameter */
    Status = pfnD3DKMTCreateContext(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTCreateContext(NULL) returned 0x%lx\n", Status);

    Status = pfnD3DKMTDestroyContext(NULL);
    ok(Status == STATUS_INVALID_PARAMETER,
       "D3DKMTDestroyContext(NULL) returned 0x%lx\n", Status);
    ...
    ok(NT_SUCCESS(Status),
       "D3DKMTCreateContext failed with 0x%lx\n", Status);
